                    ...
                    switch (message.what) {
                        case TXLiveConstants.PUSH_WARNING_NET_BUSY /*1101*/:
                            ...
                            if (d != null) {
                                ...
                                if (dd.b(d) && !dd.this.c(d)) {
                                    dd.b(dd.this, d);
                                    dd.e(dd.this);
                                    dd.this.b = dd.this.b | 2;
                                    if (dd.this.n == -1 || dd.this.n == 0) {
                                        dd.a(dd.this, true);
                                        dd.this.n = System.currentTimeMillis();
                                        return;
                                    }
                                    return;
                                }
                        ...
                        case TXLiveConstants.PUSH_WARNING_RECONNECT /*1102*/:
                            dd.e(dd.this);
                            dd.h(dd.this);
                            if (!(dd.this.t == null || dd.this.j == null || dd.this.j.size() <= 0)) {
                                try {
                                    z = dd.this.v.a(dd.this.j);
                                } catch (Throwable th) {
                                }
                            }
                            if (z) {
                                ...
                                dd.this.n = System.currentTimeMillis();
                                return;
                            } else if (dd.this.n == -1 || (System.currentTimeMillis() - dd.this.n > 40000 && dd.this.n != 0)) {
                                dd.a(dd.this, z);
                                dd.this.n = 0;
                                return;
                            } else {
    ...
    public dd(cr crVar) {
        ...
        this.p = new Runnable() {
            ...
            public final void run() {
                try {
                    dd.this.w.addGpsStatusListener(dd.this.u);
                    Bundle bundle = new Bundle();
                    dd.this.w.sendExtraCommand("gps", "force_xtra_injection", bundle);
                    dd.this.w.sendExtraCommand("gps", "force_time_injection", bundle);
                } catch (Throwable th) {
                    th.toString();
                }
            }
        ...
        this.q = new Runnable() {
            ...
            public final void run() {
                try {
                    dd.this.w.requestLocationUpdates("gps", dd.this.m, 0.0f, dd.this.u);
                } catch (Throwable th) {
                    ea.a = true;
                }
            }
        ...
        this.r = new Runnable() {
            ...
            public final void run() {
                try {
                    dd.this.w.requestLocationUpdates("passive", 1000, 0.0f, dd.this.u);
                } catch (Throwable th) {
                    th.toString();
                }
            }
