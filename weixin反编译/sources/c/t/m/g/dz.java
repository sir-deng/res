...
public final class dz implements Parcelable, TencentLocation {
    ...
    public static class a {
        ...
        public final dz a() {
            ...
            dzVar = dz.c(this.b);
            dzVar.d = this.c.i = this.d.j = this.e;
    ...
    /* synthetic */ dz(int i, byte b) {
        this(i);
    }

    /* synthetic */ dz(String str, byte b) {
        this(str);
    }
    ...
    static {
        AnonymousClass1 anonymousClass1 = new Creator<TencentLocation>() {
            ...
            public final /* synthetic */ Object createFromParcel(Parcel parcel) {
                ...
                dzVar.b = dvVar;
                dzVar.g = dtVar;
                dzVar.l = parcel.readLong();
                Bundle readBundle = parcel.readBundle();
                if (readBundle != null) {
                    dzVar.h.putAll(readBundle);
                }
                return dzVar;
            }
        };
