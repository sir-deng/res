...
public final class eg {
    ...
    public static String a(dn dnVar, boolean z) {
        ...
        if (ea.a(ordinal, i4, i5, dnVar.d, dnVar.e)) {
            i = dnVar.d;
            i2 = dnVar.e;
            i3 = dnVar.f;
            int i6 = dnVar.g;
    ...
    public static String a(dr drVar) {
        ...
        int i = 0;
        List unmodifiableList = Collections.unmodifiableList(drVar.b);
