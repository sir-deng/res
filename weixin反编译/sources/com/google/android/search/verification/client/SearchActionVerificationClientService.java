...
public abstract class SearchActionVerificationClientService extends IntentService {
    private final boolean bfB = rw();
    private final long bfC = 1000;
    private final Intent bfD = new Intent("com.google.android.googlequicksearchbox.SEARCH_ACTION_VERIFICATION_SERVICE").setPackage("com.google.android.googlequicksearchbox");
    private a bfE;
    private com.google.android.search.verification.a.a bfF = null;
    ...
    class a implements ServiceConnection {
        ...
        public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            SearchActionVerificationClientService.this.bfF = com.google.android.search.verification.a.a.a.v(iBinder);
        }

        public final void onServiceDisconnected(ComponentName componentName) {
            SearchActionVerificationClientService.this.bfF = null;
        }
    }
    ...
    protected final void onHandleIntent(Intent intent) {
        ...
        if (intent != null) {
            ...
            while (!isConnected() && System.nanoTime() - nanoTime < this.bfC * 1000000) {
                try {
                    Thread.sleep(50);
            ...
            if (!isConnected()) {
                ...
                try {
                    new StringBuilder(24).append("API version: ").append(this.bfF.getVersion());
                    Bundle bundle = new Bundle();
                    if (!(z2 && this.bfF.a(intent2, bundle))) {
                        z = false;
                    }
                    a(intent2, z);
    ...
    public final void onCreate() {
        super.onCreate();
        this.bfE = new a();
        bindService(this.bfD, this.bfE, 1);
    }

    public final void onDestroy() {
        super.onDestroy();
        unbindService(this.bfE);
    }
