...
public final class q implements u {
    ...
    public final void a(com.google.android.exoplayer2.i.q qVar, f fVar, d dVar) {
        this.aoH.a(qVar, fVar, dVar);
        this.aoL = true;
    }
    ...
    public final void a(j jVar, boolean z) {
        ...
        while (jVar.lG() > 0) {
            if (this.amN < 3) {
                ...
                readUnsignedByte = Math.min(jVar.lG(), 3 - this.amN);
                ...
                readUnsignedByte = Math.min(jVar.lG(), this.aoJ - this.amN);
                jVar.readBytes(this.aoI.data, this.amN, readUnsignedByte);
                this.amN = readUnsignedByte + this.amN;
