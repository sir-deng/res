...
final class b {
    ...
    private static final class d {
        ...
        public final SparseArray<e> axU;
    ...
    private static final class f {
        ...
        public final void a(f fVar) {
            if (fVar != null) {
                SparseArray sparseArray = fVar.aye;
    ...
    private static final class h {
        public final SparseArray<f> axU = new SparseArray();
        public final int ayk;
        public final int ayl;
        public final SparseArray<a> aym = new SparseArray();
        public final SparseArray<c> ayn = new SparseArray();
        public final SparseArray<a> ayo = new SparseArray();
        public final SparseArray<c> ayp = new SparseArray();
        public b ayq;
        public d ayr;
    ...
    public b(int i, int i2) {
        ...
        this.axH = new a(0, lb(), lc(), ld());
        this.axI = new h(i, i2);
    }

    public final List<com.google.android.exoplayer2.f.a> e(byte[] bArr, int i) {
        int cT;
        int cT2;
        int lC;
        int cT3;
                ...
                switch (cT) {
                    case 16:
                        if (cT5 == hVar.ayk) {
                            ...
                            dVar = new d(cT3, cT4, cT6, sparseArray);
                            if (dVar.state == 0) {
                    ...
                    case 20:
                        if (cT5 == hVar.ayk) {
                            ...
                            hVar.ayq = new b(cT5, cT2, cT3, cT4, cT6, cT7);
                            break;
                        }
                        break;
                }
                cT5 = lC - iVar.lC();
                com.google.android.exoplayer2.i.a.ap(iVar.aCr == 0);
                iVar.aCq += cT5;
                iVar.lF();
            }
        }
        ...
        while (true) {
            ...
            Canvas canvas;
            int[] iArr;
            e eVar = (e) sparseArray2.valueAt(lC);
            f fVar = (f) this.axI.axU.get(sparseArray2.keyAt(lC));
                ...
                if (b == null) {
                    ...
                    while (true) {
                        ...
                        if (i2 >= sparseArray3.size()) {
                            cT2 = sparseArray3.keyAt(i2);
                            gVar = (g) sparseArray3.valueAt(i2);
                            cVar = (c) this.axI.ayn.get(cT2);
                            if (cVar != null) {
                                cVar2 = (c) this.axI.ayp.get(cT2);
                            } else {
                                cVar2 = cVar;
                            }
                            if (cVar2 == null) {
                                paint = cVar2.axQ ? null : this.axD;
                                cT2 = fVar.axZ;
                                cT3 = i3 + gVar.ayg;
                                cT4 = i4 + gVar.ayh;
                                canvas = this.axF;
                                iArr = cT2 != 3 ? aVar.axL : cT2 != 2 ? aVar.axK : aVar.axJ;
                                a(cVar2.axR, iArr, cT2, cT3, cT4, paint, canvas);
                                a(cVar2.axS, iArr, cT2, cT3, cT4 + 1, paint, canvas);
                            }
                            cT = i2 + 1;
                        } else {
                            if (!fVar.axX) {
                                if (fVar.axZ == 3) {
                                    cT = aVar.axL[fVar.ayb];
                                } else if (fVar.axZ != 2) {
                                    cT = aVar.axK[fVar.ayc];
                                } else {
                                    cT = aVar.axJ[fVar.ayd];
                                }
                                this.axE.setColor(cT);
    ...
    private static f a(i iVar, int i) {
        ...
        return new f(cT, lD, cT2, cT3, cT4, cT5, cT6, cT7, cT8, cT9, sparseArray);
    }
    ...
    private static int[] ld() {
        ...
        for (int i = 0; i < 256; i++) {
            if (i >= 8) {
                switch (i & com.tencent.mm.plugin.appbrand.jsapi.map.h.CTRL_INDEX) {
                    case 0:
            ...
            switch (iVar.cT(8)) {
                ...
                case 18:
                    ...
                    while (true) {
                        ...
                        if (!(i6 == 0 || paint == null)) {
                            paint.setColor(iArr[i5]);
                            canvas.drawRect((float) i82, (float) i3, (float) (i82 + i6), (float) (i3 + 1), paint);
                        }
                        i5 = i82 + i6;
                        if (obj22 != null) {
                            i4 = i5;
