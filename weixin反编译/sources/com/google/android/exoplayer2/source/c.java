...
public final class c implements e, com.google.android.exoplayer2.source.e.a {
    ...
    private static final class a implements i {
        ...
        public final int b(k kVar, e eVar, boolean z) {
            ...
            if (this.arL == Long.MIN_VALUE || ((b != -4 || eVar.aig < this.arL) && !(b == -3 && this.adx.kb() == Long.MIN_VALUE))) {
                if (b == -4 && !eVar.iZ()) {
                    eVar.aig -= this.arK;
                }
                return b;
    ...
    public final long ka() {
        ...
        long ka2 = this.adx.ka();
        if (ka2 == -9223372036854775807L) {
        ...
        if (this.arL == Long.MIN_VALUE || ka2 <= this.arL) {
            z = true;
        }
        com.google.android.exoplayer2.i.a.ap(z);
        return ka2 - this.arK;
    ...
    public final long kc() {
        ...
        if (this.arL == Long.MIN_VALUE || kc < this.arL) {
            return kc - this.arK;
        }
        return Long.MIN_VALUE;
    }
