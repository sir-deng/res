...
public final class d implements com.google.android.exoplayer2.h.s.a<c> {
            ...
            if (next.startsWith("#EXT-X-MEDIA")) {
                ...
                switch (obj) {
                    case null:
                        ...
                        if (d != null) {
                            arrayList2.add(new com.google.android.exoplayer2.source.b.a.a.a(d, a));
                            break;
                        }
                        format = a;
                        break;
                    case 1:
                        arrayList3.add(new com.google.android.exoplayer2.source.b.a.a.a(d, Format.a(e, "application/x-mpegURL", "text/vtt", i2, d2)));
                        break;
                    case 2:
                        int parseInt;
                ...
                if (hashSet.add(next2)) {
                    arrayList.add(new com.google.android.exoplayer2.source.b.a.a.a(next2, Format.a(Integer.toString(arrayList.size()), "application/x-mpegURL", d, b, i3, i2)));
                }
                i = contains;
            }
        }
    ...
    private static b b(a aVar, String str) {
        ...
        while (aVar.hasNext()) {
            ...
            if (next.startsWith("#EXT-X-PLAYLIST-TYPE")) {
                ...
                com.google.android.exoplayer2.source.b.a.b.a aVar3 = new com.google.android.exoplayer2.source.b.a.b.a(e2, j, parseLong2);
                j = 0;
                j2 = -1;
                aVar2 = aVar3;
                ...
                arrayList.add(new com.google.android.exoplayer2.source.b.a.b.a(next, j3, i5, j7, z, str2, str4, j8, j2));
                j = j7 + j3;
                if (j2 != -1) {
                    parseLong = j8 + j2;
                } else {
        ...
        return new b(i2, str, arrayList2, j5, j6, z2, i3, i, i4, j4, z4, z3, j6 != 0, aVar2, arrayList);
    }
