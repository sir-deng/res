...
public final class l implements d {
    ...
    public final void b(ByteBuffer byteBuffer) {
        ...
        if (byteBuffer.hasRemaining()) {
            ...
            this.ahQ += (long) remaining2;
            k kVar = this.ahO;
            remaining = asShortBuffer.remaining() / kVar.aht;
            int i = (kVar.aht * remaining) * 2;
            kVar.bZ(remaining);
        ...
        if (i2 > 0) {
            ...
            remaining = Math.min(shortBuffer.remaining() / kVar2.aht, kVar2.ahH);
            shortBuffer.put(kVar2.ahB, 0, kVar2.aht * remaining);
            kVar2.ahH -= remaining;
            System.arraycopy(kVar2.ahB, remaining * kVar2.aht, kVar2.ahB, 0, kVar2.aht * kVar2.ahH);
            this.ahR += (long) i2;
