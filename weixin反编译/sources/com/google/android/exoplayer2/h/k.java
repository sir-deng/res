...
public final class k implements d, t<Object> {
    ...
    public final synchronized void lu() {
        int i = 0;
        synchronized (this) {
            com.google.android.exoplayer2.i.a.ap(this.aAX > 0);
            long elapsedRealtime = this.aAW.elapsedRealtime();
            final int i2 = (int) (elapsedRealtime - this.aAY);
            this.aBa += (long) i2;
            this.aBb += this.aAZ;
            if (i2 > 0) {
                int i3;
                ...
                if (this.aBa >= 2000 || this.aBb >= 524288) {
                    ...
                    f2 = nVar2.aCy.isEmpty() ? Float.NaN : ((a) nVar2.aCy.get(nVar2.aCy.size() - 1)).value;
                    this.aBc = Float.isNaN(f2) ? -1 : (long) f2;
                }
            }
            final long j = this.aAZ;
            final long j2 = this.aBc;
            if (!(this.acI == null || this.aAU == null)) {
                this.acI.post(new Runnable() {
