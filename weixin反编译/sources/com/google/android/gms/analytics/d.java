...
public final class d extends n implements ai {
        ...
        if (gVar != null) {
            for (Entry entry : Collections.unmodifiableMap(gVar.aFb).entrySet()) {
                ...
                if (value == null) {
                    ...
                    obj2 = d.doubleValue() != 0.0d ? f(d.doubleValue()) : null;
                } else {
    ...
    public final void b(ae aeVar) {
        ...
        ae pO = aeVar.pO();
        h hVar = (h) pO.b(h.class);
        if (TextUtils.isEmpty(hVar.aWo)) {
            this.aFo.mT().a(c(pO), "Ignoring measurement without type");
        } else if (TextUtils.isEmpty(hVar.aGm)) {
            this.aFo.mT().a(c(pO), "Ignoring measurement without client id");
        } else if (!this.aHf.mW().aEM) {
            double d = hVar.aWu;
            if (k.a(d, hVar.aGm)) {
            ...
            c.put("_s", String.valueOf(this.aFo.mV().a(new s(0, hVar.aGm, this.aIp, !TextUtils.isEmpty(hVar.aWq), 0, hashMap))));
            this.aFo.mV().c(new com.google.android.gms.analytics.internal.c(this.aFo.mT(), c, aeVar.aYb));
        }
    }
