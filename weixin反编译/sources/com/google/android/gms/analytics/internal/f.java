...
public class f extends o {
    ...
    private synchronized void b(int i, String str, Object obj, Object obj2, Object obj3) {
        ...
        char c = this.aFo.aFW.nv() ? com.google.android.gms.common.internal.f.aNs ? 'P' : 'C' : com.google.android.gms.common.internal.f.aNs ? 'p' : 'c';
        String str2 = aFk + aFl.charAt(length) + c + p.VERSION + ":" + n.a(str, aa(obj), aa(obj2), aa(obj3));
        ...
        if (iVar != null) {
            ...
            synchronized (aVar) {
                ...
                if (j <= 0) {
                    ...
                    edit.putString(aVar.mC(), str3);
                    edit.putLong(aVar.mB(), 1);
                    edit.apply();
                } else {
                    ...
                    if (obj4 != null) {
                        edit2.putString(aVar.mC(), str3);
                    }
                    edit2.putLong(aVar.mB(), j + 1);
                    edit2.apply();
                }
            }
        }
