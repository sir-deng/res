...
public final class AnalyticsReceiver extends BroadcastReceiver {
    ...
    public final void onReceive(Context context, Intent intent) {
        ...
        if (com.google.android.gms.common.internal.f.aNs) {
            mT.c("Device AnalyticsReceiver got", action);
        } else {
            mT.c("Local AnalyticsReceiver got", action);
        }
            ...
            synchronized (aEw) {
                ...
                if (z) {
                    try {
                        ...
                        mT.ax("Analytics service at risk of not starting. For more reliable analytics, add the WAKE_LOCK permission to your manifest. See http://goo.gl/8Rd3yj for instructions.");
                    }
                    return;
                }
                return;
