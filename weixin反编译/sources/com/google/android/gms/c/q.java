...
public class q<K, V> {
    ...
    public boolean containsKey(Object obj) {
        return obj == null ? bI() >= 0 : indexOf(obj, obj.hashCode()) >= 0;
    }
    ...
    public V get(Object obj) {
        int bI = obj == null ? bI() : indexOf(obj, obj.hashCode());
        return bI >= 0 ? this.wz[(bI << 1) + 1] : null;
    }
    ...
    public V put(K k, V v) {
        ...
        if (bI < this.hX) {
            System.arraycopy(this.wy, bI, this.wy, bI + 1, this.hX - bI);
            System.arraycopy(this.wz, bI << 1, this.wz, (bI + 1) << 1, (this.hX - bI) << 1);
        }
        this.wy[bI] = i;
        this.wz[bI << 1] = k;
        this.wz[(bI << 1) + 1] = v;
