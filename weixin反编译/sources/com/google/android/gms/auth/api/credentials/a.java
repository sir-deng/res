...
public final class a implements Creator<Credential> {
    static void a(Credential credential, Parcel parcel, int i) {
        ...
        b.a(parcel, 1001, credential.aIE);
        b.a(parcel, 1, credential.aEO);
        b.c(parcel, 1000, credential.mVersionCode);
        b.a(parcel, 2, credential.mName);
        b.a(parcel, 3, credential.aIG, i);
        b.a(parcel, 1002, credential.aIF);
        b.b(parcel, 4, credential.aIH);
        b.a(parcel, 5, credential.aII);
        b.a(parcel, 6, credential.aIJ);
        b.a(parcel, 7, credential.aIK);
        b.a(parcel, 8, credential.aIL);
        b.u(parcel, t);
    }
