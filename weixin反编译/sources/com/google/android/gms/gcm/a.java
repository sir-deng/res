...
public final class a {
    ...
    final Messenger aQH = new Messenger(new Handler(Looper.getMainLooper()) {
    ...
    public final synchronized String b(String... strArr) {
        ...
        synchronized (this) {
            ...
            if (d.O(this.context).contains(".gsf")) {
                ...
                Object obj2 = 1;
                c = com.google.android.gms.iid.a.ps() ? null : com.google.android.gms.iid.a.aQT.c(M.aQW, stringBuilder, str);
                if (c == null) {
