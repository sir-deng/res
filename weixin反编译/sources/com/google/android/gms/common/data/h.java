        ...
        synchronized (this) {
            if (!this.aMA) {
                ...
                if (i > 0) {
                    ...
                    String oA = oA();
                    String c = this.aMc.c(oA, 0, this.aMc.dl(0));
                    int i2 = 1;
                    while (i2 < i) {
                        int dl = this.aMc.dl(i2);
                        String c2 = this.aMc.c(oA, i2, dl);
                        if (c2 == null) {
                            throw new NullPointerException("Missing value for markerColumn: " + oA + ", at row: " + i2 + ", for window: " + dl);
                        }
                        if (c2.equals(c)) {
                            c2 = c;
                        } else {
