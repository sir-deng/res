...
public final class e {
        ...
        try {
            ...
            if (!t.dr(packageInfo.versionCode) && !t.P(context)) {
                try {
                    ...
                    if (k.a(packageInfo, k.a(packageManager.getPackageInfo("com.android.vending", 64), aw.aQp)) == null) {
                        return 9;
                    }
                } catch (NameNotFoundException e2) {
                    if (!f(context, "com.android.vending") || k.a(packageInfo, aw.aQp) == null) {
                        return 9;
                    }
                }
    ...
    L_0x000a:
        return r3;
    L_0x000b:
        r0 = com.google.android.gms.c.t.P(r11);
    ...
    L_0x0015:
        r0 = 14;
        r0 = com.google.android.gms.c.z.ds(r0);
    ...
    L_0x00a2:
        r7 = 11;
        r7 = com.google.android.gms.c.z.ds(r7);
    ...
    L_0x01c7:
        r1 = 11;
        r1 = com.google.android.gms.c.z.ds(r1);
        ...
        synchronized (aEw) {
            if (aJK == -1) {
                try {
                    PackageInfo packageInfo = packageManager.getPackageInfo("com.google.android.gms", 64);
                    k.pp();
                    if (k.a(packageInfo, j.aQl[1]) != null) {
                        aJK = 1;
                    } else {
                        aJK = 0;
                    }
    ...
    public static boolean m(Context context, int i) {
        if (a(context, i, "com.google.android.gms")) {
            if (k.pp().a(context.getPackageManager(), "com.google.android.gms")) {
                return true;
            }
        }
        return false;
