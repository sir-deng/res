...
final class j {
    ...
    private static class b {
        ...
        private b() {
            this.bhQ = new double[2];
            this.bhT = new double[2];
            this.big = new double[2];
            this.bik = new double[4];
            this.bil = (double[][]) Array.newInstance(Double.TYPE, new int[]{4, 4});
            this.biv = new double[2];
            this.biw = new double[2];
        }
        ...
        static /* synthetic */ void a(b bVar, b bVar2) {
            bVar.bhO = bVar2.bhO;
            bVar.bhP = bVar2.bhP;
            bVar.bhQ = (double[]) bVar2.bhQ.clone();
            bVar.bhR = bVar2.bhR;
            bVar.bhS = bVar2.bhS;
            bVar.bhT = (double[]) bVar2.bhT.clone();
            bVar.bhU = bVar2.bhU;
            bVar.bhV = bVar2.bhV;
            bVar.bhW = bVar2.bhW;
            bVar.bhX = bVar2.bhX;
            ...
            bVar.bie = bVar2.bie;
            bVar.bif = bVar2.bif;
            bVar.big = (double[]) bVar2.big.clone();
            bVar.bih = bVar2.bih;
            bVar.bii = bVar2.bii;
            bVar.bij = bVar2.bij;
            bVar.bhB = bVar2.bhB;
            bVar.bik = (double[]) bVar2.bik.clone();
            bVar.bil[0] = (double[]) bVar2.bil[0].clone();
            bVar.bil[1] = (double[]) bVar2.bil[1].clone();
            bVar.bil[2] = (double[]) bVar2.bil[2].clone();
            bVar.bil[3] = (double[]) bVar2.bil[3].clone();
            bVar.bim = bVar2.bim;
            bVar.bin = bVar2.bin;
            bVar.bio = bVar2.bio;
            bVar.bip = bVar2.bip;
            ...
            bVar.bit = bVar2.bit;
            bVar.biu = bVar2.biu;
            bVar.biv = (double[]) bVar2.biv.clone();
            bVar.biw = (double[]) bVar2.biw.clone();
            bVar.bix = bVar2.bix;
        }
    }
            ...
            if (this.bhz.bip) {
                ...
                if (a(this.bhz.bil, dArr)) {
                    ...
                    while (true) {
                        ...
                        dArr9[i2] = 0.0d;
                        for (i4 = 0; i4 < 4; i4++) {
                            dArr9[i2] = dArr9[i2] + (dArr[i2][i4] * this.bhz.bik[i4]);
                        }
                        i4 = i2 + 1;
                    }
                    dArr2 = dArr[0];
                    ...
                    if (a(dArr, this.bhz.bil)) {
                        ...
                        while (true) {
                            ...
                            for (obj2 = 0; obj2 < 4; obj2++) {
                                dArr5 = this.bhz.bik;
                                dArr5[i4] = dArr5[i4] + (this.bhz.bil[i4][obj2] * dArr9[obj2]);
                            }
                            obj2 = i4 + 1;
                        }
                    }
