...
public class WXRecoveryHandleService extends RecoveryHandleService {
    ...
    public void onCreate() {
        ...
        this.toF = (PowerManager) getSystemService("power");
    }
    ...
    protected final RecoveryHandleResult a(Context context, RecoveryData recoveryData, ArrayList<RecoveryHandleItem> arrayList, boolean z) {
        ...
        if (NetUtil.isConnected(this)) {
            RecoveryLog.i("Recovery.WXRecoveryHandleService", "recoveryConfigUrl %s", recoveryData.AaL);
            String a2 = a(r0, a);
            if (a2 != null) {
                ...
                if (jSONObject != null) {
                    ...
                    if ((Util.gm(this) % optInt == optInt2 ? 1 : null) != null) {
                        ...
                        if (a3 != null) {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    if (file.exists()) {
                                        bC = RecoveryTinkerManager.bC(context, optString);
                                        if (bC != 0) {
                                            a.aAM = "KeyPatchStartFailCount[" + bC + "]";
                                            RecoveryLog.i("Recovery.WXRecoveryHandleService", "patch fail tinkerPatchCode=%d", Integer.valueOf(bC));
                                        } else {
                                            a.aAM = "KeyPatchStartSuccessCount";
                                            RecoveryLog.i("Recovery.WXRecoveryHandleService", "start patch file", new Object[0]);
                                        }
                                        recoveryHandleResult.foB = true;
                                    } else {
                                        a.aAM = "KeyCheckPatchMd5FailCount";
    ...
    private RecoveryHandleItem a(RecoveryData recoveryData, String str) {
        ...
        recoveryHandleItem.njL = recoveryData.njL;
        recoveryHandleItem.clientVersion = recoveryData.clientVersion;
        recoveryHandleItem.timestamp = System.currentTimeMillis();
        recoveryHandleItem.aAM = str;
        recoveryHandleItem.processName = recoveryData.processName;
        String gp = NetUtil.gp(this);
        boolean isScreenOn = this.toF.isScreenOn();
        boolean abx = abx("dldir1.qq.com");
        recoveryHandleItem.AaN = gp + "|" + isScreenOn + "|" + abx + "|" + abx("www.qq.com");
...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Exception block dominator not found, method:com.tencent.recovery.wx.service.WXRecoveryHandleService.a(java.lang.String, com.tencent.recovery.model.RecoveryHandleItem):java.lang.String, dom blocks: [B:45:0x00b8, B:49:0x00c5]
...
*/
    ...
    L_0x000b:
        ...
        r4 = com.tencent.recovery.wx.util.FileUtil.d(r0);	 Catch:{ Exception -> 0x0196, all -> 0x0190 }
        r0.close();	 Catch:{ IOException -> 0x0164 }
    L_0x0026:
        if (r4 == 0) goto L_0x0161;
    L_0x0028:
        r0 = com.tencent.recovery.wx.util.EncryptUtil.s(r4);	 Catch:{ Exception -> 0x0138 }
        ...
        r2 = com.tencent.recovery.wx.util.EncryptUtil.h(r4, r2);	 Catch:{ Exception -> 0x0138 }
    ...
    L_0x0044:
        ...
        r11.aAM = r0;	 Catch:{ Exception -> 0x0138 }
        r0 = r1;
    L_0x005e:
        return r0;
    L_0x005f:
    ...
    L_0x0072:
        ...
        goto L_0x0026;
    L_0x0074:
        r0 = com.tencent.recovery.wx.util.WXUtil.aby(r10);
    ...
    L_0x009e:
        r2 = com.tencent.recovery.wx.util.WXUtil.Ie(r2);	 Catch:{ Exception -> 0x0181, all -> 0x0174 }
        r11.aAM = r2;	 Catch:{ Exception -> 0x0181, all -> 0x0174 }
        r3 = r1;
        r4 = r1;
    L_0x00a6:
    ...
    L_0x011e:
        ...
        r6 = com.tencent.recovery.wx.util.EncryptUtil.s(r2);	 Catch:{ Exception -> 0x0138 }
    ...
    private static byte[] a(java.lang.String r8, java.lang.String r9, com.tencent.recovery.model.RecoveryHandleItem r10) {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Exception block dominator not found, method:com.tencent.recovery.wx.service.WXRecoveryHandleService.a(java.lang.String, java.lang.String, com.tencent.recovery.model.RecoveryHandleItem):byte[], dom blocks: [B:39:0x007e, B:53:0x00c5]
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.searchTryCatchDominators(ProcessTryCatchRegions.java:89)
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.process(ProcessTryCatchRegions.java:45)
	at jadx.core.dex.visitors.regions.RegionMakerVisitor.postProcessRegions(RegionMakerVisitor.java:63)
	at jadx.core.dex.visitors.regions.RegionMakerVisitor.visit(RegionMakerVisitor.java:58)
...
*/
    ...
    L_0x000a:
        ...
        r0 = d(r2);	 Catch:{ Exception -> 0x0127, all -> 0x0123 }
    ...
    L_0x0039:
        ...
        goto L_0x0025;
    L_0x003b:
        r0 = com.tencent.recovery.wx.util.WXUtil.aby(r8);
    ...
    L_0x0065:
        r2 = com.tencent.recovery.wx.util.WXUtil.If(r2);	 Catch:{ Exception -> 0x011b, all -> 0x0106 }
        r10.aAM = r2;	 Catch:{ Exception -> 0x011b, all -> 0x0106 }
        r3 = r1;
    L_0x006c:
    ...
    L_0x007e:
        ...
        r10.aAM = r2;	 Catch:{ Exception -> 0x0084, all -> 0x010a }
        goto L_0x006c;
    L_0x0084:
        r2 = move-exception;
        r7 = r2;
    ...
    L_0x00ba:
        ...
        goto L_0x0025;
    L_0x00bf:
        r2 = com.tencent.recovery.wx.util.FileUtil.d(r3);	 Catch:{ Exception -> 0x0084, all -> 0x010a }
        if (r2 != 0) goto L_0x00cc;
    L_0x00c5:
        r1 = "KeyPatchHttpInputStreamReadDataIsNull";	 Catch:{ Exception -> 0x00e6, all -> 0x010a }
        r10.aAM = r1;	 Catch:{ Exception -> 0x00e6, all -> 0x010a }
    ...
    L_0x00cf:
        ...
        goto L_0x006c;	 Catch:{ Exception -> 0x00e6, all -> 0x010a }
    L_0x00d6:
        r4 = com.tencent.recovery.wx.util.EncryptUtil.s(r2);	 Catch:{ Exception -> 0x00e6, all -> 0x010a }
    ...
    L_0x00e0:
        ...
        r10.aAM = r4;	 Catch:{ Exception -> 0x00e6, all -> 0x010a }
        goto L_0x006c;
    L_0x00e6:
        r1 = move-exception;
        r7 = r3;
