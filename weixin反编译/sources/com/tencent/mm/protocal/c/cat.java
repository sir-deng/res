...
public final class cat extends a {
    ...
    protected final int a(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            if (this.wgY != null) {
                h += e.a.a.b.b.a.h(3, this.wgY);
            }
            if (this.vWE != null) {
                h += e.a.a.b.b.a.h(4, this.vWE);
            }
            return h + e.a.a.a.fU(5, this.sfa);
        } else if (i == 2) {
            ...
            switch (((Integer) objArr[2]).intValue()) {
                case 1:
                    cat.xgB = aVar3.AEQ.readString();
                    return 0;
                case 2:
                    cat.wmc = aVar3.AEQ.readString();
                    return 0;
                case 3:
                    cat.wgY = aVar3.AEQ.readString();
                    return 0;
                case 4:
                    cat.vWE = aVar3.AEQ.readString();
                    return 0;
                case 5:
                    cat.sfa = aVar3.AEQ.rz();
                    return 0;
                default:
                    return -1;
            }
