...
public final class ahy extends bea {
    public bes vSZ;
    public bet wfM;
    public bet wwg;
    public bet wwh;
    ...
    protected final int a(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            if (this.wfM == null) {
                ...
                if (this.wwg != null) {
                    aVar.fZ(3, this.wwg.bkL());
                    this.wwg.a(aVar);
                }
                if (this.wwh != null) {
                    aVar.fZ(4, this.wwh.bkL());
                    this.wwh.a(aVar);
                }
                if (this.vSZ != null) {
            ...
            if (this.wwg != null) {
                fW += e.a.a.a.fW(3, this.wwg.bkL());
            }
            if (this.wwh != null) {
                fW += e.a.a.a.fW(4, this.wwh.bkL());
            }
            if (this.vSZ != null) {
                fW += e.a.a.a.fW(5, this.vSZ.bkL());
            }
            if (this.wwi != null) {
                fW += e.a.a.a.fW(6, this.wwi.bkL());
            }
            return fW;
        } else if (i == 2) {
