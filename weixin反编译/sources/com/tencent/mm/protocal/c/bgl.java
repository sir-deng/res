        ...
        if (i == 0) {
            ...
            switch (intValue) {
                ...
                case 2:
                    ...
                    return 0;
                case 3:
                    bgl.hxe = aVar3.AEQ.rz();
                    return 0;
                case 4:
                    bgl.hxf = aVar3.AEQ.readString();
                    return 0;
                case 5:
                    bgl.hxg = aVar3.AEQ.readString();
                    return 0;
                case 6:
                    bgl.hxh = aVar3.AEQ.readString();
                    return 0;
                case 7:
                    bgl.hxi = aVar3.AEQ.rz();
                    return 0;
                case 8:
                    bgl.wCq = aVar3.AEQ.rz();
                    return 0;
                case 9:
                    bgl.wCr = aVar3.AEQ.readString();
                    return 0;
                case 10:
                    bgl.wCs = aVar3.AEQ.readString();
                    return 0;
                case 11:
                    bgl.hxj = aVar3.AEQ.readString();
                    return 0;
                case 12:
                    bgl.wCt = aVar3.AEQ.readString();
                    return 0;
                case 13:
                    bgl.wCu = aVar3.AEQ.rz();
                    return 0;
                case 14:
                    bgl.hxn = aVar3.AEQ.readString();
                    return 0;
                case 15:
                    JD = aVar3.JD(intValue);
                    size = JD.size();
                    ...
                    return 0;
                case 16:
                    bgl.wbY = aVar3.AEQ.readString();
                    return 0;
                case 17:
                    bgl.wbZ = aVar3.AEQ.readString();
                    return 0;
                default:
                    return -1;
            }
