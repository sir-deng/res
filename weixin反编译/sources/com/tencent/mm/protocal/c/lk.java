...
public final class lk extends bek {
    public int lot;
    public String lou;
    public int waW;
    public b waX;
    ...
    protected final int a(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            if (this.waX != null) {
                fW += e.a.a.a.a(4, this.waX);
            }
            return fW + e.a.a.a.fU(5, this.waW);
        } else if (i == 2) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    return 0;
                case 2:
                    lkVar.lot = aVar3.AEQ.rz();
                    return 0;
                case 3:
                    lkVar.lou = aVar3.AEQ.readString();
                    return 0;
                case 4:
                    lkVar.waX = aVar3.cKw();
                    return 0;
                case 5:
                    lkVar.waW = aVar3.AEQ.rz();
                    return 0;
                default:
                    return -1;
            }
