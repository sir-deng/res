    ...
    protected final int a(int i, Object... objArr) {
        ...
        if (i == 0) {
            ...
            switch (((Integer) objArr[2]).intValue()) {
                case 1:
                    akz.whT = aVar3.AEQ.readString();
                    return 0;
                case 2:
                    akz.nkW = aVar3.AEQ.readString();
                    return 0;
                case 3:
                    akz.kzt = aVar3.AEQ.rz();
                    return 0;
                case 4:
                    akz.wgP = aVar3.AEQ.readString();
                    return 0;
                case 5:
                    akz.vXI = aVar3.AEQ.readString();
                    return 0;
                case 6:
                    akz.vXE = aVar3.AEQ.readString();
                    return 0;
                case 7:
                    akz.nlE = aVar3.AEQ.readString();
                    return 0;
                case 8:
                    akz.wyW = aVar3.AEQ.readString();
                    return 0;
                default:
                    return -1;
            }
