...
public final class ac {
    ...
    public static void H(String str, String str2, int i) {
        ...
        edit.putInt("client_version", d.vHl);
        edit.commit();
    }
    ...
    public static ac cey() {
        ...
        if (!acVar.ceB()) {
            ...
            d.pVE.a(148, 38, 1, false);
            x.i("MicroMsg.RsaInfo", "summercert clear old rsa lastClientVer[%d] nowVer[%d], commit[%b]", Integer.valueOf(i), Integer.valueOf(d.vHl), Boolean.valueOf(commit));
        }
        d.pVE.a(148, 39, 1, false);
    ...
    public final boolean ceB() {
        return this.ver == 0 || bi.oN(this.vIK) || bi.oN(this.vIL);
    }
