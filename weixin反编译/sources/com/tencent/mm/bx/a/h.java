...
import com.tencent.mm.bx.a.c.a;
    ...
    final int a(c cVar, int i, int i2) {
        ...
        while (i4 < i3) {
            if (step(1) == 1) {
                Object[] objArr;
                int i5 = i4 / cVar.xKp;
                if (cVar.xKo.indexOfKey(i5) < 0) {
                    obj = new Object[(cVar.xKp * cVar.columnCount)];
                    cVar.xKo.put(i5, obj);
                    objArr = obj;
                } else {
                    objArr = (Object[]) cVar.xKo.get(i5);
                }
                int i6 = cVar.columnCount * (i4 % cVar.xKp);
