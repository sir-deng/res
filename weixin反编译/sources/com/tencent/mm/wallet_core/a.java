...
public final class a {
    private static Map<String, Class<?>> zQk = new HashMap();
    private static SparseArray<c> zQl = new SparseArray();

    public static void i(String str, Class<?> cls) {
        if (zQk.containsKey(str)) {
    ...
    public static void a(Activity activity, Class<?> cls, Bundle bundle, com.tencent.mm.wallet_core.c.a aVar) {
        x.i("MicroMsg.ProcessManager", "startProcess to1 context:%s proc name: %s bundle %s", activity, cls.getSimpleName(), ak(bundle));
        if (bundle == null) {
            try {
                bundle = new Bundle();
            } catch (Throwable e) {
    ...
    public static void a(Activity activity, String str, Bundle bundle, com.tencent.mm.wallet_core.c.a aVar) {
        try {
            x.i("MicroMsg.ProcessManager", "startProcess to2 context:%s proc name: %s bundle %s", activity, str, ak(bundle));
            Class cls = (Class) zQk.get(str);
            if (cls == null) {
    ...
    public static c ag(Activity activity) {
        if (activity == null) {
            ...
            return (c) zQl.get(activity.getIntent().getIntExtra("process_id", 0));
        } else {
