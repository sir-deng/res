...
public final class a {
    ...
    static {
        ...
        hvC[1] = new f(120, 300, 360, 640, 24, 544000, 544000);
    }
    ...
    L_0x0006:
        r10 = hvC;	 Catch:{ Exception -> 0x020f }
    L_0x0008:
    ...
    L_0x002d:
        ...
        r6 = r6.hvU;	 Catch:{ Exception -> 0x020f }
        if (r0 < r6) goto L_0x0044;
    L_0x0039:
        r0 = r12.duration;	 Catch:{ Exception -> 0x020f }
        r6 = hvC;	 Catch:{ Exception -> 0x020f }
        r8 = 1;
    ...
    L_0x0048:
        ...
        r0 = r0.hvT;	 Catch:{ Exception -> 0x020f }
        if (r5 < r0) goto L_0x0116;
    L_0x004e:
        r0 = r10[r6];	 Catch:{ Exception -> 0x020f }
        r0 = r0.hvU;	 Catch:{ Exception -> 0x020f }
        if (r5 >= r0) goto L_0x0116;
    L_0x0054:
        r0 = r10[r6];	 Catch:{ Exception -> 0x020f }
        r1 = r0.hvV;	 Catch:{ Exception -> 0x020f }
        r0 = r10[r6];	 Catch:{ Exception -> 0x020f }
        r0 = r0.hvW;	 Catch:{ Exception -> 0x020f }
    ...
    L_0x007f:
        ...
        r1 = r1.hvX;	 Catch:{ Exception -> 0x020f }
        if (r0 <= r1) goto L_0x0112;
    L_0x0089:
        r0 = r10[r6];	 Catch:{ Exception -> 0x020f }
        r0 = r0.hvX;	 Catch:{ Exception -> 0x020f }
    L_0x008d:
        r12.fps = r0;	 Catch:{ Exception -> 0x020f }
        r0 = r10[r6];	 Catch:{ Exception -> 0x020f }
        r0 = r0.hvY;	 Catch:{ Exception -> 0x020f }
        r1 = r10[r6];	 Catch:{ Exception -> 0x020f }
        r1 = r1.hvU;	 Catch:{ Exception -> 0x020f }
        r0 = r0 * r1;
        r1 = r10[r6];	 Catch:{ Exception -> 0x020f }
        r1 = r1.hvZ;	 Catch:{ Exception -> 0x020f }
        r3 = r12.duration;	 Catch:{ Exception -> 0x020f }
        r1 = r1 * r3;
        r0 = r0 + r1;
        r1 = r10[r6];	 Catch:{ Exception -> 0x020f }
        r1 = r1.hvY;	 Catch:{ Exception -> 0x020f }
        r3 = r12.duration;	 Catch:{ Exception -> 0x020f }
        r1 = r1 * r3;
        r0 = r0 - r1;
        r1 = r10[r6];	 Catch:{ Exception -> 0x020f }
        ...
        r3 = r3.hvT;	 Catch:{ Exception -> 0x020f }
        r1 = r1 * r3;
        r0 = r0 - r1;
        r1 = r10[r6];	 Catch:{ Exception -> 0x020f }
        r1 = r1.hvU;	 Catch:{ Exception -> 0x020f }
        ...
        r4 = r4 * r8;
        r3 = r10[r6];	 Catch:{ Exception -> 0x020f }
        r3 = r3.hvV;	 Catch:{ Exception -> 0x020f }
        r7 = r10[r6];	 Catch:{ Exception -> 0x020f }
        r7 = r7.hvW;	 Catch:{ Exception -> 0x020f }
        r3 = r3 * r7;
        r8 = (double) r3;	 Catch:{ Exception -> 0x020f }
        r4 = r4 / r8;
        ...
        r0 = r0 * r4;
        r3 = r10[r6];	 Catch:{ Exception -> 0x020f }
        r3 = r3.hvX;	 Catch:{ Exception -> 0x020f }
        r4 = (double) r3;	 Catch:{ Exception -> 0x020f }
        r0 = r0 / r4;
        r4 = 4607182418800017408; // 0x3ff0000000000000 float:0.0 double:1.0;
        r3 = r10[r6];	 Catch:{ Exception -> 0x020f }
