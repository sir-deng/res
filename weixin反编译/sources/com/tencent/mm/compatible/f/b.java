...
public final class b {
    private static Boolean gIP = null;
    ...
    public static boolean aK(Context context) {
        if (gIP == null) {
            gIP = Boolean.valueOf(context == null ? false : context.getPackageManager().hasSystemFeature("org.chromium.arc.device_management"));
        }
        return gIP.booleanValue();
    }

    public static boolean zg() {
        return bi.aD(VERSION.INCREMENTAL, "").toLowerCase().contains("flyme") || bi.aD(Build.DISPLAY, "").toLowerCase().contains("flyme");
    }
