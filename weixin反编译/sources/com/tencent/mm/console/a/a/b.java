...
public final class b implements a {
    public final boolean a(Context context, String[] strArr) {
        ...
        x.i("MicroMsg.HCSettingCommand", "hardcoder copy[%d] [%s]", Integer.valueOf(i), y(context, HardCoderJNI.SETTING_SP_FILE));
        ...
        x.i("MicroMsg.HCSettingCommand", "hcsetting copy[%d], ret[%d] src[%s] to dest[%s]", Integer.valueOf(i), Long.valueOf(x), str2, str);
        return true;
    }
