...
public final class l implements a {
    static {
        b.a(new l(), "//cleanwx", "//showfile", "//hidefile");
    }
    ...
    public final boolean a(Context context, String[] strArr) {
        ...
        switch (i2) {
            ...
            case 1:
                try {
                    g.Dq().Db().a(w.a.USERINFO_CALC_WX_SCAN_SHOW_FILE_INT, Integer.valueOf(1));
            ...
            case 2:
                try {
                    g.Dq().Db().a(w.a.USERINFO_CALC_WX_SCAN_SHOW_FILE_INT, Integer.valueOf(0));
