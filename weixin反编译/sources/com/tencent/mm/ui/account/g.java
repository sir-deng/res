...
public final class g {
    public static q a(Context context, View view, String[] strArr, OnItemClickListener onItemClickListener) {
        View inflate = View.inflate(context, R.i.dpz, null);
        HorizontalListView horizontalListView = (HorizontalListView) inflate.findViewById(R.h.cPN);
        ...
        horizontalListView.setBackgroundResource(R.g.bGo);
