...
public final class c {
    ...
    public final int a(d dVar) {
        ...
        Assert.assertTrue(z);
        Drawable a = a(this.zjw.voX, dVar.zjx.getContext());
        if (a == null) {
            return -1;
        }
        dVar.zjx.setBackgroundDrawable(a);
        dVar.zjy.setVisibility(this.zjw.voS ? 0 : 8);
        return 0;
    }
    ...
    private static Drawable a(Map<String, String> map, Context context) {
        ...
        try {
            ...
            if (SH == a.a.ASSET) {
                ...
                density = com.tencent.mm.bu.a.getDensity(context);
                b bVar2 = new b();
                a = d.a(open, density);
            } else {
                float density2 = com.tencent.mm.bu.a.getDensity(context);
                b bVar3 = new b();
            ...
            if (a == null) {
                x.e("MicroMsg.ADListView.Message", "get Bitmap failed type:" + SH + " path:" + str);
                return null;
            }
            ...
            if (createScaledBitmap != null) {
                if (a != createScaledBitmap) {
                    x.i("MicroMsg.ADListView.Message", "recycle bitmap:%s", a);
                    a.recycle();
                }
