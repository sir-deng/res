...
import com.tencent.mm.ui.ab.b;
import com.tencent.mm.ui.ab.c;
import com.tencent.mm.y.as;
import java.util.ArrayList;

public final class aa {
    private static aa xUB = null;
    private long timestamp = 0;
    int xUC = 0;
    private SparseIntArray xUD = new SparseIntArray();
    private SparseArray<b> xUE = new SparseArray();
    private ArrayList<Integer> xUF = new ArrayList();
    public SparseArray<c> xUG = new SparseArray();
    private boolean xUH = false;

    public static aa cop() {
        if (xUB == null) {
            xUB = new aa();
        }
        return xUB;
    ...
    public final void Et(int i) {
        if (this.xUE.size() != 0) {
            b bVar = (b) this.xUE.get(i);
            if (bVar != null && bVar.xUM == 1) {
                this.xUD.put(bVar.id, bVar.hQv);
                this.xUC--;
                if (this.xUH) {
                    StringBuffer stringBuffer = new StringBuffer();
                    for (int i2 = 0; i2 < this.xUD.size(); i2++) {
                        int keyAt = this.xUD.keyAt(i2);
                        Integer valueOf = Integer.valueOf(this.xUD.get(keyAt));
                    ...
                    as.Hm();
                    com.tencent.mm.y.c.Db().set(299010, stringBuffer.toString());
                }
            }
        }
    }
    ...
    public final void mf(boolean r15) {
        /*
        r14 = this;
        r13 = 2;
        r5 = 1;
    ...
    L_0x0005:
        r0 = r14.xUE;	 Catch:{ Exception -> 0x00e2 }
    ...
    L_0x001e:
        ...
        r0 = com.tencent.mm.j.g.Af();	 Catch:{ Exception -> 0x00e2 }
        r1 = "TopRightMenu\\d*";
        r0 = r0.eS(r1);	 Catch:{ Exception -> 0x00e2 }
        ...
        r1 = r14.xUE;	 Catch:{ all -> 0x00df }
        r1.clear();	 Catch:{ all -> 0x00df }
        r1 = r14.xUF;	 Catch:{ all -> 0x00df }
        r1.clear();	 Catch:{ all -> 0x00df }
    ...
    L_0x0059:
        ...
        r1 = "Menu";
        r1 = com.tencent.mm.sdk.platformtools.bj.y(r0, r1);	 Catch:{ all -> 0x00df }
    ...
    L_0x006e:
        ...
        r0 = (java.lang.String) r0;	 Catch:{ all -> 0x00df }
        r4 = com.tencent.mm.sdk.platformtools.bi.Wo(r0);	 Catch:{ all -> 0x00df }
        r0 = ".Menu.$shownew";
        r0 = r1.get(r0);	 Catch:{ all -> 0x00df }
        r0 = (java.lang.String) r0;	 Catch:{ all -> 0x00df }
        r8 = com.tencent.mm.sdk.platformtools.bi.Wo(r0);	 Catch:{ all -> 0x00df }
        r0 = ".Menu.$seq";
        r0 = r1.get(r0);	 Catch:{ all -> 0x00df }
        r0 = (java.lang.String) r0;	 Catch:{ all -> 0x00df }
        r9 = com.tencent.mm.sdk.platformtools.bi.Wo(r0);	 Catch:{ all -> 0x00df }
        r0 = ".Menu.$order";
        r0 = r1.get(r0);	 Catch:{ all -> 0x00df }
        r0 = (java.lang.String) r0;	 Catch:{ all -> 0x00df }
        r10 = com.tencent.mm.sdk.platformtools.bi.Wo(r0);	 Catch:{ all -> 0x00df }
        r0 = r14.xUE;	 Catch:{ all -> 0x00df }
        r1 = new com.tencent.mm.ui.ab$b;	 Catch:{ all -> 0x00df }
        r1.<init>(r4, r8, r9, r10);	 Catch:{ all -> 0x00df }
        r0.put(r4, r1);	 Catch:{ all -> 0x00df }
        r1 = r3;
    L_0x00ad:
        r0 = r14.xUF;	 Catch:{ all -> 0x00df }
        r0 = r0.size();	 Catch:{ all -> 0x00df }
        if (r1 >= r0) goto L_0x00d4;
    L_0x00b5:
        r8 = r14.xUE;	 Catch:{ all -> 0x00df }
        r0 = r14.xUF;	 Catch:{ all -> 0x00df }
        ...
        r0 = (com.tencent.mm.ui.ab.b) r0;	 Catch:{ all -> 0x00df }
    ...
    L_0x00ff:
        ...
        r0 = r14.xUE;
        r0 = r0.get(r4);
        r0 = (com.tencent.mm.ui.ab.b) r0;
        r6 = com.tencent.mm.ui.ab.Eu(r4);
        if (r6 == 0) goto L_0x014f;
    L_0x0119:
        r7 = new com.tencent.mm.ui.ab$c;
        r7.<init>(r6);
        r6 = r14.xUG;
        r6.put(r2, r7);
        r6 = r14.xUD;
    ...
    L_0x0174:
        ...
        r0 = r14.xUF;	 Catch:{ all -> 0x00df }
        r0.clear();	 Catch:{ all -> 0x00df }
        r0 = com.tencent.mm.j.g.Af();	 Catch:{ all -> 0x00df }
        r1 = "TopRightMenus";
        r0 = r0.getValue(r1);	 Catch:{ all -> 0x00df }
        r1 = com.tencent.mm.sdk.platformtools.bi.oN(r0);	 Catch:{ all -> 0x00df }
        if (r1 != 0) goto L_0x01a1;
    L_0x018f:
        r1 = "TopRightMenus";
        r8 = com.tencent.mm.sdk.platformtools.bj.y(r0, r1);	 Catch:{ all -> 0x00df }
    ...
    L_0x01aa:
        r14.coq();	 Catch:{ Exception -> 0x00e2 }
    L_0x01ad:
        r0 = java.lang.System.currentTimeMillis();	 Catch:{ Exception -> 0x00e2 }
    ...
    L_0x0208:
        ...
        r9 = r14.xUE;	 Catch:{ all -> 0x00df }
        r10 = com.tencent.mm.sdk.platformtools.bi.Wo(r0);	 Catch:{ all -> 0x00df }
        r11 = new com.tencent.mm.ui.ab$b;	 Catch:{ all -> 0x00df }
        r12 = com.tencent.mm.sdk.platformtools.bi.Wo(r0);	 Catch:{ all -> 0x00df }
        r1 = com.tencent.mm.sdk.platformtools.bi.Wo(r1);	 Catch:{ all -> 0x00df }
        r2 = com.tencent.mm.sdk.platformtools.bi.Wo(r2);	 Catch:{ all -> 0x00df }
        r11.<init>(r12, r1, r2);	 Catch:{ all -> 0x00df }
        r9.put(r10, r11);	 Catch:{ all -> 0x00df }
        r1 = r14.xUF;	 Catch:{ all -> 0x00df }
        r0 = com.tencent.mm.sdk.platformtools.bi.Wo(r0);	 Catch:{ all -> 0x00df }
    ...
    L_0x0283:
        ...
        r0 = com.tencent.mm.sdk.platformtools.f.cfD();
        if (r0 != 0) goto L_0x02be;
    L_0x02ac:
        r0 = r14.xUG;
        r1 = new com.tencent.mm.ui.ab$c;
        r3 = 2147483647; // 0x7fffffff float:NaN double:1.060997895E-314;
        r3 = com.tencent.mm.ui.ab.Eu(r3);
        r1.<init>(r3);
        r0.put(r2, r1);
    L_0x02bd:
        return;
    L_0x02be:
        ...
        goto L_0x02bd;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.ui.aa.mf(boolean):void");
    }

    private void coq() {
        this.xUD.clear();
        as.Hm();
        String str = (String) com.tencent.mm.y.c.Db().get(299010, null);
        if (!bi.oN(str)) {
            String[] split = str.split("\\|");
            for (String split2 : split) {
                String[] split3 = split2.split("\\:");
                if (split3.length == 2) {
                    this.xUD.put(bi.Wo(split3[0]), bi.Wo(split3[1]));
                }
            }
        }
        this.xUH = true;
