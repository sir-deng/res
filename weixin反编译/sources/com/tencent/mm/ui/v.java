...
public final class v {
    public static final int[] xSW = new int[]{16843087, 16843088, 16843379};
    public static final int[] xSX = new int[]{16843379};
        ...
        public final View onCreateView(String str, Context context, AttributeSet attributeSet) {
            ...
            try {
                ...
                if (view == null) {
                    ...
                    if ((ev != 1.875f && ev != 2.025f) || str.equals("com.tencent.mm.ui.widget.MMTextView") || str.equals("com.tencent.mm.plugin.sns.ui.AsyncTextView") || str.equals("com.tencent.mm.plugin.sns.ui.SnsTextView") || str.equals("com.tencent.mm.plugin.sns.ui.MaskTextView")) {
                        f = ev;
                    } else {
                        f = 1.625f;
                    }
                    ...
                    if (str.equals("TextView") || str.equals("com.tencent.mm.ui.widget.MMTextView")) {
                        ...
                        textView.setTextSize(1, (f * textView.getTextSize()) / com.tencent.mm.bu.a.getDensity(textView.getContext()));
                        context.getAssets();
                        e.ceN();
                        if (e.ceO()) {
                            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, v.xSW);
                            for (i = 0; i < v.xSW.length; i++) {
                                resourceId = obtainStyledAttributes.getResourceId(i, 0);
                                if (resourceId != 0) {
                                    if (v.xSW[i] == 16843379) {
                                        textView.setContentDescription(context.getString(resourceId));
                                    } else if (v.xSW[i] == 16843088) {
                        ...
                        button.setTextSize(1, (f * button.getTextSize()) / com.tencent.mm.bu.a.getDensity(button.getContext()));
                        context.getAssets();
                        e.ceN();
                        if (e.ceO()) {
                            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, v.xSW);
                        ...
                        editText.setTextSize(1, (f * editText.getTextSize()) / com.tencent.mm.bu.a.getDensity(editText.getContext()));
                        context.getAssets();
                        e.ceN();
                        if (e.ceO()) {
                            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, v.xSW);
                        ...
                        checkBox.setTextSize(1, (f * checkBox.getTextSize()) / com.tencent.mm.bu.a.getDensity(checkBox.getContext()));
                        context.getAssets();
                        e.ceN();
                        if (e.ceO()) {
                            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, v.xSW);
                        ...
                        e.ceN();
                        if (e.ceO()) {
                            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, v.xSX);
                            i = 0;
                            while (i < v.xSX.length) {
                                resourceId = obtainStyledAttributes.getResourceId(i, 0);
                                if (resourceId != 0 && v.xSX[i] == 16843379) {
    ...
    public static LayoutInflater b(LayoutInflater layoutInflater) {
        com.tencent.mm.bu.a.ev(layoutInflater.getContext());
    ...
    public static LayoutInflater fw(Context context) {
        com.tencent.mm.bu.a.ev(context);
