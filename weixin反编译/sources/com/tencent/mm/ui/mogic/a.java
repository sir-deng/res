...
public final class a {
    ...
    public final Runnable Fm = new Runnable() {
    ...
    public final boolean f(int i, int i2, int i3, int i4) {
        ...
        int i7 = abs3 + abs4;
        int i8 = abs + abs2;
        x.d("WxViewDragHelper", "ashutest:: xvel %d, yvel %d, dx %d, dy %d duration %d", Integer.valueOf(i3), Integer.valueOf(i4), Integer.valueOf(i5), Integer.valueOf(i6), Integer.valueOf((int) (((k2 != 0 ? ((float) abs4) / ((float) i7) : ((float) abs2) / ((float) i8)) * ((float) j(i6, k2, 0))) + ((k != 0 ? ((float) abs3) / ((float) i7) : ((float) abs) / ((float) i8)) * ((float) j(i5, k, this.zow.cyj()))))));
    ...
    public final boolean l(View view, float f) {
        ...
        if (!(this.zow.cyj() > 0) || Math.abs(f) <= ((float) this.iN)) {
            return false;
        }
        return true;
    }
