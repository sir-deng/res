...
public final class ae {
    private static Rect xVG = new Rect(0, 0, 0, 0);
    ...
    public static ViewGroup a(Window window, View view) {
        ...
        if (view != null) {
            ...
            while (parent != window.getDecorView() && parent != null) {
                ...
                ViewParent viewGroup2 = viewParent;
            }
            f = viewGroup2;
        } else {
            f = null;
    ...
    public static boolean c(final View view, final View view2) {
        ...
        view.setOnApplyWindowInsetsListener(new OnApplyWindowInsetsListener() {
            public final WindowInsets onApplyWindowInsets(View view, WindowInsets windowInsets) {
                ...
                ae.x(marginLayoutParams.leftMargin, marginLayoutParams.topMargin, marginLayoutParams.rightMargin, marginLayoutParams.bottomMargin);
    ...
    public static boolean fz(Context context) {
        ...
        Point fA = fA(context);
        return Math.max(fA.y, fA.x) > Math.max(point.y, point.x);
    }

    public static Point fA(Context context) {
        Point point = new Point();
        Display defaultDisplay = ((WindowManager) context.getSystemService("window")).getDefaultDisplay();
