...
public class ZoneSelectOtherCountryPreference extends Preference {
    ...
    protected final void onBindView(View view) {
        ...
        TextView textView = (TextView) view.findViewById(R.h.dab);
        if (!bi.oN(this.text)) {
            textView.setText(this.text);
        }
        view.setOnClickListener(new OnClickListener() {
            public final void onClick(View view) {
                if (ZoneSelectOtherCountryPreference.this.zwK != null) {
                    ZoneSelectOtherCountryPreference.this.zwK.onClick();
                }
            }
        });
    }
