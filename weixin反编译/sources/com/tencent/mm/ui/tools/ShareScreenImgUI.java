...
public class ShareScreenImgUI extends MMActivity {
    ...
    private ag handler = new ag() {
        public final void handleMessage(Message message) {
            ...
            if (bi.oN(ShareScreenImgUI.this.filePath)) {
                x.e("MicroMsg.ShareScreenImgUI", "launch : fail, filePath is null");
                ShareScreenImgUI.this.cys();
                ShareScreenImgUI.this.finish();
                return;
            }
            ShareScreenImgUI.this.cyT();
        }
    };
    ...
    static /* synthetic */ void a(ShareScreenImgUI shareScreenImgUI) {
        if (shareScreenImgUI.inI != null && shareScreenImgUI.inI.isShowing()) {
            shareScreenImgUI.inI.dismiss();
        }
    }
    ...
    protected final void initView() {
        ...
        if (bi.oN(action)) {
            ...
            if (this.uri == null || !bi.m(this.uri)) {
            ...
            this.filePath = bi.f(this, this.uri);
            if (!bi.oN(this.filePath)) {
                ...
                if (!b && decodeResultLogger.getDecodeResult() >= MMBitmapFactory.ERROR_IMG_BUG_DETECTED_BEGIN) {
                    g.pWK.k(12712, KVStatHelper.getKVStatString(action, 3, decodeResultLogger));
                }
                if (b) {
                    cyT();
                    return;
    ...
    private void cyT() {
        ...
        if (!t.a(getIntent(), "Intro_Switch", false) && as.Ho() && !as.Cz()) {
