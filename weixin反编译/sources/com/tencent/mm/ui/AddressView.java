...
public class AddressView extends View implements a, d.a {
    ...
    public AddressView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.drawable = getResources().getDrawable(R.g.bGm);
        this.needUpdatePostion = true;
        this.AVATAR_LAYOUT_WIDTH = getResources().getDimensionPixelSize(R.f.buA);
        this.AVATAR_WIDTH = getResources().getDimensionPixelSize(R.f.buA);
        this.NAME_TEXT_SIZE = (float) com.tencent.mm.bu.a.aa(context, R.f.bvL);
        this.DESCRIPTION_TEXT_SIZE = (float) com.tencent.mm.bu.a.aa(context, R.f.bvX);
        this.WEIBO_ICON_SIZE = getResources().getDimensionPixelSize(R.f.bvR);
        this.AVATAR_START_POS = 0;
        this.AVATAR_PADDING = getResources().getDimensionPixelSize(R.f.bus);
        this.COMMON_PADDING = 0;
        this.DESCRIPTION_PADDING = getResources().getDimensionPixelSize(R.f.bvy) * 2;
        this.TEXT_TOP_PADDING = getResources().getDimensionPixelSize(R.f.bvW);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.nameIsSpanned) {
            ...
            canvas.restore();
        } else if (bi.oN(this.description)) {
    ...
    public void resumeAvatarLoad() {
        if (this.avatarDrawable != null) {
            ((com.tencent.mm.pluginsdk.ui.a) this.avatarDrawable).caQ();
        }
    }

    public void stopAvatarLoad() {
        if (this.avatarDrawable != null) {
            ((com.tencent.mm.pluginsdk.ui.a) this.avatarDrawable).caP();
        }
    }
    ...
    private void installAccessibilityDelegate() {
        z.a((View) this, new android.support.v4.view.a() {
