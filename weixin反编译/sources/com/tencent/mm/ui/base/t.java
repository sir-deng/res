...
final class t extends SurfaceTexture {
    public SurfaceTexture mrs = null;
    ...
    public final void setOnFrameAvailableListener(OnFrameAvailableListener onFrameAvailableListener) {
        ...
        this.mrs.setOnFrameAvailableListener(onFrameAvailableListener);
    }
    ...
    public final void detachFromGLContext() {
        ...
        try {
            this.mrs.detachFromGLContext();
            z = false;
        } catch (Throwable e) {
            x.printErrStackTrace("MicroMsg.MMSurfaceTextureWrap", e, "%s", "detect texture problem, RuntimeException detachFromGLContext");
            z = true;
        }
        if (z) {
            String str2;
            try {
                ...
                str2 = IP() + " detect texture problem error code = " + ((Integer) declaredMethod.invoke(this.mrs, new Object[0])).intValue() + ", detach = true, and error = " + z;
                b.z(Base64.encodeToString(str2.getBytes(), 2), "DetachFromGLContext");
                x.w("MicroMsg.MMSurfaceTextureWrap", str2);
                x.i("MicroMsg.MMSurfaceTextureWrap", "detect texture problem, err %s hasDetach %s hasError %s", Integer.valueOf(r0), Boolean.valueOf(true), Boolean.valueOf(z));
            } catch (Throwable e2) {
                x.printErrStackTrace("MicroMsg.MMSurfaceTextureWrap", e2, "%s", "detect texture problem, IllegalArgumentException");
                str = IP() + " detect texture problem error code = 0" + ", detach = false, and error = " + z;
                b.z(Base64.encodeToString(str.getBytes(), 2), "DetachFromGLContext");
                x.w("MicroMsg.MMSurfaceTextureWrap", str);
                x.i("MicroMsg.MMSurfaceTextureWrap", "detect texture problem, err %s hasDetach %s hasError %s", Integer.valueOf(0), Boolean.valueOf(false), Boolean.valueOf(z));
            } catch (Throwable e22) {
                x.printErrStackTrace("MicroMsg.MMSurfaceTextureWrap", e22, "%s", "detect texture problem, IllegalAccessException");
                str = IP() + " detect texture problem error code = 0" + ", detach = false, and error = " + z;
                b.z(Base64.encodeToString(str.getBytes(), 2), "DetachFromGLContext");
                x.w("MicroMsg.MMSurfaceTextureWrap", str);
                x.i("MicroMsg.MMSurfaceTextureWrap", "detect texture problem, err %s hasDetach %s hasError %s", Integer.valueOf(0), Boolean.valueOf(false), Boolean.valueOf(z));
            } catch (Throwable e222) {
                x.printErrStackTrace("MicroMsg.MMSurfaceTextureWrap", e222, "%s", "detect texture problem, InvocationTargetException");
                str = IP() + " detect texture problem error code = 0" + ", detach = false, and error = " + z;
                b.z(Base64.encodeToString(str.getBytes(), 2), "DetachFromGLContext");
                x.w("MicroMsg.MMSurfaceTextureWrap", str);
                x.i("MicroMsg.MMSurfaceTextureWrap", "detect texture problem, err %s hasDetach %s hasError %s", Integer.valueOf(0), Boolean.valueOf(false), Boolean.valueOf(z));
            } catch (Throwable e2222) {
                x.printErrStackTrace("MicroMsg.MMSurfaceTextureWrap", e2222, "%s", "detect texture problem, NoSuchMethodException");
                str = IP() + " detect texture problem error code = 0" + ", detach = false, and error = " + z;
                b.z(Base64.encodeToString(str.getBytes(), 2), "DetachFromGLContext");
                x.w("MicroMsg.MMSurfaceTextureWrap", str);
                x.i("MicroMsg.MMSurfaceTextureWrap", "detect texture problem, err %s hasDetach %s hasError %s", Integer.valueOf(0), Boolean.valueOf(false), Boolean.valueOf(z));
            } catch (Throwable e22222) {
                x.printErrStackTrace("MicroMsg.MMSurfaceTextureWrap", e22222, "%s", "detect texture problem, Exception");
                str = IP() + " detect texture problem error code = 0" + ", detach = false, and error = " + z;
                b.z(Base64.encodeToString(str.getBytes(), 2), "DetachFromGLContext");
                x.w("MicroMsg.MMSurfaceTextureWrap", str);
                x.i("MicroMsg.MMSurfaceTextureWrap", "detect texture problem, err %s hasDetach %s hasError %s", Integer.valueOf(0), Boolean.valueOf(false), Boolean.valueOf(z));
            } catch (Throwable th) {
                str2 = IP() + " detect texture problem error code = 0" + ", detach = false, and error = " + z;
                b.z(Base64.encodeToString(str2.getBytes(), 2), "DetachFromGLContext");
                x.w("MicroMsg.MMSurfaceTextureWrap", str2);
                x.i("MicroMsg.MMSurfaceTextureWrap", "detect texture problem, err %s hasDetach %s hasError %s", Integer.valueOf(0), Boolean.valueOf(false), Boolean.valueOf(z));
            }
    ...
    private static String IP() {
        ...
        stringBuilderPrinter.println("#accinfo.build=" + e.TIME + ":" + e.HOSTNAME + ":" + f.fei);
        ...
        try {
            ...
            x.e("MicroMsg.MMSurfaceTextureWrap", "check data size failed :%s", e.getMessage());
            format = str;
        }
