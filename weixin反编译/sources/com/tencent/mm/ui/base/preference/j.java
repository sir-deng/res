...
public final class j {
    private static HashMap<String, Constructor<?>> yse = new HashMap();
    private static final Class<?>[] ysf = new Class[]{Context.class, AttributeSet.class};
    ...
    L_0x0023:
        ...
        r2 = ysf;	 Catch:{ NoSuchMethodException -> 0x0040, ClassNotFoundException -> 0x0079, Exception -> 0x007b }
        r1 = r1.getConstructor(r2);	 Catch:{ NoSuchMethodException -> 0x0040, ClassNotFoundException -> 0x0079, Exception -> 0x007b }
        r0 = yse;	 Catch:{ NoSuchMethodException -> 0x0040, ClassNotFoundException -> 0x0079, Exception -> 0x00aa }
        r0.put(r7, r1);	 Catch:{ NoSuchMethodException -> 0x0040, ClassNotFoundException -> 0x0079, Exception -> 0x00aa }
    L_0x0032:
        r0 = r6.HO;	 Catch:{ NoSuchMethodException -> 0x0040, ClassNotFoundException -> 0x0079, Exception -> 0x00aa }
        r2 = 1;
