...
public class NotifyFreqLimit extends BroadcastReceiver {
    ...
    public void onReceive(android.content.Context r23, android.content.Intent r24) {
        /*
        r22 = this;
        r11 = gUq;	 Catch:{ Throwable -> 0x00fb }
    ...
    L_0x002d:
        ...
        r2 = com.tencent.mm.sdk.platformtools.bi.Wy();	 Catch:{ all -> 0x00f8 }
        r14 = r2 - r12;
        r2 = "pid";
        r3 = 0;
        r0 = r24;
        ...
        r5[r6] = r7;	 Catch:{ all -> 0x00f8 }
        r6 = 6;
        r7 = hHW;	 Catch:{ all -> 0x00f8 }
        r5[r6] = r7;	 Catch:{ all -> 0x00f8 }
        r6 = 7;
        r7 = hHN;	 Catch:{ all -> 0x00f8 }
        r5[r6] = r7;	 Catch:{ all -> 0x00f8 }
        com.tencent.mm.sdk.platformtools.x.i(r3, r4, r5);	 Catch:{ all -> 0x00f8 }
        r3 = hHW;	 Catch:{ all -> 0x00f8 }
        if (r3 != 0) goto L_0x0120;
    L_0x00a8:
        r3 = com.tencent.mm.plugin.report.service.g.pWK;	 Catch:{ all -> 0x00f8 }
        r4 = 99;
        ...
        r5[r2] = r6;	 Catch:{ all -> 0x00f8 }
        r2 = 6;
        r6 = hHW;	 Catch:{ all -> 0x00f8 }
        r5[r2] = r6;	 Catch:{ all -> 0x00f8 }
        r2 = 7;
        r6 = hHN;	 Catch:{ all -> 0x00f8 }
        r5[r2] = r6;	 Catch:{ all -> 0x00f8 }
        com.tencent.mm.sdk.platformtools.x.e(r3, r4, r5);	 Catch:{ all -> 0x00f8 }
        monitor-exit(r11);	 Catch:{ all -> 0x00f8 }
        goto L_0x0027;
    ...
    L_0x0188:
        ...
        r4 = com.tencent.mm.sdk.platformtools.bi.oM(r4);	 Catch:{ all -> 0x00f8 }
        ...
        r8 = com.tencent.mm.sdk.platformtools.bi.Wy();	 Catch:{ all -> 0x00f8 }
        ...
        r3 = com.tencent.mm.sdk.platformtools.bi.oN(r4);	 Catch:{ all -> 0x00f8 }
