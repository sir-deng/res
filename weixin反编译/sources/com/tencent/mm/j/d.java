...
public final class d {
    public static final int[] gJP = new int[]{1};
    HashMap<String, HashMap<String, String>> gJQ = new HashMap();
    public Map<String, String> gJR = null;
    private int id;
    int version;
    ...
    static boolean eR(String str) {
        try {
            ...
            x.d("MicroMsg.ConfigListInfo", "locale is " + cfV);
            for (String str2 : arrayList) {
                if (str2.trim().toLowerCase().equals("other") && !cfV.equals("zh_CN")) {
                    x.d("MicroMsg.ConfigListInfo", "find other");
                    return true;
                } else if (str2.trim().toLowerCase().equals(cfV.trim().toLowerCase())) {
