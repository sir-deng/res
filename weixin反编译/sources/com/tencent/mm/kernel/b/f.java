...
public abstract class f implements d {
    ...
    private void checkIfNeedDefaultDependency() {
        a aVar = (a) h.Dv().Dm().gRI.gTB.get(getClass());
        int i = (aVar == null || !(aVar.DG() || aVar.DI())) ? 0 : 1;
        if (i == 0) {
            Class cls = h.Dv().Dm().gRL;
            if (cls != null) {
                dependsOn(cls);
