...
public final class a extends Resources {
        ...
        try {
            ...
            if (cls != null) {
                ...
                if (declaredField != null) {
                    ...
                    this.xjN = ad.cgg().getBoolean("ShowStringName", false);
                }
            }
            declaredField = null;
    ...
    public static Resources a(Resources resources, Context context) {
        return new a(resources, e.eD(context), new c());
    }
    ...
    public final Drawable getDrawable(int i) {
        if (i != 0) {
            Drawable c = this.xjM.c(this.mResources, i);
            if (c != null) {
                return c;
            }
        }
