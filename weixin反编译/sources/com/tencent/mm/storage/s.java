...
public class s {
        ...
        synchronized (this) {
            ...
            try {
                ...
                try {
                    ...
                    this.xuU = false;
                    x.d("MicroMsg.ConfigFileStorage", "writeCfg end, keys count:%d time:%d", Integer.valueOf(this.values.keySet().toArray().length), Long.valueOf(bi.bA(Wy)));
                    try {
                        objectOutputStream.close();
                        fileOutputStream2.close();
                    } catch (Exception e5) {
    ...
    public final synchronized int DE(int i) {
        Integer num;
        num = (Integer) get(i);
