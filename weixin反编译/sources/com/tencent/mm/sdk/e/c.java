...
public abstract class c {
    ...
    public static class a {
        ...
        public Field[] hUM;
        public String xrS;
        public Map<String, String> xrT = new HashMap();
        public String xrU;
    }
    ...
    public abstract ContentValues vP();
    ...
    public static a D(Class<?> cls) {
        ...
        for (Field field : cls.getDeclaredFields()) {
            ...
            if (!(name == null || !Modifier.isPublic(modifiers) || Modifier.isFinal(modifiers))) {
                ...
                if (field.isAnnotationPresent(h.class)) {
                    if (((h) field.getAnnotation(h.class)).chB() == 1) {
                        aVar.xrS = substring;
                    }
        ...
        aVar.hUM = (Field[]) linkedList.toArray(new Field[0]);
        aVar.columns = a(aVar.hUM);
        aVar.xrT = b(aVar.hUM);
        aVar.xrU = c(aVar.hUM);
        return aVar;
    }
        ...
        while (i < fieldArr.length) {
            ...
            if (C == null) {
                ...
                if (!bi.oN(b)) {
                    ...
                    String str2 = "";
                    if (field.isAnnotationPresent(h.class)) {
                        str = " default '" + ((h) field.getAnnotation(h.class)).chA() + "' ";
                        chB = ((h) field.getAnnotation(h.class)).chB();
                    } else {
                        str = str2;
                        chB = 0;
                    }
                    stringBuilder.append(b + " " + C + str + (chB == 1 ? " PRIMARY KEY " : ""));
