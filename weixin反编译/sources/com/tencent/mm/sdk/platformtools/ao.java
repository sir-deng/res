...
public final class ao {
    ...
    private static PhoneStateListener xpg = null;
    private static int xph = 10000;
    ...
    public static synchronized void eU(Context context) {
        synchronized (ao.class) {
            TelephonyManager telephonyManager = (TelephonyManager) context.getSystemService("phone");
            nJI = telephonyManager.getPhoneType();
            if (xpg == null) {
                xpg = new PhoneStateListener() {
                    public final void onSignalStrengthsChanged(SignalStrength signalStrength) {
                        ...
                        x.i("MicroMsg.NetStatusUtil", "PhoneStateListener  type:%d  strength:%d", Integer.valueOf(ao.nJI), Integer.valueOf(ao.nowStrength));
                    }
                };
                telephonyManager.listen(xpg, 256);
            }
        }
    }
    ...
    public static synchronized List<a> eV(Context context) {
        List<a> list;
                    ...
                    if (telephonyManager.getPhoneType() == 2) {
                        try {
                            ...
                            if (cdmaCellLocation != null) {
                                str3 = nowStrength == xph ? "" : nowStrength;
                        ...
                        try {
                            ...
                            if (gsmCellLocation != null) {
                                ...
                                lac = gsmCellLocation.getLac();
                                if (!(lac >= 65535 || lac == -1 || cid == -1)) {
                                    linkedList.add(new a(str, networkOperator, String.valueOf(lac), String.valueOf(cid), nowStrength == xph ? "" : nowStrength, "gsm", "", "", ""));
                                }
                            }
                        } catch (Throwable e22) {
                            x.printErrStackTrace("MicroMsg.NetStatusUtil", e22, "", new Object[0]);
