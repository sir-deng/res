                    ...
                    try {
                        ...
                        if (obj != null && (obj instanceof View)) {
                            ...
                            if (view.getContext() == context) {
                                ...
                                x.d("MicroMsg.ActivityResourceRecycler", "fixInputMethodManagerLeak break, context is not suitable, get_context=" + view.getContext() + " dest_context=" + context);
                                return;
                            }
                        }
                    } catch (Throwable th) {
                        x.printErrStackTrace("MicroMsg.ActivityResourceRecycler", th, "", new Object[0]);
                    }
                }
            }
        }
    ...
    public static void dd(View view) {
        if (view != null) {
            ...
            try {
                ...
                x.printErrStackTrace("MicroMsg.Crash", e22, "May cause dvmFindCatchBlock crash!", new Object[0]);
            ...
            try {
                ...
                x.printErrStackTrace("MicroMsg.Crash", e222, "May cause dvmFindCatchBlock crash!", new Object[0]);
            ...
            try {
                ...
                x.printErrStackTrace("MicroMsg.Crash", e2222, "May cause dvmFindCatchBlock crash!", new Object[0]);
            ...
            try {
                ...
                x.printErrStackTrace("MicroMsg.Crash", e22222, "May cause dvmFindCatchBlock crash!", new Object[0]);
            ...
            try {
                ...
                x.printErrStackTrace("MicroMsg.Crash", e222222, "May cause dvmFindCatchBlock crash!", new Object[0]);
            ...
            if (view instanceof ListView) {
                ...
                if (view instanceof ViewGroup) {
                    ...
                    for (i = 0; i < childCount; i++) {
                        dd(((ViewGroup) view).getChildAt(i));
                    }
                }
                try {
                    listView.setAdapter(null);
                } catch (Throwable e2222222) {
                    x.printErrStackTrace("MicroMsg.Crash", e2222222, "May cause dvmFindCatchBlock crash!", new Object[0]);
                ...
                try {
                    ...
                    x.printErrStackTrace("MicroMsg.Crash", e22222222, "May cause dvmFindCatchBlock crash!", new Object[0]);
                ...
                try {
                    ...
                    x.printErrStackTrace("MicroMsg.Crash", e222222222, "May cause dvmFindCatchBlock crash!", new Object[0]);
                ...
                try {
                    ...
                    x.printErrStackTrace("MicroMsg.Crash", e2222222222, "May cause dvmFindCatchBlock crash!", new Object[0]);
                ...
                try {
                    ...
                    x.printErrStackTrace("MicroMsg.Crash", e22222222222, "May cause dvmFindCatchBlock crash!", new Object[0]);
            ...
            if (view instanceof ViewGroup) {
                ...
                for (int i2 = 0; i2 < i; i2++) {
                    dd(((ViewGroup) view).getChildAt(i2));
                }
            }
        }
    }
