...
public final class e {
    ...
    public static String baj() {
        x.d("MicroMsg.MediaCodecUtil", "check hevc info last rpt time[%d]", Long.valueOf(ouR));
        try {
            ouR = bi.Wy();
            if (!d.fN(21)) {
                return bak();
            ...
            x.i("MicroMsg.MediaCodecUtil", "high api 21 cost[%d] hevc info %s", Long.valueOf(bi.bB(Wz)), stringBuilder3.toString());
            return stringBuilder3.toString();
        } catch (Throwable e) {
            x.printErrStackTrace("MicroMsg.MediaCodecUtil", e, "report hevc info error %s", e.toString());
        } catch (Throwable e2) {
            x.printErrStackTrace("MicroMsg.MediaCodecUtil", e2, "report hevc info error %s", e2.toString());
        }
        return "";
    }
    ...
    private static String bak() {
        ...
        x.i("MicroMsg.MediaCodecUtil", "below api 21 cost[%d] hevc info %s", Long.valueOf(bi.bB(Wz)), stringBuilder3.toString());
        return stringBuilder3.toString();
    }
    ...
    private static String a(MediaCodecInfo mediaCodecInfo) {
        ...
        for (String str : supportedTypes) {
            if (!bi.oN(str) && str.contains("hevc")) {
                return str;
            }
        }
        return "";
