...
public final class k {
    public static LinkedList<kx> bb(String str, int i) {
        ...
        try {
            ...
            LinkedList<kx> linkedList = new LinkedList();
            for (int i2 = 0; i2 < jSONArray.length(); i2++) {
                JSONObject optJSONObject = jSONArray.optJSONObject(i2);
                kx kxVar = new kx();
                kxVar.kPy = optJSONObject.optString(i == 26 ? "cardId" : "card_id");
                kxVar.code = optJSONObject.optString(TMQQDownloaderOpenSDKConst.UINTYPE_CODE);
