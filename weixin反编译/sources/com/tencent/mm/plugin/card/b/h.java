...
public final class h {
    public static ArrayList<kp> aZ(String str, int i) {
        ...
        for (int i2 = 0; i2 < optJSONArray.length(); i2++) {
            ...
            kp kpVar = new kp();
            kpVar.kPy = optJSONObject.optString(i == 26 ? "cardId" : "card_id");
            kpVar.fHQ = optJSONObject.optString(i == 26 ? "cardExt" : "card_ext");
            arrayList.add(kpVar);
        }
        return arrayList;
    }
    ...
    public static String a(LinkedList<e> linkedList, boolean z, int i) {
        ...
        while (it.hasNext()) {
            ...
            jSONStringer.value(eVar.kPy);
            jSONStringer.key(i == 26 ? "cardExt" : "card_ext");
            jSONStringer.value(eVar.fHQ == null ? "" : eVar.fHQ);
