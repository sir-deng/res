...
public final class e {
    public static String cc(String str, String str2) {
        ...
        as.Hm();
        try {
            byte[] ak = ak(("CbW9HMPiil38ldOjZp5WkwlIfzvLwiX6_" + c.Cn() + "_" + str).getBytes());
            byte[] xl = xl(str2);
            Key secretKeySpec = new SecretKeySpec(ak, "AES");
            Cipher instance = Cipher.getInstance("AES");
            instance.init(2, secretKeySpec);
            return new String(instance.doFinal(xl));
        } catch (Throwable e) {
    ...
    public static String cd(String str, String str2) {
        ...
        try {
            ...
            return aj(instance.doFinal(bytes));
        } catch (Throwable e) {
            x.printErrStackTrace("MicroMsg.CardDymanicQrcodeOfflineHelper", e, "", new Object[0]);
            return str3;
        }
    ...
    public static String ce(String str, String str2) {
        ...
        try {
            String cf = cf(stringBuilder.toString(), str2);
