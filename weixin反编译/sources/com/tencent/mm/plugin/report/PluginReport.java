...
public class PluginReport extends f implements b, b {
    ...
    public void configure(g gVar) {
        this.pVD = new p(i.class);
        com.tencent.mm.kernel.g.a(p.class, new d(this.pVD));
        d dVar = d.pVE;
        x.i("MicroMsg.ReportService", "instance set %s", com.tencent.mm.plugin.report.service.g.pWK);
        dVar.pVF = r1;
    }
