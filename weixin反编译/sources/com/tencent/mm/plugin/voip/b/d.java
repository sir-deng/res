...
public final class d {
    public static Context syL = null;
    private static final String syM;
    private static final Uri syN = Uri.parse("content://com.lbe.security.miui.permmgr/active");
    ...
    private static boolean dG(android.content.Context r13) {
        /*
        r11 = 2;
        r9 = 0;
        ...
        r1 = syN;	 Catch:{ Throwable -> 0x00f7, all -> 0x00d2 }
        r2 = 1;
    ...
    L_0x005e:
        ...
        r4[r3] = r5;	 Catch:{ Throwable -> 0x00f1 }
        com.tencent.mm.sdk.platformtools.x.d(r1, r2, r4);	 Catch:{ Throwable -> 0x00f1 }
    L_0x00a8:
        r2 = r0;
    L_0x00a9:
    ...
    L_0x00b1:
        ...
        com.tencent.mm.sdk.platformtools.x.w(r3, r4, r5);	 Catch:{ all -> 0x00f5 }
    ...
    L_0x00db:
        ...
        r4[r7] = r0;
        com.tencent.mm.sdk.platformtools.x.w(r1, r3, r4);
        goto L_0x00a9;
    L_0x00ef:
        r0 = r8;
        goto L_0x00ac;
    ...
    L_0x0107:
        ...
        goto L_0x0033;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.plugin.voip.b.d.dG(android.content.Context):boolean");
    }
    ...
    private static boolean dH(Context context) {
        ...
        Cursor query;
        try {
            query = context.getContentResolver().query(syN, new String[]{"suggestAccept", "userAccept", "userPrompt", "userReject"}, "pkgName='com.tencent.mm'", null, null);
            if (query != null) {
                try {
                    ...
                    th = th2;
                    try {
                        x.w("gray", "isLbePermissionEnable", th, Integer.valueOf(WXMediaMessage.MINI_PROGRAM__THUMB_LENGHT));
                        if (query != null) {
                            query.close();
                        }
                        return false;
    ...
    public static boolean bJa() {
        ...
        srVar.fLl.fvG = 2;
        a.xmy.m(srVar);
        return srVar.fLm.fLn;
    }

    public static boolean bJb() {
        b bgVar = new bg();
        a.xmy.m(bgVar);
        return bgVar.fqq.fds;
    }

    public static boolean bJc() {
        b auVar = new au();
        a.xmy.m(auVar);
        return auVar.fpQ.fpR;
    }
