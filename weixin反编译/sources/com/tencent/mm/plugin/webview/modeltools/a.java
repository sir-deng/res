...
public final class a {
    public static void d(MMActivity mMActivity, String str) {
        if (mMActivity != null && !mMActivity.isFinishing() && !bi.oN(str)) {
    ...
    public static Intent a(MMActivity mMActivity, Intent intent, String str) {
        ...
        intent2.putExtra("title", mMActivity.getString(R.l.dTJ));
    ...
    public static boolean b(MMActivity mMActivity, int i, int i2, Intent intent) {
        ...
        if (-1 == i2 && intent != null) {
            ...
            r rVar = (r) v.t(0, null);
            Intent intent2;
            if (rVar.RV(stringExtra)) {
                if (rVar.ed(mMActivity)) {
                ...
                if (booleanExtra) {
                    g.pWK.h(10998, Integer.valueOf(4), Integer.valueOf(2));
                } else {
                    g.pWK.h(10998, Integer.valueOf(4), Integer.valueOf(1));
                }
            } else {
                intent2 = new Intent((Intent) bundleExtra.getParcelable("targetintent"));
                intent2.setPackage(stringExtra);
                intent2.addFlags(SQLiteGlobal.journalSizeLimit);
                mMActivity.startActivity(intent2);
                g.pWK.h(10998, Integer.valueOf(5));
                if (booleanExtra) {
                    g.pWK.h(10998, Integer.valueOf(5), Integer.valueOf(2));
                } else {
                    g.pWK.h(10998, Integer.valueOf(5), Integer.valueOf(1));
                }
            }
        }
        return true;
