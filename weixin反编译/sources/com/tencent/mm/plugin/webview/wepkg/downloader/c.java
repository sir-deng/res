...
*/
    ...
    L_0x0016:
        ...
        r0 = r15.tSf;	 Catch:{ Exception -> 0x0180, all -> 0x01fe }
        ...
        r15.tSh = r0;	 Catch:{ Exception -> 0x0180, all -> 0x01fe }
        r0 = r15.tSh;	 Catch:{ Exception -> 0x0180, all -> 0x01fe }
        r2 = r15.tSf;	 Catch:{ Exception -> 0x0180, all -> 0x01fe }
        r2 = r2.tSI;	 Catch:{ Exception -> 0x0180, all -> 0x01fe }
        r0.setConnectTimeout(r2);	 Catch:{ Exception -> 0x0180, all -> 0x01fe }
        r0 = r15.tSh;	 Catch:{ Exception -> 0x0180, all -> 0x01fe }
        r2 = r15.tSf;	 Catch:{ Exception -> 0x0180, all -> 0x01fe }
        r2 = r2.tSJ;	 Catch:{ Exception -> 0x0180, all -> 0x01fe }
    ...
    L_0x007f:
        ...
        r12 = r15.tSf;	 Catch:{ Exception -> 0x0180, all -> 0x01fe }
        r12 = r12.tSC;	 Catch:{ Exception -> 0x0180, all -> 0x01fe }
    ...
    L_0x00a8:
        r15.tSm = r0;	 Catch:{ Exception -> 0x0180, all -> 0x01fe }
    L_0x00aa:
    ...
    L_0x00e8:
        r15.bVQ();	 Catch:{ Exception -> 0x0180, all -> 0x01fe }
        r0 = "MicroMsg.Wepkg.WePkgDownloadTask";	 Catch:{ Exception -> 0x0180, all -> 0x01fe }
    ...
    L_0x0104:
        r0 = r15.tSf;	 Catch:{ Exception -> 0x0180, all -> 0x01fe }
        r0 = r0.tSL;	 Catch:{ Exception -> 0x0180, all -> 0x01fe }
        if (r0 == 0) goto L_0x028c;	 Catch:{ Exception -> 0x0180, all -> 0x01fe }
    L_0x010a:
        r0 = r15.tSf;	 Catch:{ Exception -> 0x0180, all -> 0x01fe }
        r10 = r0.tSL;	 Catch:{ Exception -> 0x0180, all -> 0x01fe }
        r0 = new com.tencent.mm.plugin.webview.wepkg.downloader.g;	 Catch:{ Exception -> 0x0180, all -> 0x01fe }
        r1 = r15.tSf;	 Catch:{ Exception -> 0x0180, all -> 0x01fe }
        r2 = 1;	 Catch:{ Exception -> 0x0180, all -> 0x01fe }
        r3 = 0;	 Catch:{ Exception -> 0x0180, all -> 0x01fe }
        r4 = r15.tSn;	 Catch:{ Exception -> 0x0180, all -> 0x01fe }
    ...
    L_0x0177:
        r0 = r15.tSf;	 Catch:{ Exception -> 0x0180, all -> 0x01fe }
        r0 = r0.mFilePath;	 Catch:{ Exception -> 0x0180, all -> 0x01fe }
        com.tencent.mm.pluginsdk.i.a.e.a.SF(r0);	 Catch:{ Exception -> 0x0180, all -> 0x01fe }
        goto L_0x00aa;
    L_0x0180:
        r0 = move-exception;
    ...
    L_0x01ec:
        ...
        r3 = com.tencent.mm.sdk.platformtools.ad.getContext();	 Catch:{ Exception -> 0x0180, all -> 0x01fe }
    ...
    private void bVQ() {
        ...
        r1 = 0;
        r0 = 0;
        r2 = r13.tSh;	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        ...
        r7 = 0;
        r8 = r13.tSf;	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        r8 = r8.tSC;	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        ...
        r6[r7] = r8;	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        com.tencent.mm.sdk.platformtools.x.i(r2, r5, r6);	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
    ...
    L_0x002d:
        r2 = r13.mStatusCode;	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        r13.retCode = r2;	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
    L_0x0031:
        com.tencent.mm.pluginsdk.i.a.e.a.g(r1);
        com.tencent.mm.pluginsdk.i.a.e.a.g(r0);
    L_0x0037:
        return;
    L_0x0038:
        r2 = r13.tSh;	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        ...
        r5 = "Content-Range";
        r2 = r2.getHeaderField(r5);	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        r13.tSi = r2;	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        r2 = r13.tSh;	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        r5 = "Content-Length";
        r2 = r2.getHeaderField(r5);	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        r13.tSj = r2;	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        r2 = r13.tSh;	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        r5 = "bytes";
        r6 = "Accept-Ranges";
    ...
    L_0x0070:
        r2 = r4;
    L_0x0071:
        r5 = r13.tSm;	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
    ...
    L_0x0077:
        ...
        com.tencent.mm.sdk.platformtools.x.i(r5, r6);	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        r5 = r13.tSf;	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        r5 = r5.mFilePath;	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        com.tencent.mm.pluginsdk.i.a.e.a.SF(r5);	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        r5 = r13.tSj;	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        r6 = QE(r5);	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        r5 = r2;
    L_0x008e:
        r13.tSn = r5;	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        r2 = "MicroMsg.Wepkg.WePkgDownloadTask";
        ...
        r10 = 0;
        r11 = r13.tSf;	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        r11 = r11.tSC;	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        r9[r10] = r11;	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        r10 = 1;
        r11 = r13.tSi;	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        r9[r10] = r11;	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        r10 = 2;
        r11 = r13.tSj;	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        r9[r10] = r11;	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        r10 = 3;
        ...
        r9[r10] = r11;	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        com.tencent.mm.sdk.platformtools.x.i(r2, r8, r9);	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        r8 = -1;
    ...
    L_0x00c5:
        ...
        r0 = r12;
    L_0x00ca:
        r3 = r13.tSl;	 Catch:{ all -> 0x026f }
        if (r3 == 0) goto L_0x025f;
    L_0x00ce:
        r3 = 1001; // 0x3e9 float:1.403E-42 double:4.946E-321;
        r13.retCode = r3;	 Catch:{ all -> 0x026f }
    L_0x00d2:
        ...
        com.tencent.mm.sdk.platformtools.x.e(r3, r4, r5);	 Catch:{ all -> 0x026f }
        com.tencent.mm.pluginsdk.i.a.e.a.g(r2);
        com.tencent.mm.pluginsdk.i.a.e.a.g(r1);
        goto L_0x0037;
    L_0x00ed:
        r2 = r13.tSi;	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
    ...
    L_0x00ff:
        ...
        goto L_0x0071;
    L_0x0102:
        r5 = r13.tSi;	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        r5 = QD(r5);	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
    ...
    L_0x010f:
        ...
        com.tencent.mm.sdk.platformtools.x.i(r2, r5);	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        r2 = r13.tSf;	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        r2 = r2.mFilePath;	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        com.tencent.mm.pluginsdk.i.a.e.a.SF(r2);	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        r2 = r13.tSj;	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        r6 = QE(r2);	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        r5 = r3;
        goto L_0x008e;
    L_0x0128:
        r2 = "MicroMsg.Wepkg.WePkgDownloadTask";
    ...
    L_0x013a:
        r2 = r13.tSf;	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        r8 = r2.tSG;	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        r10 = 0;
    ...
    L_0x014c:
        ...
        r5 = 0;
        r8 = r13.tSf;	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        r8 = r8.tSG;	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        ...
        com.tencent.mm.sdk.platformtools.x.i(r2, r3, r4);	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
    ...
    L_0x017c:
        ...
        r13.tSk = r2;	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        r2 = r13.tSh;	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        r6 = r2.getInputStream();	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        r2 = r13.tSk;	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
        r2 = com.tencent.mm.sdk.platformtools.bi.oN(r2);	 Catch:{ Exception -> 0x00c5, all -> 0x0170 }
    ...
    L_0x01a2:
        r1 = r13.tSf;	 Catch:{ Exception -> 0x01db, all -> 0x02a8 }
        r6 = r1.mFilePath;	 Catch:{ Exception -> 0x01db, all -> 0x02a8 }
        r1 = r13.tSf;	 Catch:{ Exception -> 0x01db, all -> 0x02a8 }
        r1 = r1.tSC;	 Catch:{ Exception -> 0x01db, all -> 0x02a8 }
        r7 = r13.tSm;	 Catch:{ Exception -> 0x01db, all -> 0x02a8 }
    ...
    L_0x01b0:
        ...
        com.tencent.mm.sdk.platformtools.x.d(r7, r8, r9);	 Catch:{ Exception -> 0x01db, all -> 0x02a8 }
        r7 = com.tencent.mm.sdk.platformtools.bi.oN(r6);	 Catch:{ Exception -> 0x01db, all -> 0x02a8 }
    ...
    L_0x01e9:
        ...
        r7 = 0;
        r8 = r13.tSf;	 Catch:{ Exception -> 0x02ae }
        r8 = r8.tSC;	 Catch:{ Exception -> 0x02ae }
        r6[r7] = r8;	 Catch:{ Exception -> 0x02ae }
        r7 = 1;
        r8 = r13.tSm;	 Catch:{ Exception -> 0x02ae }
        ...
        com.tencent.mm.sdk.platformtools.x.i(r0, r4, r6);	 Catch:{ Exception -> 0x02ae }
    ...
    L_0x022b:
        ...
        r6 = 0;
        r7 = r13.tSf;	 Catch:{ Exception -> 0x02ae }
        ...
        com.tencent.mm.sdk.platformtools.x.i(r3, r4, r5);	 Catch:{ Exception -> 0x02ae }
        ...
        r5 = 0;
        r6 = r13.tSf;	 Catch:{ Exception -> 0x02ae }
        r6 = r6.mUrl;	 Catch:{ Exception -> 0x02ae }
        r4[r5] = r6;	 Catch:{ Exception -> 0x02ae }
        com.tencent.mm.sdk.platformtools.x.i(r0, r3, r4);	 Catch:{ Exception -> 0x02ae }
        r0 = r1;
        r1 = r2;
        goto L_0x0031;
    L_0x025f:
        r3 = com.tencent.mm.y.as.CN();	 Catch:{ all -> 0x026f }
        r3 = r3.Ks();	 Catch:{ all -> 0x026f }
    ...
    L_0x02b1:
        ...
        goto L_0x008e;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.plugin.webview.wepkg.downloader.c.bVQ():void");
    }
    ...
    private static long QE(String str) {
        if (!TextUtils.isEmpty(str)) {
            try {
