...
public class DownloadFileService extends IntentService {
    ...
    public void onCreate() {
        super.onCreate();
        d dVar = new d(this);
        dVar.a("Something Download").b("Download in progress").U(a.icon);
        startForeground(4657, dVar.build());
    }

    protected void onHandleIntent(Intent intent) {
        String string = intent.getExtras().getString(SlookSmartClipMetaTag.TAG_TYPE_URL);
        this.lxd = (ResultReceiver) intent.getParcelableExtra("receiver");
                ...
                if (responseCode == 200) {
                    ...
                    while (true) {
                        ...
                        if (read != -1) {
                            ...
                            this.lxe = read + this.lxe;
                            Bundle bundle = new Bundle();
                            int i = (int) ((((long) this.lxe) * 100) / ((long) intValue));
                            if (i > this.lxf) {
                                bundle.putInt("progress", i);
                                this.lxd.send(4657, bundle);
                                this.lxf = i;
                            }
                        }
                    }
