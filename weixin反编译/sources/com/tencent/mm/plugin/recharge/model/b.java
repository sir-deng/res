...
public final class b {
    ...
    public static MallRechargeProduct d(String str, JSONObject jSONObject) {
        ...
        mallRechargeProduct.pHt = str;
        mallRechargeProduct.frQ = jSONObject.getString("product_id");
        mallRechargeProduct.lKx = jSONObject.getString("product_name");
        mallRechargeProduct.pHu = jSONObject.optString("product_desc");
        mallRechargeProduct.pHv = ((float) jSONObject.getInt("product_min_price")) / 100.0f;
        mallRechargeProduct.pHw = ((float) jSONObject.getInt("product_max_price")) / 100.0f;
        ...
        mallRechargeProduct.pHx = z;
        mallRechargeProduct.pHy = jSONObject.getInt("left_count");
        mallRechargeProduct.pHz = jSONObject.getInt("discount");
        ...
        mallRechargeProduct.pHC = true;
        mallRechargeProduct.pHA = jSONObject.optInt("product_type", 0);
