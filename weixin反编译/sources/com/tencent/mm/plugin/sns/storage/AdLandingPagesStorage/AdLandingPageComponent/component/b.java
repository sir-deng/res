...
public abstract class b extends i {
    ...
    protected final void a(LinearLayout linearLayout) {
        ...
        if (linearLayout != null) {
            ...
            int i = (int) cVar.rlX;
            int i2 = (int) cVar.rlY;
            if (Double.compare(cVar.rlX, cVar.rlY) != 0) {
                if (i == 0 && cVar.rlX != 0.0d) {
                    i = 1;
                }
                if (i2 == 0 && cVar.rlY != 0.0d) {
                    i2 = 1;
                }
            } else if (i == 0) {
                i2 = 1;
            ...
            x.i("AdLandingBorderedComp", "border width top %d,bottom %d", Integer.valueOf(i), Integer.valueOf(i2));
            if (i > 0) {
                linearLayout2 = new LinearLayout(linearLayout.getContext());
                linearLayout2.setBackgroundColor(cVar.rlZ);
