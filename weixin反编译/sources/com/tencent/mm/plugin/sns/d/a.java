...
public final class a {
    public static n c(String str, Options options, DecodeResultLogger decodeResultLogger) {
        ...
        try {
            Bitmap a = l.EH().a(str, options, decodeResultLogger);
            if (a != null) {
                a = i.s(str, a);
            }
            x.d("MicroMsg.SnsBitmapUtil", "decodeWithRotateByExif used %dms bitmap: %s", Long.valueOf(System.currentTimeMillis() - currentTimeMillis), a);
            return n.i(a);
