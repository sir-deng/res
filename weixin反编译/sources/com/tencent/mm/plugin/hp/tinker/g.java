...
public final class g {
    public static boolean ag(Context context, String str) {
        ...
        if (bi.oN(string) || bi.oN(str) || !string.equalsIgnoreCase(str)) {
            return false;
        }
        return true;
    }
    ...
    public static void cW(Context context) {
        int i = com.tencent.mm.j.g.Af().getInt("TinkerCheckUpdateInterval", 12);
        if (i < 0) {
            x.i("MicroMsg.Tinker.TinkerPatchSharedPreferencesUtil", "saveTinkerCheckUpdateTinker hours < 0 ");
            return;
        }
        x.i("MicroMsg.Tinker.TinkerPatchSharedPreferencesUtil", "saveTinkerCheckUpdateTinker hours:%d", Integer.valueOf(i));
