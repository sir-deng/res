...
public final class a extends SpannableString {
    ...
    public final void setSpan(Object obj, int i, int i2, int i3) {
        if (this.Rw + 1 >= this.tYV.length) {
            int i4 = this.Rw + 10;
            Object obj2 = new Object[i4];
            Object obj3 = new int[(i4 * 3)];
            System.arraycopy(this.tYV, 0, obj2, 0, this.Rw);
            System.arraycopy(this.tYW, 0, obj3, 0, this.Rw * 3);
            this.tYV = obj2;
            this.tYW = obj3;
        }
        this.tYV[this.Rw] = obj;
        this.tYW[(this.Rw * 3) + 0] = i;
        this.tYW[(this.Rw * 3) + 1] = i2;
        this.tYW[(this.Rw * 3) + 2] = i3;
        this.Rw++;
    }

    public final void removeSpan(Object obj) {
        int i = this.Rw;
        Object obj2 = this.tYV;
        Object obj3 = this.tYW;
