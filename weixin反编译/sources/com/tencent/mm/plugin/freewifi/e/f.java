...
public final class f extends e implements a {
    private String mHK = this.intent.getStringExtra("free_wifi_passowrd");

    public f(FreeWifiFrontPageUI freeWifiFrontPageUI) {
        super(freeWifiFrontPageUI);
        x.i("MicroMsg.FreeWifi.ProtocolFour", "sessionKey=%s, step=%d, desc=Data retrieved. password=%s", m.D(this.intent), Integer.valueOf(m.E(this.intent)), this.mHK);
    }

    public final void connect() {
        final c cVar = new c(this.ssid, this.mKM, this.mHK);
        j.aMt();
        j.aMy().aMg().post(new Runnable() {
            ...
            L_0x0025:
                r0 = r2.ssid;
                r4 = com.tencent.mm.plugin.freewifi.model.d.aMn();
                r0 = r0.equals(r4);
                if (r0 == 0) goto L_0x0035;
            L_0x0031:
                r3.onSuccess();
            ...
            L_0x0078:
                ...
                com.tencent.mm.sdk.platformtools.x.i(r4, r5);	 Catch:{ all -> 0x012f }
                if (r0 == 0) goto L_0x00a7;
            L_0x009b:
                r3.qi(r0);	 Catch:{ all -> 0x012f }
                r2.aLz();
                r0 = r2.mHC;
                r0.unlock();
                goto L_0x0034;
            ...
            L_0x00c7:
                r0 = r2.mHJ;	 Catch:{ InterruptedException -> 0x00e6 }
                if (r0 != 0) goto L_0x0143;
            L_0x00cb:
                r0 = r2.fcU;	 Catch:{ InterruptedException -> 0x00e6 }
                r4 = r2.hoU;	 Catch:{ InterruptedException -> 0x00e6 }
            ...
            L_0x00e6:
                ...
                r7 = com.tencent.mm.plugin.freewifi.m.D(r7);	 Catch:{ all -> 0x012f }
                r5[r6] = r7;	 Catch:{ all -> 0x012f }
                r6 = 1;
                r7 = r2.activity;	 Catch:{ all -> 0x012f }
                r7 = r7.getIntent();	 Catch:{ all -> 0x012f }
                r7 = com.tencent.mm.plugin.freewifi.m.E(r7);	 Catch:{ all -> 0x012f }
                r7 = java.lang.Integer.valueOf(r7);	 Catch:{ all -> 0x012f }
                r5[r6] = r7;	 Catch:{ all -> 0x012f }
                r6 = 2;
                r0 = r0.getMessage();	 Catch:{ all -> 0x012f }
                r5[r6] = r0;	 Catch:{ all -> 0x012f }
                com.tencent.mm.sdk.platformtools.x.i(r1, r4, r5);	 Catch:{ all -> 0x012f }
                r0 = -17;
                r3.qi(r0);	 Catch:{ all -> 0x012f }
                r2.aLz();
                r0 = r2.mHC;
