...
public final class a {
    private static final int mJf = b.mIb.aLE();
    private static final int mJg = b.mIb.aLF();
    ...
    public static void a(java.lang.String r5, com.tencent.mm.plugin.freewifi.a.a.a r6) {
        ...
        r0 = com.tencent.mm.plugin.freewifi.m.Bf(r5);
    ...
    L_0x0024:
        r1 = mJf;	 Catch:{ Exception -> 0x0052, all -> 0x0064 }
        r0.setConnectTimeout(r1);	 Catch:{ Exception -> 0x0052, all -> 0x0064 }
        r1 = mJg;	 Catch:{ Exception -> 0x0052, all -> 0x0064 }
        r0.setReadTimeout(r1);	 Catch:{ Exception -> 0x0052, all -> 0x0064 }
        r1 = "User-Agent";
        r2 = com.tencent.mm.plugin.freewifi.h.b.mIb;	 Catch:{ Exception -> 0x0052, all -> 0x0064 }
        ...
        r6.e(r0);	 Catch:{ IOException -> 0x004d, Exception -> 0x005f, all -> 0x0064 }
    L_0x0047:
    ...
    public static void a(java.lang.String r13, java.lang.String r14, com.tencent.mm.plugin.freewifi.a.a.a r15) {
        ...
        r2[r3] = r14;
        com.tencent.mm.sdk.platformtools.x.i(r0, r1, r2);
        r0 = com.tencent.mm.plugin.freewifi.m.Bf(r13);
        if (r0 != 0) goto L_0x001e;
    L_0x0018:
        r0 = com.tencent.mm.plugin.freewifi.m.Bf(r14);
    ...
    L_0x004e:
        r2 = mJf;	 Catch:{ Exception -> 0x0188, all -> 0x019c }
        r0.setConnectTimeout(r2);	 Catch:{ Exception -> 0x0188, all -> 0x019c }
        r2 = mJg;	 Catch:{ Exception -> 0x0188, all -> 0x019c }
        r0.setReadTimeout(r2);	 Catch:{ Exception -> 0x0188, all -> 0x019c }
        r2 = "User-Agent";
        r3 = com.tencent.mm.plugin.freewifi.h.b.mIb;	 Catch:{ Exception -> 0x0188, all -> 0x019c }
        ...
        r15.e(r0);	 Catch:{ IOException -> 0x0182, Exception -> 0x0196, all -> 0x019c }
    L_0x00b5:
        if (r0 == 0) goto L_0x001e;
    L_0x00b7:
        r0.disconnect();
