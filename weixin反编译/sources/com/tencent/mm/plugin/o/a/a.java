...
public final class a extends com.tencent.mm.bp.a {
    public LinkedList<b> nHo = new LinkedList();

    protected final int a(int i, Object... objArr) {
        if (i == 0) {
            ((e.a.a.c.a) objArr[0]).d(1, 8, this.nHo);
            return 0;
        } else if (i == 1) {
            return e.a.a.a.c(1, 8, this.nHo) + 0;
        } else {
            byte[] bArr;
            if (i == 2) {
                bArr = (byte[]) objArr[0];
                ...
                switch (intValue) {
                    case 1:
                        ...
                        for (intValue = 0; intValue < size; intValue++) {
                            ...
                            for (boolean z = true; z; z = bVar.a(aVar4, bVar, com.tencent.mm.bp.a.a(aVar4))) {
                            }
                            aVar3.nHo.add(bVar);
                        }
                        return 0;
