...
public final class f {
    ...
    public f(String str) {
        this.mUrl = str;
        this.fileName = g.Gr(this.mUrl);
        x.i("MicroMsg.PieceFileCache", "PieceFileCache mUrl:%s, fileName:%s,", this.mUrl, this.fileName);
    }
    ...
    public final synchronized void setLength(long j) {
        if (this.randomAccessFile == null) {
            ...
            Logger.e("MicroMsg.PieceFileCache", "set file length %s ", String.valueOf(j));
            try {
    ...
    public final synchronized long beR() {
        long length;
