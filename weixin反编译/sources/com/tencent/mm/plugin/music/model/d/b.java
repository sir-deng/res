...
public final class b {
    private static final NumberFormat oRq;

    static {
        NumberFormat instance = NumberFormat.getInstance(Locale.US);
        oRq = instance;
        instance.setMinimumFractionDigits(2);
        oRq.setMaximumFractionDigits(2);
        oRq.setGroupingUsed(false);
    }
    ...
    public static String dQ(long j) {
        return j == -9223372036854775807L ? "?" : oRq.format((double) (((float) j) / 1000.0f));
    }
