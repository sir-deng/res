...
public class WalletJsApiAdapterUI extends WalletBaseUI {
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.sOn = getIntent().getStringExtra("intent_jump_ui");
        jl(580);
        if (getIntent() == null) {
    ...
    public final boolean d(int i, int i2, String str, k kVar) {
        x.i("MicroMsg.WalletJsApiAdapterUI", "onSceneEnd errType %s errCode %s errMsg %s scene %s", Integer.valueOf(i), Integer.valueOf(i2), str, kVar);
        if (i != 0 || i2 != 0) {
            setResult(DownloadResult.CODE_UNDEFINED);
            h.bu(this, str);
            finish();
            ...
            d.b(this, this.packageName, this.sOn, intent, 1);
            return true;
        }
    }
