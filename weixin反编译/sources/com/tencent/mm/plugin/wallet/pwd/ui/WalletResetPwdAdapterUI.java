...
public class WalletResetPwdAdapterUI extends WalletBaseUI {
    protected String gBJ = null;
    protected boolean pRx = false;
    protected com.tencent.mm.plugin.wallet.a pRy = null;
    protected String sNE = "";

    public void onCreate(Bundle bundle) {
        super.onCreate(bundle);
        uV(8);
        this.sNE = getIntent().getStringExtra("reset_pwd_token");
        x.i("MicroMsg.WalletResetPwdAdapterUI", "token_by_resetPwd %s", this.sNE);
        jl(580);
        if (getIntent() == null) {
    ...
    public final boolean d(int i, int i2, String str, k kVar) {
        if (i != 0 || i2 != 0) {
            ...
            bundle.putString("kreq_token", this.sNE);
