...
public final class m {
    ...
    public static k a(k kVar, long j) {
        ...
        x.d("MicroMsg.IPCallRecordStorageLogic", "recordSelfShutdownCall, localId: %d, talkTime: %d", Long.valueOf(kVar.xrR), Long.valueOf(j));
        if (kVar.xrR == -1) {
            return kVar;
        }
        kVar.field_status = 4;
    ...
    public static java.util.ArrayList<com.tencent.mm.plugin.ipcall.a.g.k> aUO() {
        /*
        r8 = java.lang.System.currentTimeMillis();
        r0 = com.tencent.mm.plugin.ipcall.a.i.aUl();
        ...
        r0 = r0.gLA;
        r1 = "IPCallRecord";
        r2 = com.tencent.mm.plugin.ipcall.a.g.l.nMx;
        r3 = "calltime>=?";
        r4 = 1;
    ...
    L_0x00cd:
        ...
        com.tencent.mm.sdk.platformtools.x.e(r2, r3, r4);	 Catch:{ all -> 0x0152 }
        r1.close();
    L_0x00e4:
        ...
        return r5;
    L_0x00fd:
        r0 = com.tencent.mm.sdk.platformtools.ad.getContext();	 Catch:{ Exception -> 0x00cd }
        r2 = r6.field_phonenumber;	 Catch:{ Exception -> 0x00cd }
        r0 = com.tencent.mm.plugin.ipcall.b.a.al(r0, r2);	 Catch:{ Exception -> 0x00cd }
        r2 = com.tencent.mm.plugin.ipcall.a.i.aUk();	 Catch:{ Exception -> 0x00cd }
        r7 = r2.Dj(r0);	 Catch:{ Exception -> 0x00cd }
        if (r7 == 0) goto L_0x019d;
    L_0x0111:
        r0 = com.tencent.mm.plugin.ipcall.a.i.aUl();	 Catch:{ Exception -> 0x00cd }
        r2 = r0.gLA;	 Catch:{ Exception -> 0x00cd }
        r2 = r2 instanceof com.tencent.mm.bx.h;	 Catch:{ Exception -> 0x00cd }
        if (r2 == 0) goto L_0x0157;
    L_0x011b:
        r0 = r0.gLA;	 Catch:{ Exception -> 0x00cd }
        r0 = (com.tencent.mm.bx.h) r0;	 Catch:{ Exception -> 0x00cd }
        r2 = -1;
        r2 = r0.dA(r2);	 Catch:{ Exception -> 0x00cd }
    L_0x0125:
        r0 = com.tencent.mm.plugin.ipcall.a.i.aUl();	 Catch:{ Exception -> 0x00cd }
        r10 = r6.field_phonenumber;	 Catch:{ Exception -> 0x00cd }
        r0 = r0.Dm(r10);	 Catch:{ Exception -> 0x00cd }
    ...
    L_0x013b:
        ...
        r12 = r7.xrR;	 Catch:{ Exception -> 0x00cd }
        r10.field_addressId = r12;	 Catch:{ Exception -> 0x00cd }
        r11 = com.tencent.mm.plugin.ipcall.a.i.aUl();	 Catch:{ Exception -> 0x00cd }
    ...
    L_0x015a:
        r0 = com.tencent.mm.plugin.ipcall.a.i.aUl();	 Catch:{ Exception -> 0x00cd }
        r7 = r0.gLA;	 Catch:{ Exception -> 0x00cd }
        r7 = r7 instanceof com.tencent.mm.bx.h;	 Catch:{ Exception -> 0x00cd }
    ...
    L_0x016a:
        r0 = r0.gLA;	 Catch:{ Exception -> 0x00cd }
        r0 = (com.tencent.mm.bx.h) r0;	 Catch:{ Exception -> 0x00cd }
        r0.fT(r2);	 Catch:{ Exception -> 0x00cd }
    L_0x0171:
        r0 = new java.lang.StringBuilder;	 Catch:{ Exception -> 0x00cd }
        r0.<init>();	 Catch:{ Exception -> 0x00cd }
        r2 = r6.field_addressId;	 Catch:{ Exception -> 0x00cd }
    ...
    L_0x01b4:
        ...
        goto L_0x0059;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.plugin.ipcall.a.g.m.aUO():java.util.ArrayList<com.tencent.mm.plugin.ipcall.a.g.k>");
    }
}
