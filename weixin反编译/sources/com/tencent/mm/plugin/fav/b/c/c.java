...
public final class c extends i<e> implements l {
    ...
    public final /* synthetic */ boolean a(e eVar) {
        return super.b((com.tencent.mm.sdk.e.c) eVar);
    }
    ...
    public c(com.tencent.mm.sdk.e.e eVar) {
        super(eVar, e.gKN, "FavEditInfo", null);
        this.gLA = eVar;
        this.gLA.fD("FavEditInfo", "CREATE INDEX IF NOT EXISTS IndexLocalId_Type ON FavEditInfo(localId,type);");
    }

    public final e db(long j) {
        e eVar = null;
        Cursor a = this.gLA.a("select * from FavEditInfo where localId =  ? and type =  ?", new String[]{String.valueOf(j), "0"}, 2);
        if (a != null) {
            if (a.moveToFirst()) {
                eVar = new e();
                eVar.b(a);
    ...
    public final void p(long j, int i) {
        this.gLA.delete("FavEditInfo", "localId=? and type=?", new String[]{String.valueOf(j), String.valueOf(i)});
    }

    public final List<e> aIE() {
        Cursor a = this.gLA.a("select count(*) from FavEditInfo", null, 2);
        if (a == null) {
        ...
        try {
            if (a.moveToFirst()) {
                x.i("MicroMsg.Fav.FavEditInfoStorage", "get all edit infos, count %d", Integer.valueOf(a.getInt(0)));
            }
            a.close();
            a = this.gLA.a("select * from FavEditInfo", null, 2);
            if (a == null) {
                return null;
            }
