...
public class FFmpegMetadataRetriever {
    ...
    public int getVideoWidth() {
        try {
            ...
            x.e(TAG, "can not get video width %s", e.getMessage());
            return 0;
        }
    }
    ...
    public int getVideoRotation() {
        ...
        try {
            ...
            x.e(TAG, "can not get video rotation. %s", e.getMessage());
            return i;
        }
    }
    ...
    public int getVideoHeight() {
        try {
            ...
            x.d(TAG, "video height %s rotate %s", extractMetadata, extractMetadata2);
            return Integer.valueOf(extractMetadata).intValue();
        } catch (Exception e) {
            x.e(TAG, "can not get video height %s", e.getMessage());
            return 0;
        }
    }
