...
public abstract class a {
        ...
        if (auVar != null) {
            ...
            if (a >= 0) {
                if (!arrayList.isEmpty()) {
                    b.atn().ato().al(arrayList);
                }
                if (!arrayList2.isEmpty()) {
                    b.atn().ato().am(arrayList2);
                }
            }
        }
    }
            ...
            if (aVar2 != null) {
                ...
                if (aVar3 != null) {
                    if (aVar2.field_msgSubType != aVar3.field_msgSubType) {
                        ...
                        if (!bi.fA(aVar2.field_path, aVar3.field_path)) {
                            aVar2.xrR = aVar3.xrR;
                            list4.add(aVar2);
                        } else if (!bi.L(aVar2.field_size, aVar3.field_size)) {
                            aVar2.xrR = aVar3.xrR;
                            list4.add(aVar2);
                        }
                        i++;
    ...
    protected final String wy(String str) {
        if (bi.oN(str)) {
            return "";
        }
        String str2 = g.Dq().gRS;
        int indexOf = str.indexOf(str2);
        if (indexOf < 0) {
            return str;
        }
        x.d("MicroMsg.AbstractMsgHandler", "%s cut down result[%s] root[%s] path[%s]", atw(), str.substring(indexOf + str2.length()), str2, str);
