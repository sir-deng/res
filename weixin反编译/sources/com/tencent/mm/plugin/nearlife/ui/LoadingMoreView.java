...
public class LoadingMoreView extends LinearLayout {
    ...
    private ImageView fzb = ((ImageView) findViewById(R.h.csV));
    protected LinearLayout kUr;

    public LoadingMoreView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        this.context = context;
        View inflate = LayoutInflater.from(this.context).inflate(R.i.dmK, this, true);
        this.kUr = (LinearLayout) inflate.findViewById(R.h.ctB);
