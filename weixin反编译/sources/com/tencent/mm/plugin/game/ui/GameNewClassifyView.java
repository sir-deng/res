...
public class GameNewClassifyView extends LinearLayout implements OnClickListener {
    ...
    public final void a(ec ecVar, int i, int i2) {
        ...
        while (this.mAt.getChildCount() < ecVar.nmz.size()) {
            linearLayout = (LinearLayout) this.ntf.inflate(R.i.dlf, this, false);
        ...
        setVisibility(0);
        if (i == 2) {
            ap.a(getContext(), 10, 1019, 0, null, this.niV, null);
        }
    }
    ...
    public void onClick(View view) {
        if (view.getTag() != null && (view.getTag() instanceof a)) {
            ...
            if (!bi.oN(aVar.url)) {
                ...
                ap.a(getContext(), 10, 1019, aVar.position, 7, null, this.niV, ap.CD(aVar.extInfo));
            }
        }
    }
}
