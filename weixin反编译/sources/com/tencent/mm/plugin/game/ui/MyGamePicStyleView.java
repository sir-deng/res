...
public class MyGamePicStyleView extends LinearLayout implements OnClickListener {
    ...
    protected void onFinishInflate() {
        ...
        this.nBU = (ImageView) findViewById(R.h.cCI);
    ...
    public void onClick(View view) {
        ...
        ap.a(this.mContext, 10, 1002, anVar.nmE, c.p(this.mContext, anVar.nmG.nkN, "game_center_mygame_comm"), this.appId, this.niV, ap.CD(anVar.nlr));
    }
}
