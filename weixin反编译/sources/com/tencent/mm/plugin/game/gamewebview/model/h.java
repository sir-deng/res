...
public final class h {
    public static void c(d dVar) {
        dVar.Cw(GameJsApiSendAppMessage.NAME);
        if (dVar.bs(GameJsApiSendAppMessage.NAME, 89)) {
            dVar.cO("menu:share:appmessage", "");
            return;
        }
        ...
        dVar.cP(GameJsApiSendAppMessage.NAME, jSONObject.toString());
    }
    ...
    public static void a(d dVar, JSONObject jSONObject) {
        ...
        c.d dVar2 = (c.d) dVar.nfh.get(dVar.aPR());
        if (TextUtils.isEmpty(optString) || dVar2 == null || dVar2.tNg == null || dVar2.tNg.size() <= 0) {
            i = 0;
        } else {
            int i2;
            ...
            for (String substring3 : dVar2.tNg) {
