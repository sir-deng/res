...
public final class bs extends bea {
    public String hxn;
        ...
        if (i == 0) {
            ...
            switch (intValue) {
                case 1:
                    ...
                    return 0;
                case 2:
                    bsVar.nnm = aVar3.AEQ.readString();
                    return 0;
                case 3:
                    bsVar.nnJ.add(aVar3.AEQ.readString());
                    return 0;
                case 4:
                    bsVar.hxn = aVar3.AEQ.readString();
                    return 0;
                case 5:
                    JD = aVar3.JD(intValue);
                    size = JD.size();
                    ...
                    return 0;
                case 6:
                    bsVar.nnL = aVar3.AEQ.rz();
                    return 0;
                case 7:
                    bsVar.nnM = aVar3.cKv();
                    return 0;
                case 8:
                    bsVar.nnn = aVar3.AEQ.rz();
                    return 0;
                default:
                    return -1;
            }
