...
public class talk {
    public static int oLp = 8000;
    public static int oLq = 20;
    ...
    static {
        try {
            if (com.tencent.pb.common.a.a.zUT && com.tencent.pb.common.a.a.zVk) {
                com.tencent.pb.common.c.a.l("stlport_shared", d.syL);
                com.tencent.pb.common.c.a.l("wechatxlog", d.syL);
                com.tencent.pb.common.c.a.l("voipMain", d.syL);
            }
        } catch (Throwable th) {
            c.m("loadLibrary: ", th);
        }
