...
public class a {
    ...
    public static final int igT = c.ak("----");
    private int igU;
    private long igV;
    public long igW;
    private int type;
    ...
    public final long getSize() {
        ...
        return (long) this.igU;
    }

    public String toString() {
        StringBuilder append = new StringBuilder("Atom{atomSize=").append(this.igU).append(", atomLargeSize=").append(this.igV).append(", type=");
        int i = this.type;
        return append.append(new String(new byte[]{(byte) ((i >> 24) & 255), (byte) ((i >> 16) & 255), (byte) ((i >> 8) & 255), (byte) (i & 255)})).append(", beginPos=").append(this.igW).append('}').toString();
    }
}
