...
public final class e extends a {
    public static final int iho = c.ak("vide");
    public static final int ihp = c.ak("soun");
    public static final int ihq = c.ak("hint");
    long duration = 0;
    long ihr = 0;
    long ihs = 0;
    long iht = 0;
    ...
    public final boolean a(RandomAccessFile randomAccessFile, byte[] bArr) {
        ...
        while (read >= 8) {
            ...
            if (y2 == a.ake) {
                ...
                this.iht = randomAccessFile.getFilePointer() - ((long) read);
                j = (long) (y - read);
                obj3 = obj2;
                obj2 = obj4;
                i = 1;
