...
public final class a {
    public static ArrayList<d> a(String str, String str2, String str3, String str4, Map<String, String> map, List<c> list) {
        ...
        com.tencent.mm.x.g.a I = com.tencent.mm.x.g.a.I(str3, str4);
        if (I != null) {
            Map map2 = I.hcK;
            ...
            if (!(map2 == null || map2.isEmpty())) {
                String str7;
                String str8;
                x.d("MicroMsg.ExdeviceMsgXmlParser", "ap: map %s", map2.toString());
                int i = 0;
                while (true) {
                ...
                x.i("MicroMsg.ExdeviceMsgXmlParser", "follow should break now : %d", Integer.valueOf(i));
                int i2 = 0;
                while (true) {
                    ...
                    if (bi.oN(str7)) {
                        x.i("MicroMsg.ExdeviceMsgXmlParser", "should break now : %d", Integer.valueOf(i2));
                        return arrayList;
                    }
    ...
    public static void a(String str, String str2, Map<String, String> map) {
        int i = 0;
        x.d("MicroMsg.ExdeviceMsgXmlParser", "ap: only nickname: %s", str);
        if (bi.oN(str)) {
            x.e("MicroMsg.ExdeviceMsgXmlParser", "rank info is null or nil");
            return;
        }
        com.tencent.mm.x.g.a I = com.tencent.mm.x.g.a.I(str, str2);
        if (I != null) {
            Map map2 = I.hcK;
            if (map2 != null && !map2.isEmpty()) {
                String str3;
