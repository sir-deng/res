        ...
        if ("linear".equalsIgnoreCase(optString)) {
            ...
            for (i = 0; i < optJSONArray2.length(); i++) {
                ...
                if (optJSONArray3.length() >= 2) {
                    ...
                    iArr[i] = com.tencent.mm.plugin.appbrand.q.f.i(optJSONArray3.optJSONArray(1));
                }
            }
            ...
            d3 = com.tencent.mm.plugin.appbrand.q.f.d(optJSONArray, 2);
            if (d3 <= 0.0f) {
                x.i("MicroMsg.Canvas.SetFillStyleAction", "setFillStyle(radial) failed, sr(%s) <= 0.", Float.valueOf(d3));
                return false;
            }
            ...
            for (i = 0; i < optJSONArray4.length(); i++) {
                ...
                if (optJSONArray2.length() >= 2) {
                    ...
                    iArr2[i] = com.tencent.mm.plugin.appbrand.q.f.i(optJSONArray2.optJSONArray(1));
                }
            }
            ...
            aVar.setShader(null);
            aVar.setColor(com.tencent.mm.plugin.appbrand.q.f.i(optJSONArray));
            ...
            Bitmap aT = fVar.iNZ.aT(fVar.gQA, optString);
            if (!(aT == null || aT.isRecycled())) {
                Shader bitmapShader;
                int ma = com.tencent.mm.plugin.appbrand.q.f.ma(aT.getWidth());
                int ma2 = com.tencent.mm.plugin.appbrand.q.f.ma(aT.getHeight());
                Object obj = -1;
                ...
                switch (obj) {
                    case null:
                        bitmapShader = new BitmapShader(Bitmap.createScaledBitmap(aT, ma, ma2, false), TileMode.REPEAT, TileMode.REPEAT);
                        break;
                    case 1:
                        createBitmap = Bitmap.createBitmap(ma, ma2 + 1, Config.ARGB_8888);
                        new Canvas(createBitmap).drawBitmap(aT, new Rect(0, 0, aT.getWidth(), aT.getHeight()), new RectF(0.0f, 0.0f, (float) ma, (float) ma2), null);
                        bitmapShader = new BitmapShader(createBitmap, TileMode.REPEAT, TileMode.CLAMP);
                        break;
                    case 2:
                        createBitmap = Bitmap.createBitmap(ma + 1, ma2, Config.ARGB_8888);
                        new Canvas(createBitmap).drawBitmap(aT, new Rect(0, 0, aT.getWidth(), aT.getHeight()), new RectF(0.0f, 0.0f, (float) ma, (float) ma2), null);
                        bitmapShader = new BitmapShader(createBitmap, TileMode.CLAMP, TileMode.REPEAT);
                        break;
                    case 3:
                        createBitmap = Bitmap.createBitmap(ma + 1, ma2 + 1, Config.ARGB_8888);
                        new Canvas(createBitmap).drawBitmap(aT, new Rect(0, 0, aT.getWidth(), aT.getHeight()), new RectF(0.0f, 0.0f, (float) ma, (float) ma2), null);
