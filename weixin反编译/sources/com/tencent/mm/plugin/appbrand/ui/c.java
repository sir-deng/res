...
public final class c extends a {
    static c bI(String str, String str2) {
        c cVar = new c();
    ...
    public final void initView() {
        ...
        imageView.setImageResource(i.iAs);
        LayoutParams layoutParams = new LinearLayout.LayoutParams(lP(50), lP(50));
        layoutParams.topMargin = lP(91);
        ...
        layoutParams2.topMargin = lP(16);
        layoutParams2.gravity = 1;
        linearLayout.addView(textView, layoutParams2);
        ((ViewGroup) this.Iv).addView(linearLayout, new LayoutParams(-1, -1));
        com.tencent.mm.plugin.appbrand.report.a.a(this.itU, "", "", 0, "", this.jQF);
    }
}
