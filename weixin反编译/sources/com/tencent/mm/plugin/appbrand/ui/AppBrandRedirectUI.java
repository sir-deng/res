...
public class AppBrandRedirectUI extends MMActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (this.fromScene == 0) {
            ...
            String simCountryIso = ((TelephonyManager) this.mController.xRr.getSystemService("phone")).getSimCountryIso();
            if (!bi.oN(simCountryIso)) {
                b.a h = b.h(this, simCountryIso, this.mController.xRr.getString(j.bZd));
                if (h != null) {
