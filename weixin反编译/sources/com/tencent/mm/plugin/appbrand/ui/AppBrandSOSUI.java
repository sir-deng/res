...
public class AppBrandSOSUI extends FTSSOSMoreWebViewUI {
    ...
    public void onCreate(Bundle bundle) {
        ...
        x.i("MicroMsg.AppBrandSOSUI", "onCreate oreh report weAppSearchClickStream(13929) statSessionId:%s", this.jRy);
    ...
    protected final void dealContentView(View view) {
        ...
        findViewById.setOnClickListener(new OnClickListener() {
            public final void onClick(View view) {
                if (!TextUtils.isEmpty(AppBrandSOSUI.this.jRx)) {
                    Intent intent = new Intent();
                    intent.putExtra("showShare", false);
                    intent.putExtra("rawUrl", AppBrandSOSUI.this.jRx);
