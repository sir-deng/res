...
final class c extends a {
    ...
    protected final boolean a(Context context, LaunchParcel launchParcel) {
        ...
        if ((context instanceof AppBrandUI) && !(context instanceof AppBrandPluginUI) && !(context instanceof AppBrandInToolsUI) && ((launchParcel.iRl == null || launchParcel.iRl.iRp != 1) && launchParcel.jEr.scene != 1085)) {
            z = true;
        }
        if (z) {
