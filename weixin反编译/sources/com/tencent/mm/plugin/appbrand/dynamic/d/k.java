...
public final class k extends a {
    ...
    protected final void a(com.tencent.mm.t.c.a aVar, JSONObject jSONObject, b.a<JSONObject> aVar2) {
        if (i.rK(aVar.Ci().getString("__page_view_id", null)) == null) {
        ...
        for (int i = 0; i < optJSONArray.length(); i++) {
            try {
                ...
                if (optInt > 0 && !bi.oN(optString)) {
                    g.pWK.h(optInt, r3.getAppId(), Integer.valueOf(r3.adb()), Integer.valueOf(com.tencent.mm.plugin.appbrand.dynamic.k.a.ka(r3.ada()) + 1), optString);
                }
            } catch (Exception e) {
