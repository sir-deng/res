...
public final class at extends a {
    ...
    public final void a(j jVar, JSONObject jSONObject, int i) {
        ...
        x.i("MicroMsg.JsApiPageNotFoundCallback", "pageNotFoundCallback data:%s", jSONObject);
        ...
        if (valueOf.booleanValue()) {
            if (b != null) {
                ...
                if (b.hashCode() != optInt) {
                    x.e("MicroMsg.JsApiPageNotFoundCallback", "appBrandPageView.getComponentId():%d, webviewId:%d, err", Integer.valueOf(b.hashCode()), Integer.valueOf(optInt));
                }
            } else {
