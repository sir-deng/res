...
public final class i extends a {
    ...
    public final void a(j jVar, JSONObject jSONObject, int i) {
        a.kv(JsApiLaunchMiniProgram.CTRL_INDEX);
        ...
        if (f.fO(18)) {
                    ...
                    for (BluetoothDevice bluetoothDevice : connectedDevices) {
                        ...
                        if (!hashMap.containsKey(address)) {
                            ...
                            try {
                                ...
                                x.e("MicroMsg.JsApiGetBluetoothDevices", "put JSON data error : %s", e);
                            }
                        }
                    }
                }
            ...
            try {
                ...
                x.e("MicroMsg.JsApiGetBluetoothDevices", "put json value error : %s", Log.getStackTraceString(e2));
            }
