...
public final class p extends a {
    ...
    public final void a(j jVar, JSONObject jSONObject, int i) {
        ...
        x.i("MicroMsg.JsApiWriteBLECharacteristicValue", "writeBLECharacteristicValue data %s", jSONObject);
    ...
    private static byte[] V(byte[] bArr) {
        ...
        x.d("MicroMsg.JsApiWriteBLECharacteristicValue", "write data = %s", toUpperCase);
