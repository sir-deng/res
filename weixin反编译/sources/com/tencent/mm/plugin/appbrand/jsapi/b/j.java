...
public final class j extends a {
    ...
    public final void a(com.tencent.mm.plugin.appbrand.j jVar, JSONObject jSONObject, int i) {
        a.kv(com.tencent.mm.plugin.game.gamewebview.jsapi.biz.j.CTRL_BYTE);
        ...
        if (f.fO(18)) {
            ...
            for (BluetoothDevice bluetoothDevice : connectedDevices) {
                ...
                try {
                    ...
                    x.e("MicroMsg.JsApiGetConnectedBluetoothDevices", "put JSON data error : %s", e);
                }
            }
            ...
            x.i("MicroMsg.JsApiGetConnectedBluetoothDevices", "retJson %s", jSONObject3.toString());
