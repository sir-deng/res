...
public final class b extends a {
    ...
    public final void a(final j jVar, final JSONObject jSONObject, final int i) {
        ...
        if (a == null) {
            x.e("MicroMsg.JsApiChooseContact", "getPageContext failed, appid is %s", jVar.mAppId);
            ...
            public final void onRequestPermissionsResult(int i, String[] strArr, int[] iArr) {
                if (i == 48) {
                    if (iArr == null || iArr.length <= 0 || iArr[0] != 0) {
                        jVar.E(i, b.this.e("permission_denied", null));
                    } else {
                        b.this.a(jVar, jSONObject, i);
                    }
                }
            }
        });
        ...
        a.jCj = new MMActivity.a() {
            public final void b(int i, int i2, Intent intent) {
                if (100 != i) {
                    x.e("MicroMsg.JsApiChooseContact", "requestcode not equal, requestCode = %d", Integer.valueOf(i));
                    jVar.E(i, b.this.e("fail", null));
                } else if (i2 == 0 || i2 == 1) {
                    jVar.E(i, b.this.e("cancel", null));
                } else if (i2 == -1) {
                        ...
                        try {
                            ...
                            if (query != null && query.getCount() > 0) {
                                ...
                                if (columnIndex <= 0 || query.getInt(columnIndex) > 0) {
                                    ...
                                    x.i("MicroMsg.JsApiChooseContact", "onActivityResult, queried cursor = %s", query);
                                    if (query2 == null) {
                                        jVar.E(i, b.this.e("fail", null));
                                        return;
                                    }
                                    ...
                                    jVar.E(i, b.this.e("fail", null));
                                    Toast.makeText(a, q.j.iDm, 0).show();
                                    return;
                                }
                            }
                            obj = null;
                            ...
                            x.e("MicroMsg.JsApiChooseContact", "onActivityResult, permission denied: %s", e2.toString());
                            h.b(a, ad.getResources().getString(q.j.iDy), "", true);
                            jVar.E(i, b.this.e("fail:system permission denied", null));
                        }
                    } else {
