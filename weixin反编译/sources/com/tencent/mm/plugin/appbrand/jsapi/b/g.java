...
public final class g extends a {
    ...
    public final void a(j jVar, JSONObject jSONObject, int i) {
        ...
        x.i("MicroMsg.JsApiGetBLEDeviceServices", "getBLEDeviceServices data %s", jSONObject.toString());
        ...
        if (b.jkS) {
            ...
            for (Entry entry : map.entrySet()) {
                ...
                boolean c = bi.c((Boolean) entry.getValue());
                if (bi.oN(str)) {
                ...
                try {
                    ...
                    x.e("MicroMsg.JsApiGetBLEDeviceServices", "JSONException %s", e.getMessage());
                }
            }
            ...
            x.i("MicroMsg.JsApiGetBLEDeviceServices", "retJson %s", jSONObject3.toString());
