...
public final class k extends a {
    ...
    protected static final UUID jlb = UUID.fromString("00002902-0000-1000-8000-00805f9b34fb");
    public static String jlc = "notification";
    public static String jld = "indication";
    ...
    public final void a(j jVar, JSONObject jSONObject, int i) {
        ...
        if (f.fO(18)) {
            ...
            String optString4 = jSONObject.optString(Columns.TYPE, jld);
            ...
            BluetoothGattDescriptor descriptor = bluetoothGattCharacteristic.getDescriptor(jlb);
            if (descriptor == null) {
            ...
            if ((properties & 16) != 0 && (properties & 32) == 0) {
                ...
                if (optString4.toLowerCase().equals(jlc)) {
                    descriptor.setValue(optBoolean ? BluetoothGattDescriptor.ENABLE_NOTIFICATION_VALUE : BluetoothGattDescriptor.DISABLE_NOTIFICATION_VALUE);
                } else {
