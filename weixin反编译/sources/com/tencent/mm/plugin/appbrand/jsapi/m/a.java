                ...
                if (!TextUtils.isEmpty(string)) {
                    if (string.startsWith(AppBrandLocalMediaObjectManager.OBJECT_NAME_PREFIX)) {
                        ...
                        if (!(itemByLocalId == null || TextUtils.isEmpty(itemByLocalId.hjJ))) {
                            String str = itemByLocalId.hjJ;
                            if (!str.startsWith("file://")) {
                                str = "file://" + str;
                            }
                            bitmap = b.Jp().a(str, null);
                        }
                    } else if (string.startsWith("https://") || string.startsWith("http://")) {
                        bitmap = b.Jp().a(string, null);
                        if (bitmap == null) {
                            b.Jp().a(imageView, string, null, null);
                        }
                    } else {
                        bitmap = o.j(pVar.iuk, string);
                    }
    ...
    public static void a(TextView textView, JSONObject jSONObject) {
        if (textView != null && jSONObject != null) {
            ...
            try {
                ...
                if (!bi.oN(string)) {
                    textView.setTextColor(f.vg(string));
                }
            } catch (JSONException e) {
            }
            try {
            ...
            if (textView instanceof com.tencent.mm.plugin.appbrand.widget.f) {
                ...
                if (fVar.kaB == null) {
                    fVar.kaB = new com.tencent.mm.plugin.appbrand.widget.g.a((float) a);
                }
                if (fVar.kaB.ad((float) a)) {
                    fVar.invalidate();
                }
            }
            try {
