    ...
    public final void a(final j jVar, JSONObject jSONObject, final int i) {
        ...
        a.jCj = new com.tencent.mm.ui.MMActivity.a() {
            public final void b(int i, int i2, Intent intent) {
                ...
                int i4;
                if (i == 1000) {
                    x.i("MicroMsg.JsApiFaceAsyncBase", "alvinluo: requestWxFacePictureVerify errCode: %d", Integer.valueOf(i3));
                    if (i3 == 0) {
                        aVar = a.this;
                        jVar = jVar;
                        i4 = i;
                    ...
                    x.i("MicroMsg.JsApiFaceAsyncBase", "hy: REQUEST_FACE_DETECT_WITH_VIDEO errCode: %d", Integer.valueOf(i3));
                    if (i3 == 0) {
                        aVar = a.this;
                        jVar = jVar;
                        i4 = i;
