...
public final class r extends a {
    ...
    public final void a(final j jVar, JSONObject jSONObject, final int i) {
        ...
        try {
            ...
            View lG = b.aeW().lG(i2);
            if (lG == null) {
                x.w("MicroMsg.JsApiCanvasPutImageData", "view(%s) is null.", Integer.valueOf(i2));
                ...
                if (w instanceof a) {
                    ...
                    Math.round(((float) optInt) * aml);
                    Math.round(((float) optInt2) * aml);
                    Math.round(((float) optInt3) * aml);
                    Math.round(aml * ((float) optInt4));
                    if (optInt3 == 0 || optInt4 == 0) {
                        x.i("MicroMsg.JsApiCanvasPutImageData", "width(%s) or height(%s) is 0.(%s)", Integer.valueOf(optInt3), Integer.valueOf(optInt4), Integer.valueOf(i2));
                    ...
                    try {
                        ...
                        if (obj instanceof ByteBuffer) {
                            ...
                            try {
                                ...
                                a aVar = (a) w;
                                aVar.b(jSONArray, new a.a() {
                                    public final void abF() {
                                        jVar.E(i, r.this.e("ok", null));
                                    }
                                });
                                aVar.abx();
                                return;
                            } catch (JSONException e) {
                                x.w("MicroMsg.JsApiCanvasPutImageData", "put json value error : %s", e);
                        ...
                        x.i("MicroMsg.JsApiCanvasPutImageData", "get data failed, %s", Log.getStackTraceString(e2));
                        jVar.E(i, e("fail:missing data", null));
                        return;
                    }
                }
                x.i("MicroMsg.JsApiCanvasPutImageData", "the view is not a instance of CanvasView.(%s)", Integer.valueOf(i2));
                jVar.E(i, e("fail:illegal view type", null));
            } else {
                x.w("MicroMsg.JsApiCanvasPutImageData", "the viewId is not a canvas(%s).", Integer.valueOf(i2));
                jVar.E(i, e("fail:illegal view type", null));
            }
        } catch (Throwable e22) {
            x.i("MicroMsg.JsApiCanvasPutImageData", "get canvas id failed, %s", Log.getStackTraceString(e22));
