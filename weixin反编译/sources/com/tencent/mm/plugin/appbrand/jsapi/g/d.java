...
public final class d extends a {
    ...
    public final void a(final j jVar, JSONObject jSONObject, final int i) {
        ...
        try {
            ...
            if (a.jsn.a(a, jVar.iuk.itc, jSONObject, new b.a() {
                public final void a(int i, String str, Map<String, Object> map) {
                    switch (i) {
                        case 1:
                            ...
                            return;
                        case 2:
                            jVar.E(i, d.this.e("fail:" + str, null));
                            return;
                        case 3:
                            jVar.E(i, d.this.e("cancel", null));
                            return;
                        default:
                            return;
                    }
                ...
                if (b != null) {
                    ...
                    reportSubmitFormTask.jkD = str.replace("prepay_id=", "");
                    reportSubmitFormTask.fDk = b.getURL();
