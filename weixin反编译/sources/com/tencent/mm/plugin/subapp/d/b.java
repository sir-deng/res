...
public final class b {
    public static void b(String str, int i, int i2, int i3, int i4) {
        ...
        g.pWK.h(14220, Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3), Integer.valueOf(i2 + i3), Integer.valueOf(i4), str);
    }
}
