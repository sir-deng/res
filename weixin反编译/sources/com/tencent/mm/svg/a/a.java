...
public final class a {
    private static String xKO = ".svg.code.drawable";
    protected static int xKP = 3;
    private static String xKQ = "";
    private static Map<Integer, c> xKR = new ConcurrentHashMap();
    private static Map<Integer, Picture> xKS = new ConcurrentHashMap();
    private static Map<String, Picture> xKT = new ConcurrentHashMap();
    private static Float xKU;
    private TypedValue xKM = new TypedValue();
    private byte[] xKN = new byte[0];
    ...
    private static Drawable a(Resources resources, int i, float f) {
        ...
        if (i == 0) {
            ...
            if (f > 0.0f) {
                ...
                picture = (Picture) xKT.get(str4);
                if (picture == null) {
                    picture = a(f2, a(resources, i, str), f3);
                    xKT.put(str4, picture);
                }
                return new c(picture, i);
            }
            picture = (Picture) xKS.get(Integer.valueOf(i));
            if (picture == null) {
                picture = a(f2, a(resources, i, str), f3);
                xKS.put(Integer.valueOf(i), picture);
            }
            return new c(picture, i);
        }
    }
    ...
    public final boolean d(Resources resources, int i) {
        try {
            if (resources.getResourceTypeName(i).equals("raw")) {
                String charSequence;
                synchronized (this.xKN) {
                    TypedValue typedValue = this.xKM;
                    if (typedValue == null) {
    ...
    public static Map<Integer, c> clQ() {
        return xKR;
    }
    ...
    protected static View v(Drawable drawable) {
        while (true) {
    ...
    private static Drawable c(Resources resources, int i, float f) {
        ...
        try {
            ...
            float f2 = resources.getDisplayMetrics().density;
            float f3 = (f > 0.0f ? f : 1.0f) * ((viewPort[0] / ((float) xKP)) * f2);
            float f4 = (viewPort[1] / ((float) xKP)) * f2;
            if (f <= 0.0f) {
                f = 1.0f;
            }
            float f5 = f4 * f;
    ...
    private static c a(Resources resources, int i, String str) {
        Object obj = "";
        try {
            if (xKR.containsKey(Integer.valueOf(i))) {
                return (c) xKR.get(Integer.valueOf(i));
            }
            ...
            xKR.put(Integer.valueOf(i), cVar);
            return cVar;
        } catch (Throwable e) {
            x.printErrStackTrace("MicroMsg.SVGCompat", e, "", new Object[0]);
    ...
    private static Picture a(float f, c cVar, float f2) {
        ...
        if (cVar == null) {
            ...
            if (xKU == null) {
                xKU = Float.valueOf(f / ((float) xKP));
            }
            float floatValue = xKU.floatValue() * f2;
