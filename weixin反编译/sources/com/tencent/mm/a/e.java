...
public final class e {
                ...
                if (i >= 0 && i2 > 0 && i + i2 <= ((int) file.length())) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            try {
                                x.printErrStackTrace("MicroMsg.FileOperation", e2, "", new Object[0]);
                                x.w("MicroMsg.FileOperation", "file op readFromFile e type:%s, e msg:%s, fileName:%s, offset:%d, len:%d", e2.getClass().getSimpleName(), e2.getMessage(), str, Integer.valueOf(i), Integer.valueOf(i2));
                                if (randomAccessFile != null) {
                                    try {
                                        randomAccessFile.close();
                                    } catch (Throwable e22) {
                                        x.printErrStackTrace("MicroMsg.FileOperation", e22, "", new Object[0]);
                                        x.w("MicroMsg.FileOperation", "file op readFromFile close e type:%s, e msg:%s, fileName:%s, offset:%d, len:%d", e22.getClass().getSimpleName(), e22.getMessage(), str, Integer.valueOf(i), Integer.valueOf(i2));
                                    }
                                }
                                return bArr;
                            } catch (Throwable th2) {
                        ...
                        x.printErrStackTrace("MicroMsg.FileOperation", e222, "", new Object[0]);
                        x.w("MicroMsg.FileOperation", "file op readFromFile e type:%s, e msg:%s, fileName:%s, offset:%d, len:%d", e222.getClass().getSimpleName(), e222.getMessage(), str, Integer.valueOf(i), Integer.valueOf(i2));
                        if (randomAccessFile != null) {
                            randomAccessFile.close();
                        }
                        return bArr;
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    x.printErrStackTrace("MicroMsg.FileOperation", e2, "", new Object[0]);
                    x.w("MicroMsg.FileOperation", "file op readFromFileV2 close e type:%s, e msg:%s, fileName:%s, offset:%d, maxLen:%d", e2.getClass().getSimpleName(), e2.getMessage(), str, Integer.valueOf(i), Integer.valueOf(length));
                    return bArr;
                }
            } catch (Exception e3) {
                e2 = e3;
                try {
                    x.printErrStackTrace("MicroMsg.FileOperation", e2, "", new Object[0]);
                    x.w("MicroMsg.FileOperation", "file op readFromFileV2 e type:%s, e msg:%s, fileName:%s, offset:%d, maxLen:%d", e2.getClass().getSimpleName(), e2.getMessage(), str, Integer.valueOf(i), Integer.valueOf(length));
                    if (randomAccessFile != null) {
                        return bArr;
                    }
                    try {
                        ...
                        x.printErrStackTrace("MicroMsg.FileOperation", e22, "", new Object[0]);
                        x.w("MicroMsg.FileOperation", "file op readFromFileV2 close e type:%s, e msg:%s, fileName:%s, offset:%d, maxLen:%d", e22.getClass().getSimpleName(), e22.getMessage(), str, Integer.valueOf(i), Integer.valueOf(length));
                        return bArr;
                    }
                } catch (Throwable th2) {
                    th = th2;
                    if (randomAccessFile != null) {
                        try {
                            ...
                            x.printErrStackTrace("MicroMsg.FileOperation", e222, "", new Object[0]);
                            x.w("MicroMsg.FileOperation", "file op readFromFileV2 close e type:%s, e msg:%s, fileName:%s, offset:%d, maxLen:%d", e222.getClass().getSimpleName(), e222.getMessage(), str, Integer.valueOf(i), Integer.valueOf(length));
                        }
                    }
                    throw th;
                }
            ...
            randomAccessFile = null;
            x.printErrStackTrace("MicroMsg.FileOperation", e222, "", new Object[0]);
            x.w("MicroMsg.FileOperation", "file op readFromFileV2 e type:%s, e msg:%s, fileName:%s, offset:%d, maxLen:%d", e222.getClass().getSimpleName(), e222.getMessage(), str, Integer.valueOf(i), Integer.valueOf(length));
            if (randomAccessFile != null) {
                return bArr;
            }
            randomAccessFile.close();
    ...
    public static final boolean bS(String str) {
        if (bi.oN(str)) {
            return false;
        }
        File file = new File(str);
    ...
    public static String bT(String str) {
        ...
        try {
            ...
            try {
                ...
                while (true) {
                    ...
                    if (read != -1) {
                        ...
                        try {
                            ...
                            x.printErrStackTrace("MicroMsg.FileOperation", e2, "", new Object[0]);
                            x.w("MicroMsg.FileOperation", "file op readFileAsString close e type:%s, e msg:%s, filePath:%s", e2.getClass().getSimpleName(), e2.getMessage(), str);
                        }
                    }
                }
                ...
                try {
                    x.printErrStackTrace("MicroMsg.FileOperation", e, "", new Object[0]);
                    x.w("MicroMsg.FileOperation", "file op readFileAsString e type:%s, e msg:%s, filePath:%s", e.getClass().getSimpleName(), e.getMessage(), str);
                    throw e;
                } catch (Throwable th) {
                    e = th;
                    if (bufferedReader != null) {
                        try {
                            ...
                            x.printErrStackTrace("MicroMsg.FileOperation", e22, "", new Object[0]);
                            x.w("MicroMsg.FileOperation", "file op readFileAsString close e type:%s, e msg:%s, filePath:%s", e22.getClass().getSimpleName(), e22.getMessage(), str);
                        }
                    }
                    throw e;
                }
