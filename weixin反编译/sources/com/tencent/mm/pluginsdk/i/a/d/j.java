...
import com.tencent.mm.pluginsdk.i.a.c.b;
...
public final class j {
    private static final Class[] vos = new Class[]{InterruptedException.class};
    private static final Class[] vot = new Class[]{UnknownHostException.class, IllegalArgumentException.class, MalformedURLException.class, IOException.class, FileNotFoundException.class, a.class, d.class, g.class};
    private static final Class[] vou = new Class[]{SocketException.class, SocketTimeoutException.class};
    ...
    final com.tencent.mm.pluginsdk.i.a.d.l a(com.tencent.mm.pluginsdk.i.a.d.e r15) {
        /*
        r14 = this;
        r4 = 0;
        r8 = 1;
    ...
    L_0x0032:
        r2 = r15.aao();	 Catch:{ Exception -> 0x0262, all -> 0x025d }
        if (r2 != 0) goto L_0x003f;
    L_0x0038:
        r2 = r15.getFilePath();	 Catch:{ Exception -> 0x0262, all -> 0x025d }
        com.tencent.mm.pluginsdk.i.a.e.a.SF(r2);	 Catch:{ Exception -> 0x0262, all -> 0x025d }
    L_0x003f:
        can();	 Catch:{ Exception -> 0x0262, all -> 0x025d }
        ...
        r10 = 0;
        r11 = r15.bZW();	 Catch:{ Exception -> 0x0191, all -> 0x01f5 }
        ...
        can();	 Catch:{ Exception -> 0x0191, all -> 0x01f5 }
        a(r15, r2);	 Catch:{ Exception -> 0x0191, all -> 0x01f5 }
        can();	 Catch:{ Exception -> 0x0191, all -> 0x01f5 }
        r5 = r15.getFilePath();	 Catch:{ Exception -> 0x0191, all -> 0x01f5 }
        r10 = com.tencent.mm.pluginsdk.i.a.e.a.GW(r5);	 Catch:{ Exception -> 0x0191, all -> 0x01f5 }
        r5 = "MicroMsg.ResDownloader.NetworkPerformer";
        r6 = "%s: RangeOffset = %d";
        r9 = 2;
        r9 = new java.lang.Object[r9];	 Catch:{ Exception -> 0x0191, all -> 0x01f5 }
        r12 = 0;
        r13 = r15.bZW();	 Catch:{ Exception -> 0x0191, all -> 0x01f5 }
    ...
    L_0x009d:
        ...
        r11 = 0;
        r12 = r15.bZW();	 Catch:{ Exception -> 0x0191, all -> 0x01f5 }
    ...
    L_0x00c7:
        ...
        r3 = r0;
        r5 = "TLSv1.2";
        r5 = QC(r5);	 Catch:{ Exception -> 0x0191, all -> 0x01f5 }
    ...
    L_0x00f4:
        ...
        r9[r10] = r11;	 Catch:{ Exception -> 0x0191, all -> 0x01f5 }
        r10 = 1;
        r11 = r15.caj();	 Catch:{ Exception -> 0x0191, all -> 0x01f5 }
        r9[r10] = r11;	 Catch:{ Exception -> 0x0191, all -> 0x01f5 }
        com.tencent.mm.sdk.platformtools.x.d(r3, r5, r9);	 Catch:{ Exception -> 0x0191, all -> 0x01f5 }
        r3 = "POST";
        r5 = r15.caj();	 Catch:{ Exception -> 0x0191, all -> 0x01f5 }
        r3 = r3.equals(r5);	 Catch:{ Exception -> 0x0191, all -> 0x01f5 }
        if (r3 == 0) goto L_0x0148;
    L_0x011e:
        r3 = 0;
        r3 = com.tencent.mm.sdk.platformtools.bi.by(r3);	 Catch:{ Exception -> 0x0191, all -> 0x01f5 }
        if (r3 != 0) goto L_0x0148;
    L_0x0125:
        r3 = 1;
        r2.setDoOutput(r3);	 Catch:{ Exception -> 0x0191, all -> 0x01f5 }
        r3 = "Content-Type";
        r5 = r15.cam();	 Catch:{ Exception -> 0x0191, all -> 0x01f5 }
    ...
    L_0x017a:
        r5 = move-exception;
    L_0x017b:
        r5 = r15.cal();	 Catch:{ Exception -> 0x0191, all -> 0x01f5 }
    ...
    L_0x0200:
        ...
        r11 = 0;
        r12 = r15.bZW();	 Catch:{ all -> 0x0220 }
        r10[r11] = r12;	 Catch:{ all -> 0x0220 }
        com.tencent.mm.sdk.platformtools.x.e(r6, r9, r10);	 Catch:{ all -> 0x0220 }
        r6 = "MicroMsg.ResDownloader.NetworkPerformer";
        r9 = "";
        r10 = 0;
        r10 = new java.lang.Object[r10];	 Catch:{ all -> 0x0220 }
        com.tencent.mm.sdk.platformtools.x.printErrStackTrace(r6, r3, r9, r10);	 Catch:{ all -> 0x0220 }
    ...
    private static void a(e eVar, HttpURLConnection httpURLConnection) {
        x.d("MicroMsg.ResDownloader.NetworkPerformer", "%s: add http headers", eVar.bZW());
        Collection<b> cak = eVar.cak();
        if (cak != null && cak.size() > 0) {
            for (b bVar : cak) {
                httpURLConnection.addRequestProperty(bVar.name, bVar.value);
            }
        }
        httpURLConnection.setRequestMethod(eVar.caj());
        if ("GET".equalsIgnoreCase(eVar.caj())) {
    ...
    private static SSLContext QC(String str) {
        try {
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static com.tencent.mm.pluginsdk.i.a.d.l a(com.tencent.mm.pluginsdk.i.a.d.e r17, java.net.HttpURLConnection r18, boolean r19) {
        /*
        r2 = "MicroMsg.ResDownloader.NetworkPerformer";
    ...
    L_0x003b:
        ...
        r13 = 0;
        r14 = r17.bZW();	 Catch:{ InterruptedException -> 0x00ee, UnknownHostException -> 0x010c, SSLHandshakeException -> 0x011c, SocketException -> 0x014e, SocketTimeoutException -> 0x0181, IOException -> 0x02e0 }
        ...
        r14 = com.tencent.mm.pluginsdk.i.a.e.b.aq(r14);	 Catch:{ InterruptedException -> 0x00ee, UnknownHostException -> 0x010c, SSLHandshakeException -> 0x011c, SocketException -> 0x014e, SocketTimeoutException -> 0x0181, IOException -> 0x02e0 }
        r12[r13] = r14;	 Catch:{ InterruptedException -> 0x00ee, UnknownHostException -> 0x010c, SSLHandshakeException -> 0x011c, SocketException -> 0x014e, SocketTimeoutException -> 0x0181, IOException -> 0x02e0 }
        com.tencent.mm.sdk.platformtools.x.i(r2, r6, r12);	 Catch:{ InterruptedException -> 0x00ee, UnknownHostException -> 0x010c, SSLHandshakeException -> 0x011c, SocketException -> 0x014e, SocketTimeoutException -> 0x0181, IOException -> 0x02e0 }
        ...
        r12 = com.tencent.mm.pluginsdk.i.a.e.a.GW(r2);	 Catch:{ InterruptedException -> 0x00ee, UnknownHostException -> 0x010c, SSLHandshakeException -> 0x011c, SocketException -> 0x014e, SocketTimeoutException -> 0x0181, IOException -> 0x02e0 }
    ...
    L_0x0088:
        ...
        r9 = 0;
        r10 = r17.bZW();	 Catch:{ InterruptedException -> 0x00ee, UnknownHostException -> 0x010c, SSLHandshakeException -> 0x011c, SocketException -> 0x014e, SocketTimeoutException -> 0x0181, IOException -> 0x02e0 }
        ...
        com.tencent.mm.sdk.platformtools.x.i(r2, r6, r8);	 Catch:{ InterruptedException -> 0x00ee, UnknownHostException -> 0x010c, SSLHandshakeException -> 0x011c, SocketException -> 0x014e, SocketTimeoutException -> 0x0181, IOException -> 0x02e0 }
        r2 = new com.tencent.mm.pluginsdk.i.a.d.l;	 Catch:{ InterruptedException -> 0x00ee, UnknownHostException -> 0x010c, SSLHandshakeException -> 0x011c, SocketException -> 0x014e, SocketTimeoutException -> 0x0181, IOException -> 0x02e0 }
        r0 = r17;
        ...
        r3 = 0;
        com.tencent.mm.pluginsdk.i.a.e.a.g(r3);
        r3 = 0;
        com.tencent.mm.pluginsdk.i.a.e.a.g(r3);
    L_0x00aa:
        return r2;
    ...
    L_0x00cf:
        r2 = r17.aar();	 Catch:{ InterruptedException -> 0x00ee, UnknownHostException -> 0x010c, SSLHandshakeException -> 0x011c, SocketException -> 0x014e, SocketTimeoutException -> 0x0181, IOException -> 0x02e0 }
    ...
    L_0x00d5:
        ...
        r8[r9] = r10;	 Catch:{ InterruptedException -> 0x00ee, UnknownHostException -> 0x010c, SSLHandshakeException -> 0x011c, SocketException -> 0x014e, SocketTimeoutException -> 0x0181, IOException -> 0x02e0 }
        com.tencent.mm.sdk.platformtools.x.i(r2, r6, r8);	 Catch:{ InterruptedException -> 0x00ee, UnknownHostException -> 0x010c, SSLHandshakeException -> 0x011c, SocketException -> 0x014e, SocketTimeoutException -> 0x0181, IOException -> 0x02e0 }
        r2 = new com.tencent.mm.pluginsdk.i.a.c.d;	 Catch:{ InterruptedException -> 0x00ee, UnknownHostException -> 0x010c, SSLHandshakeException -> 0x011c, SocketException -> 0x014e, SocketTimeoutException -> 0x0181, IOException -> 0x02e0 }
    ...
    L_0x00f0:
        r2 = move-exception;
    L_0x00f1:
        com.tencent.mm.pluginsdk.i.a.e.a.g(r5);
        com.tencent.mm.pluginsdk.i.a.e.a.g(r4);
        if (r3 <= 0) goto L_0x0103;
    L_0x00f9:
        r4 = com.tencent.mm.y.ak.a.hhw;
    ...
    L_0x0106:
        r2 = new com.tencent.mm.pluginsdk.i.a.c.g;	 Catch:{ InterruptedException -> 0x00ee, UnknownHostException -> 0x010c, SSLHandshakeException -> 0x011c, SocketException -> 0x014e, SocketTimeoutException -> 0x0181, IOException -> 0x02e0 }
        r2.<init>();	 Catch:{ InterruptedException -> 0x00ee, UnknownHostException -> 0x010c, SSLHandshakeException -> 0x011c, SocketException -> 0x014e, SocketTimeoutException -> 0x0181, IOException -> 0x02e0 }
        throw r2;	 Catch:{ InterruptedException -> 0x00ee, UnknownHostException -> 0x010c, SSLHandshakeException -> 0x011c, SocketException -> 0x014e, SocketTimeoutException -> 0x0181, IOException -> 0x02e0 }
    L_0x010c:
        r2 = move-exception;
    L_0x010d:
        throw r2;	 Catch:{ all -> 0x00f0 }
    L_0x010e:
        r2 = r17.aap();	 Catch:{ InterruptedException -> 0x00ee, UnknownHostException -> 0x010c, SSLHandshakeException -> 0x011c, SocketException -> 0x014e, SocketTimeoutException -> 0x0181, IOException -> 0x02e0 }
    ...
    L_0x011d:
        ...
        r9 = 0;
        r10 = r17.bZW();	 Catch:{ all -> 0x00f0 }
        r8[r9] = r10;	 Catch:{ all -> 0x00f0 }
        com.tencent.mm.sdk.platformtools.x.e(r6, r7, r8);	 Catch:{ all -> 0x00f0 }
        r6 = "MicroMsg.ResDownloader.NetworkPerformer";
        r7 = "";
        r8 = 0;
        r8 = new java.lang.Object[r8];	 Catch:{ all -> 0x00f0 }
        com.tencent.mm.sdk.platformtools.x.printErrStackTrace(r6, r2, r7, r8);	 Catch:{ all -> 0x00f0 }
        throw r2;	 Catch:{ all -> 0x00f0 }
    L_0x013d:
    ...
    L_0x013f:
        r14 = (long) r9;
        r0 = r17;
        r2 = r0.bE(r14);	 Catch:{ InterruptedException -> 0x00ee, UnknownHostException -> 0x010c, SSLHandshakeException -> 0x011c, SocketException -> 0x014e, SocketTimeoutException -> 0x0181, IOException -> 0x02e0 }
        if (r2 != 0) goto L_0x0176;
    L_0x0148:
        r2 = new com.tencent.mm.pluginsdk.i.a.c.a;	 Catch:{ InterruptedException -> 0x00ee, UnknownHostException -> 0x010c, SSLHandshakeException -> 0x011c, SocketException -> 0x014e, SocketTimeoutException -> 0x0181, IOException -> 0x02e0 }
        r2.<init>();	 Catch:{ InterruptedException -> 0x00ee, UnknownHostException -> 0x010c, SSLHandshakeException -> 0x011c, SocketException -> 0x014e, SocketTimeoutException -> 0x0181, IOException -> 0x02e0 }
        throw r2;	 Catch:{ InterruptedException -> 0x00ee, UnknownHostException -> 0x010c, SSLHandshakeException -> 0x011c, SocketException -> 0x014e, SocketTimeoutException -> 0x0181, IOException -> 0x02e0 }
    L_0x014e:
        r2 = move-exception;
    L_0x014f:
        ...
        com.tencent.mm.sdk.platformtools.x.e(r6, r7);	 Catch:{ all -> 0x00f0 }
        throw r2;	 Catch:{ all -> 0x00f0 }
    L_0x0176:
        r2 = 416; // 0x1a0 float:5.83E-43 double:2.055E-321;
        if (r2 != r7) goto L_0x0183;
    L_0x017a:
        r2 = new com.tencent.mm.pluginsdk.i.a.c.b;	 Catch:{ InterruptedException -> 0x00ee, UnknownHostException -> 0x010c, SSLHandshakeException -> 0x011c, SocketException -> 0x014e, SocketTimeoutException -> 0x0181, IOException -> 0x02e0 }
    ...
    L_0x0183:
        ...
        r2 = com.tencent.mm.sdk.platformtools.bi.oN(r10);	 Catch:{ InterruptedException -> 0x0323, UnknownHostException -> 0x0316, SSLHandshakeException -> 0x0309, SocketException -> 0x02fc, SocketTimeoutException -> 0x02ef, IOException -> 0x02e6, all -> 0x02cd }
    ...
    L_0x01a1:
        ...
        r5 = r17.bZW();	 Catch:{ InterruptedException -> 0x01d9, UnknownHostException -> 0x031a, SSLHandshakeException -> 0x030d, SocketException -> 0x0300, SocketTimeoutException -> 0x02f3, IOException -> 0x02e6, all -> 0x02d1 }
    ...
    L_0x01ae:
        ...
        com.tencent.mm.sdk.platformtools.x.d(r12, r13, r14);	 Catch:{ InterruptedException -> 0x01d9, UnknownHostException -> 0x031a, SSLHandshakeException -> 0x030d, SocketException -> 0x0300, SocketTimeoutException -> 0x02f3, IOException -> 0x02e6, all -> 0x02d1 }
        r12 = com.tencent.mm.sdk.platformtools.bi.oN(r10);	 Catch:{ InterruptedException -> 0x01d9, UnknownHostException -> 0x031a, SSLHandshakeException -> 0x030d, SocketException -> 0x0300, SocketTimeoutException -> 0x02f3, IOException -> 0x02e6, all -> 0x02d1 }
    ...
    L_0x01df:
        ...
        r12 = 0;
        r13 = r17.bZW();	 Catch:{ InterruptedException -> 0x0222, UnknownHostException -> 0x031e, SSLHandshakeException -> 0x0311, SocketException -> 0x0304, SocketTimeoutException -> 0x02f7, IOException -> 0x02eb, all -> 0x02d5 }
        ...
        com.tencent.mm.sdk.platformtools.x.i(r2, r4, r10);	 Catch:{ InterruptedException -> 0x0222, UnknownHostException -> 0x031e, SSLHandshakeException -> 0x0311, SocketException -> 0x0304, SocketTimeoutException -> 0x02f7, IOException -> 0x02eb, all -> 0x02d5 }
    ...
    L_0x0219:
        ...
        r3 = r3 + r4;
        can();	 Catch:{ InterruptedException -> 0x0222, UnknownHostException -> 0x031e, SSLHandshakeException -> 0x0311, SocketException -> 0x0304, SocketTimeoutException -> 0x02f7, IOException -> 0x02eb, all -> 0x02d5 }
        goto L_0x020f;
    L_0x0222:
        r2 = move-exception;
        r4 = r5;
    ...
    L_0x0227:
        ...
        r10 = 0;
        r12 = r17.bZW();	 Catch:{ InterruptedException -> 0x0222, UnknownHostException -> 0x031e, SSLHandshakeException -> 0x0311, SocketException -> 0x0304, SocketTimeoutException -> 0x02f7, IOException -> 0x02eb, all -> 0x02d5 }
        ...
        r8[r10] = r12;	 Catch:{ InterruptedException -> 0x0222, UnknownHostException -> 0x031e, SSLHandshakeException -> 0x0311, SocketException -> 0x0304, SocketTimeoutException -> 0x02f7, IOException -> 0x02eb, all -> 0x02d5 }
        com.tencent.mm.sdk.platformtools.x.i(r2, r4, r8);	 Catch:{ InterruptedException -> 0x0222, UnknownHostException -> 0x031e, SSLHandshakeException -> 0x0311, SocketException -> 0x0304, SocketTimeoutException -> 0x02f7, IOException -> 0x02eb, all -> 0x02d5 }
        ...
        r8[r10] = r12;	 Catch:{ InterruptedException -> 0x0222, UnknownHostException -> 0x031e, SSLHandshakeException -> 0x0311, SocketException -> 0x0304, SocketTimeoutException -> 0x02f7, IOException -> 0x02eb, all -> 0x02d5 }
        com.tencent.mm.sdk.platformtools.x.i(r2, r4, r8);	 Catch:{ InterruptedException -> 0x0222, UnknownHostException -> 0x031e, SSLHandshakeException -> 0x0311, SocketException -> 0x0304, SocketTimeoutException -> 0x02f7, IOException -> 0x02eb, all -> 0x02d5 }
        r2 = r17.aap();	 Catch:{ InterruptedException -> 0x0222, UnknownHostException -> 0x031e, SSLHandshakeException -> 0x0311, SocketException -> 0x0304, SocketTimeoutException -> 0x02f7, IOException -> 0x02eb, all -> 0x02d5 }
        if (r2 == 0) goto L_0x0280;
    L_0x025d:
        r2 = new com.tencent.mm.pluginsdk.i.a.d.l;	 Catch:{ InterruptedException -> 0x0222, UnknownHostException -> 0x031e, SSLHandshakeException -> 0x0311, SocketException -> 0x0304, SocketTimeoutException -> 0x02f7, IOException -> 0x02eb, all -> 0x02d5 }
        ...
        r8 = com.tencent.mm.pluginsdk.i.a.e.a.GW(r4);	 Catch:{ InterruptedException -> 0x0222, UnknownHostException -> 0x031e, SSLHandshakeException -> 0x0311, SocketException -> 0x0304, SocketTimeoutException -> 0x02f7, IOException -> 0x02eb, all -> 0x02d5 }
        r0 = r17;
        ...
        com.tencent.mm.pluginsdk.i.a.e.a.g(r6);
        com.tencent.mm.pluginsdk.i.a.e.a.g(r5);
    ...
    L_0x029c:
        ...
        r3 = r16;
    L_0x02a4:
        com.tencent.mm.pluginsdk.i.a.e.a.g(r6);	 Catch:{ all -> 0x02da }
        ...
        r10 = 0;
        r11 = r17.bZW();	 Catch:{ all -> 0x02c7 }
        r9[r10] = r11;	 Catch:{ all -> 0x02c7 }
        r10 = 1;
        r9[r10] = r2;	 Catch:{ all -> 0x02c7 }
        com.tencent.mm.sdk.platformtools.x.e(r7, r8, r9);	 Catch:{ all -> 0x02c7 }
        r7 = new com.tencent.mm.pluginsdk.i.a.c.f;	 Catch:{ all -> 0x02c7 }
    ...
    L_0x0323:
        ...
        goto L_0x00ef;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.pluginsdk.i.a.d.j.a(com.tencent.mm.pluginsdk.i.a.d.e, java.net.HttpURLConnection, boolean):com.tencent.mm.pluginsdk.i.a.d.l");
    }
    ...
    private static l a(e eVar, Exception exception) {
        ...
        if (exception instanceof f) {
            ...
            exception = ((f) exception).voe;
        }
        x.i("MicroMsg.ResDownloader.NetworkPerformer", "%s: download failed, caused by %s", eVar.bZW(), exception);
        return new l(eVar, exception, i, 3);
    }

    private static l b(e eVar, Exception exception) {
        if (exception instanceof ProtocolException) {
            x.e("MicroMsg.ResDownloader.NetworkPerformer", "%s: Protocol not support, the protocol: %s", eVar.bZW(), eVar.caj());
            return a(eVar, exception);
        } else if (exception instanceof b) {
            x.e("MicroMsg.ResDownloader.NetworkPerformer", "%s: %s [%s]", eVar.bZW(), exception.getClass().getSimpleName(), exception.getMessage());
            com.tencent.mm.pluginsdk.i.a.e.a.SF(eVar.getFilePath());
            return null;
        } else {
            for (Object equals : vos) {
                if (equals.equals(exception.getClass())) {
                    x.i("MicroMsg.ResDownloader.NetworkPerformer", "%s: download canceled, caused by %s", eVar.bZW(), exception);
                    return new l(eVar, exception, 4);
                }
            }
            for (Object equals2 : vou) {
                if (equals2.equals(exception.getClass())) {
                    return null;
                }
            }
            for (Object equals3 : vot) {
