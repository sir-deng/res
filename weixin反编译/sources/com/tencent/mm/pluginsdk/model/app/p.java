...
public final class p {
    public static String f(Context context, String str, String str2) {
        ...
        return context.getString(h.luR, new Object[]{str, Integer.valueOf(d.vHl), d, d.DEVICE_TYPE, str2});
    }
    ...
    public static String w(Context context, String str, String str2) {
        ...
        return context.getString(h.luS, new Object[]{str, Integer.valueOf(d.vHl), d, d.DEVICE_TYPE, str2, Integer.valueOf(0)});
    }
    ...
    public static String aW(Context context, String str) {
        ...
        if (aX != null && aX.length != 0) {
            return Sp(g.s(aX[0].toByteArray()));
        }
    ...
    public static boolean b(Context context, f fVar, String str) {
        ...
        if (str == null || str.length() == 0) {
            ...
            if (aX == null || aX.length == 0) {
                ...
                int i = 0;
                while (i < length) {
                    x.i("MicroMsg.AppUtil", "local signatures:%s", Sp(g.s(aX[i].toByteArray())));
    ...
    public static boolean b(Context context, f fVar) {
        ...
        if (context == null) {
            ...
            return true;
        } else if (bi.oN(fVar.field_packageName)) {
            x.e("MicroMsg.AppUtil", "packageName is null.");
            return true;
        } else if (bi.oN(fVar.field_signature)) {
            ...
            for (Signature toByteArray : aX) {
                if (fVar.field_signature.equals(Sp(g.s(toByteArray.toByteArray())))) {
    ...
    public static void Sq(String str) {
        ...
        if (cgg != null) {
            String string = cgg.getString("key_app_ids_registion_while_not_login", "");
            ...
            cgg.edit().putString("key_app_ids_registion_while_not_login", stringBuilder.toString()).commit();
        }
    }
