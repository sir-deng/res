...
public final class o extends i<q> {
    public static final String[] gLy = new String[]{i.a(n.gKN, "AppSort")};
    public e gLA;

    public o(e eVar) {
        super(eVar, n.gKN, "AppSort", null);
        this.gLA = eVar;
        eVar.fD("AppSort", "CREATE INDEX IF NOT EXISTS flagIdIndex ON AppSort ( flag )");
        eVar.fD("AppSort", "CREATE INDEX IF NOT EXISTS flagIdIndex ON AppSort ( sortId )");
    }

    public final List<String> ft(long j) {
