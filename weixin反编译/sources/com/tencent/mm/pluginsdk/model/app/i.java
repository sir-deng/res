...
public final class i extends com.tencent.mm.sdk.e.i<f> {
    public static final String[] gLy = new String[]{com.tencent.mm.sdk.e.i.a(f.gKN, "AppInfo")};
    public final f<String, f> vkY = new f(50);
    ...
    public i(e eVar) {
        super(eVar, f.gKN, "AppInfo", o.fNF);
        c fVar = new f();
    ...
    private void k(f fVar) {
        if (fVar != null && fVar.field_appId != null) {
            this.vkY.l(fVar.field_appId, fVar);
        }
    }
    ...
    public final boolean l(f fVar) {
        if (fVar == null || bi.oN(fVar.field_appId) || !super.a((c) fVar, false)) {
            return false;
        }
    ...
    public final Cursor dj(int i, int i2) {
        ...
        x.d("MicroMsg.AppInfoStorage", "getServiceByAppInfoFlagAndShowFlag count = %d", Integer.valueOf(rawQuery.getCount()));
        return rawQuery;
    }

    public final Cursor bZw() {
        ...
        if (!file.exists()) {
            if (!file.getParentFile().exists()) {
                ...
                if (file2.mkdir()) {
                    ...
                    x.e("MicroMsg.AppInfoStorage", "mkdir error, %s", parentFile.getAbsolutePath());
                    if (i2 != 0) {
                        return null;
                    }
                    switch (i) {
                        case 1:
                            return a.FA() + g.s(str.getBytes()) + ".png";
                        case 2:
                            return a.FA() + g.s(str.getBytes()) + "_wm.png";
                        case 3:
                            return a.FA() + g.s(str.getBytes()) + "_sg.png";
                        case 4:
                            return a.FA() + g.s(str.getBytes()) + "_sp.png";
                        case 5:
                            return a.FA() + g.s(str.getBytes()) + "_sl.png";
                        default:
            ...
            if (!(file.mkdir() && file.isDirectory())) {
                x.e("MicroMsg.AppInfoStorage", "mkdir error. %s", r3);
                if (i2 != 0) {
                    return null;
                }
                switch (i) {
