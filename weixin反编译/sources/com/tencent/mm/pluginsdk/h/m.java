...
public final class m {
            ...
            if (charAt == '\'') {
                ...
                switch (charAt) {
                    ...
                    case 'a':
                        ...
                        break;
                    case 'd':
                        aMPMString = ez(time.monthDay, i2);
                        break;
                    case 'h':
                        length2 = time.hour;
                        if (length2 == 0) {
                        ...
                        break;
                    case 'k':
                        aMPMString = ez(time.hour, i2);
                        break;
                    case 'm':
                        aMPMString = ez(time.minute, i2);
                        break;
                    case 's':
                        aMPMString = ez(time.second, i2);
                        break;
                    case 'y':
                        length2 = time.year;
                        if (i2 > 2) {
                    ...
                    case 'z':
                        ...
                        stringBuilder.append(ez((int) (rawOffset / 3600), 2));
                        stringBuilder.append(ez(length2, 2));
    ...
    private static String ez(int i, int i2) {
