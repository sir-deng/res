...
public final class k {
    ...
    public static boolean a(Fragment fragment, Intent intent, String str, int i) {
        ...
        String nx = s.nx(nw);
        o.Ub();
        sightParams.j(nw, nx, s.ny(nw), e.gJf + String.format("%s%d.%s", new Object[]{"capture", Long.valueOf(System.currentTimeMillis()), "jpg"}));
        intent.putExtra("KEY_SIGHT_PARAMS", sightParams);
        d.a(fragment, "mmsight", ".ui.SightCaptureUI", intent, (int) a.CTRL_INDEX);
        fragment.getActivity().overridePendingTransition(com.tencent.mm.plugin.ah.a.a.sjz, -1);
        return true;
    }
    ...
    public static boolean a(Context context, int i, Intent intent, int i2, String str, int i3) {
        ...
        if (i2 == 1) {
            ...
            String nx = s.nx(nw);
            o.Ub();
            parcelable.j(nw, nx, s.ny(nw), e.gJf + String.format("%s%d.%s", new Object[]{"capture", Long.valueOf(System.currentTimeMillis()), "jpg"}));
        }
        if (parcelable == null) {
        ...
        if (context instanceof Activity) {
            ((Activity) context).overridePendingTransition(com.tencent.mm.plugin.ah.a.a.sjz, -1);
        }
        return true;
    }
    ...
    private static boolean a(u uVar, String str, String str2, int i) {
        if (com.tencent.mm.o.a.aV(uVar.getContext()) || com.tencent.mm.o.a.aU(uVar.getContext())) {
            return false;
        }
        filePath = str + str2;
    ...
    private static boolean d(Activity activity, String str, String str2, int i) {
        if (com.tencent.mm.o.a.aV(activity) || com.tencent.mm.o.a.aU(activity)) {
            return false;
        }
        filePath = str + str2;
        x.i("MicroMsg.TakePhotoUtil", "takePhotoFromSys(), filePath = " + filePath);
    ...
    public static void h(String str, Context context) {
        com.tencent.mm.platformtools.d.a(str, context, h.sjF);
    }

    public static String oF(String str) {
        return com.tencent.mm.platformtools.d.oF(str);
    }
    ...
    public static String Wl() {
        return com.tencent.mm.platformtools.d.Wl();
    }
}
