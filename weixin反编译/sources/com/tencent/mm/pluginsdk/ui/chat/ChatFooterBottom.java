...
public class ChatFooterBottom extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        x.d("MicroMsg.ChatFooterBottom", "jacks onMeasure  width:%d, height:%d, isHide: %B", Integer.valueOf(MeasureSpec.getSize(i)), Integer.valueOf(MeasureSpec.getSize(i2)), Boolean.valueOf(this.fKg));
        if (this.fKg) {
            setVisibility(8);
