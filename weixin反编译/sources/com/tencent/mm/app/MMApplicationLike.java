...
public class MMApplicationLike extends DefaultApplicationLike {
    ...
    public void onBaseContextAttached(Context context) {
        ...
        try {
            this.wrapper = (ApplicationLifeCycle) Class.forName(ad.getPackageName() + ".app.MMApplicationWrapper").getConstructor(new Class[]{MMApplicationLike.class, String.class}).newInstance(new Object[]{this, r});
    ...
    private void clearOldDirIfNewVersion() {
        ...
        com.tencent.mm.sdk.e.a aVar = new com.tencent.mm.sdk.e.a(com.tencent.mm.loader.stub.a.hbv + "NowRev.ini");
        ...
        if (!this.mNewVersionCode.equals(this.mOldVersionCode)) {
            ...
            b.e(applicationLike);
            aVar.fB("NowRev", this.mNewVersionCode);
            this.mSetRevTime = System.currentTimeMillis() - currentTimeMillis2;
            x.w(TAG, "application hash:%s, %s", hash, new aj().toString());
        }
