...
public final class c implements h {
    public final String o(Context context, String str) {
        ...
        if (bc.size() != 0) {
            Collections.sort(bc, new Comparator<k>() {
            ...
            while (it.hasNext()) {
                ...
                if (str3 != null) {
                    ...
                    if (format.length() == 0) {
                        x.d("MicroMsg.QrCodeURLHelper", "formatQRString, result:%s", str);
                    }
                } else {
                    format = str2;
                }
    ...
    public final boolean a(Context context, String str, OnDismissListener onDismissListener) {
        x.d("MicroMsg.QrCodeURLHelper", "tryHandleEvents, url:%s", str);
        if (bi.oN(str)) {
            return false;
        }
