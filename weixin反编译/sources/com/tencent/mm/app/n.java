...
public final class n {
    ...
    public static void b(Throwable th) {
        ...
        } else if (b.c(tinkerApplicationLike)) {
            ...
            while (th != null) {
                ...
                if (z2) {
                    ...
                    if (i2 != 0) {
                        ...
                        ShareTinkerInternals.iJ(tinkerApplicationLike.getApplication());
                        b.e(tinkerApplicationLike);
                        ShareTinkerInternals.iF(tinkerApplicationLike.getApplication());
                        return;
                    }
                }
                if (i != 0) {
