    ...
    static class AnonymousClass1 implements d {
        ...
        public final void a(ak akVar, String str, Throwable th) {
            ...
            try {
                ...
                String H = c.hby.H("last_login_uin", "0");
                ...
                try {
                    ...
                    StatFs statFs2 = new StatFs(a.bnD);
                    int memoryClass = ((ActivityManager) context.getSystemService("activity")).getMemoryClass();
                    int largeMemoryClass = ((ActivityManager) context.getSystemService("activity")).getLargeMemoryClass();
                    str2 = String.format("%dMB %dMB %s:%d:%d:%d %s:%d:%d:%d", new Object[]{Integer.valueOf(memoryClass), Integer.valueOf(largeMemoryClass), r5.getAbsolutePath(), Integer.valueOf(statFs.getBlockSize()), Integer.valueOf(statFs.getBlockCount()), Integer.valueOf(statFs.getAvailableBlocks()), a.bnD, Integer.valueOf(statFs2.getBlockSize()), Integer.valueOf(statFs2.getBlockCount()), Integer.valueOf(statFs2.getAvailableBlocks())});
                } catch (Exception e) {
                    str2 = H;
                }
                n.b(th);
                ...
                if (e.an(ad.getContext()) == 1) {
                    str = str.substring(0, e.ao(ad.getContext()));
                }
                e.e(ad.getContext(), ad.By(), "first");
                ...
                intent.putExtra("INTENT_EXTRA_USER_NAME", c.hby.H("login_user_name", "never_login_crash"));
                intent.putExtra("INTENT_EXTRA_EXCEPTION_MSG", Base64.encodeToString(stringBuilder.toString().getBytes(), 2));
                intent.putExtra("INTENT_EXTRA_DATA_PATH", a.hbv + "crash/");
                intent.putExtra("INTENT_EXTRA_SDCARD_PATH", a.hbx);
                intent.putExtra("INTENT_EXTRA_UIN", c.hby.H("last_login_uin", "0"));
