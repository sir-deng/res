...
public final class j {
    public static String hrs = "menu_click";
    public static String hrt = "menu_action_start";
    public static String hru = "menu_action_success";
    public String aAM;
    public String content;
    public String fMx;
    public List<j> hrv = null;
    public int hrw;
    public int id;
    public String name;
    public String state;
    ...
    public final String toString() {
        ...
        objArr[1] = Integer.valueOf(this.hrw);
        ...
        if (jSONArray != null) {
            try {
                ...
                for (int i = 0; i < length; i++) {
                    ...
                    jVar.type = jSONObject.getInt(Columns.TYPE);
                    jVar.name = jSONObject.getString("name");
                    jVar.aAM = jSONObject.getString("key");
                    jVar.value = jSONObject.optString(Columns.VALUE);
                    jVar.fMx = jSONObject.optString("native_url");
                    x.d("MicroMsg.BizMenuItem", "menuItem.nativeurl : " + jVar.fMx);
                    jVar.hrv = c(jSONObject.optJSONArray("sub_button_list"));
                    jVar.hrw = jSONObject.optInt("acttype");
                    arrayList.add(jVar);
                }
            } catch (Throwable e) {
                x.e("MicroMsg.BizMenuItem", "exception:%s", bi.i(e));
                return null;
            }
        }
        arrayList = null;
    ...
    public static LinkedList<j> q(Map<String, String> map) {
        ...
        try {
            ...
            while (i2 < i) {
                ...
                jVar.hrw = bi.getInt((String) map.get(str + ".acttype"), 0);
                linkedList.add(jVar);
                i2++;
            }
            return linkedList;
