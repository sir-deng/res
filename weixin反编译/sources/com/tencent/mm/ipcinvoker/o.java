...
public final class o {
    private static Map<String, e> gOD = new ConcurrentHashMap();

    public static <T> T d(String str, Class<?> cls) {
        try {
            Class cls2 = Class.forName(str);
            if (!cls.isAssignableFrom(cls2)) {
                x.e("IPC.ObjectStore", "%s isAssignableFrom %s return false", cls, cls2);
                return null;
            } else if (!cls2.isAnnotationPresent(a.class)) {
                return b.e(str, cls);
            } else {
                e eVar = (e) gOD.get(str);
                if (eVar == null) {
                    eVar = new e(cls2);
                    gOD.put(str, eVar);
                }
    ...
    public static <T> T a(Class<?> cls, Class<?> cls2) {
        try {
            if (!cls2.isAssignableFrom(cls)) {
                x.e("IPC.ObjectStore", "%s isAssignableFrom %s return false", cls2, cls);
                return null;
            } else if (!cls.isAnnotationPresent(a.class)) {
                return b.b(cls, cls2);
            } else {
                String name = cls.getName();
                e eVar = (e) gOD.get(name);
                if (eVar == null) {
                    eVar = new e(cls);
                    gOD.put(name, eVar);
                }
