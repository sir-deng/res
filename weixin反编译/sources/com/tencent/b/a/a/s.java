...
public final class s {
    ...
    static String ac(Context context) {
        if (!j(context, "android.permission.ACCESS_WIFI_STATE")) {
            return "";
        }
        try {
    ...
    static String ad(Context context) {
        try {
    ...
    static String ae(Context context) {
        try {
            WifiInfo wifiInfo = getWifiInfo(context);
            if (wifiInfo != null) {
    ...
    static JSONArray af(Context context) {
        try {
            if (j(context, "android.permission.INTERNET") && j(context, "android.permission.ACCESS_NETWORK_STATE")) {
                WifiManager wifiManager = (WifiManager) context.getSystemService("wifi");
                if (wifiManager != null) {
    ...
    static String ag(Context context) {
        try {
