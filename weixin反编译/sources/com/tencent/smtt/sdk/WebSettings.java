...
public class WebSettings {
    ...
    public static String getDefaultUserAgent(Context context) {
        ...
        if (af.cFZ().cGa()) {
            invokeStaticMethod = af.cFZ().cGb().Ain.invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "getDefaultUserAgent", new Class[]{Context.class}, context);
            return invokeStaticMethod instanceof String ? (String) invokeStaticMethod : null;
        } else if (VERSION.SDK_INT < 17) {
            return null;
        } else {
            invokeStaticMethod = o.b(android.webkit.WebSettings.class, "getDefaultUserAgent", new Class[]{Context.class}, context);
    ...
    public synchronized PluginState getPluginState() {
        ...
        if (this.isUseX5 && this.mWebSettingsImpl != null) {
            ...
            valueOf = f == null ? null : PluginState.valueOf(((android.webkit.WebSettings.PluginState) f).name());
        } else {
            valueOf = null;
        }
        return valueOf;
    ...
    public void setAllowContentAccess(boolean z) {
        if (this.isUseX5 && this.mWebSettingsImpl != null) {
            ...
            o.b(this.mSystemWebSettings, "setAllowContentAccess", new Class[]{Boolean.TYPE}, Boolean.valueOf(z));
        }
    }
    ...
    public void setAllowFileAccessFromFileURLs(boolean z) {
        if (this.isUseX5 && this.mWebSettingsImpl != null) {
            ...
            o.b(this.mSystemWebSettings, "setAllowFileAccessFromFileURLs", new Class[]{Boolean.TYPE}, Boolean.valueOf(z));
        }
    }
    ...
    public void setAllowUniversalAccessFromFileURLs(boolean z) {
        if (this.isUseX5 && this.mWebSettingsImpl != null) {
            ...
            o.b(this.mSystemWebSettings, "setAllowUniversalAccessFromFileURLs", new Class[]{Boolean.TYPE}, Boolean.valueOf(z));
        }
    }
    ...
    public void setDatabasePath(String str) {
        if (this.isUseX5 && this.mWebSettingsImpl != null) {
            ...
            o.b(this.mSystemWebSettings, "setDatabasePath", new Class[]{String.class}, str);
        }
    }
    ...
    public void setDisplayZoomControls(boolean z) {
        if (this.isUseX5 && this.mWebSettingsImpl != null) {
            ...
            o.b(this.mSystemWebSettings, "setDisplayZoomControls", new Class[]{Boolean.TYPE}, Boolean.valueOf(z));
        }
    }
    ...
    public void setEnableSmoothTransition(boolean z) {
        if (this.isUseX5 && this.mWebSettingsImpl != null) {
            ...
            o.b(this.mSystemWebSettings, "setEnableSmoothTransition", new Class[]{Boolean.TYPE}, Boolean.valueOf(z));
        }
    }
    ...
    public void setMediaPlaybackRequiresUserGesture(boolean z) {
        if (this.isUseX5 && this.mWebSettingsImpl != null) {
            ...
            o.b(this.mSystemWebSettings, "setMediaPlaybackRequiresUserGesture", new Class[]{Boolean.TYPE}, Boolean.valueOf(z));
        }
    }
    ...
    public void setMixedContentMode(int i) {
        if ((!this.isUseX5 || this.mWebSettingsImpl == null) && !this.isUseX5 && this.mSystemWebSettings != null && VERSION.SDK_INT >= 21) {
            o.b(this.mSystemWebSettings, "setMixedContentMode", new Class[]{Integer.TYPE}, Integer.valueOf(i));
        }
    }
    ...
    public void setNavDump(boolean z) {
        if (this.isUseX5 && this.mWebSettingsImpl != null) {
            ...
            o.b(this.mSystemWebSettings, "setNavDump", new Class[]{Boolean.TYPE}, Boolean.valueOf(z));
        }
    }
    ...
    public synchronized void setPluginState(PluginState pluginState) {
        if (this.isUseX5 && this.mWebSettingsImpl != null) {
            ...
            o.b(this.mSystemWebSettings, "setPluginState", new Class[]{android.webkit.WebSettings.PluginState.class}, valueOf);
        }
    }
    ...
    public void setPluginsEnabled(boolean z) {
        if (this.isUseX5 && this.mWebSettingsImpl != null) {
            ...
            o.b(this.mSystemWebSettings, "setPluginsEnabled", new Class[]{Boolean.TYPE}, Boolean.valueOf(z));
        }
    }
    ...
    public synchronized void setPluginsPath(String str) {
        if (this.isUseX5 && this.mWebSettingsImpl != null) {
            ...
            o.b(this.mSystemWebSettings, "setPluginsPath", new Class[]{String.class}, str);
        }
    }
    ...
    public synchronized void setTextZoom(int i) {
        if (this.isUseX5 && this.mWebSettingsImpl != null) {
            ...
            try {
                ...
                o.b(this.mSystemWebSettings, "setTextZoom", new Class[]{Integer.TYPE}, Integer.valueOf(i));
            }
        }
        return;
    }
    ...
    public void setUseWebViewBackgroundForOverscrollBackground(boolean z) {
        if (this.isUseX5 && this.mWebSettingsImpl != null) {
            ...
            o.b(this.mSystemWebSettings, "setUseWebViewBackgroundForOverscrollBackground", new Class[]{Boolean.TYPE}, Boolean.valueOf(z));
        }
    }
