    ...
    static class c extends AsyncTask<String, Void, d> {
        ...
        private d a(String... strArr) {
            ...
            if (strArr != null && strArr.length == 2) {
                byte[] a2;
                int i;
                dVar.a = com.tencent.mapsdk.rastercore.d.e.y();
                ...
                try {
                    a2 = a.a(a.c());
                    str = a2 != null ? new String(a2, ProtocolPackage.ServerEncoding) : null;
                } catch (Exception e) {
                ...
                try {
                    ...
                    if (httpURLConnection.getResponseCode() == 200) {
                        ...
                        if (!z4) {
                            ...
                            if (a2 != null) {
                                try {
                                    dVar.g = BitmapFactory.decodeByteArray(a2, 0, a2.length);
                                } catch (Exception e2) {
                            ...
                            if (optString2.trim().length() > 0) {
                                ...
                                try {
                                    ...
                                    try {
                                        ...
                                        if (httpURLConnection.getResponseCode() == 200) {
                                            a2 = a.a(httpURLConnection.getInputStream());
                                            dVar.g = BitmapFactory.decodeByteArray(a2, 0, a2.length);
                                            a.a(a2, a.b());
                                        }
                                        ...
                                        if (jSONObject != null) {
                                            ...
                                            if (!d.a(optString)) {
                                                ...
                                                if (httpURLConnection.getResponseCode() == 200) {
                                                    ...
                                                    a = a.a(a.c());
                                                    if (a != null) {
                                                        str = new String(a, ProtocolPackage.ServerEncoding);
                                                    }
                                                    if (!d.a(str)) {
                                                        b = d.c(str);
                                                        if (!d.a(b[1])) {
