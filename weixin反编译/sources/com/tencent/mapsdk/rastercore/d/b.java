...
public final class b extends View {
    ...
    public b(e eVar) {
        ...
        com.tencent.mapsdk.rastercore.f.a.a((View) this, 2);
    }

    private c a(int i, int i2) {
        return new c(this.g.b() + (((double) i) * this.f.d()), this.g.a() - (((double) i2) * this.f.d()));
    }
