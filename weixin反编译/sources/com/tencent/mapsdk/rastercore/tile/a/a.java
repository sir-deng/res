...
public final class a {
    ...
    class c extends SQLiteOpenHelper {
        ...
        private static String b(MapSource mapSource) {
            switch (AnonymousClass1.a[mapSource.ordinal()]) {
                case 1:
                    return "wmt";
                case 2:
                    return "tct";
        ...
        private static String b(com.tencent.mapsdk.rastercore.tile.a aVar) {
            switch (AnonymousClass1.a[aVar.m().ordinal()]) {
                case 1:
                    return aVar.d() + "-" + aVar.b() + "-" + aVar.c() + "-" + e.u() + "-" + aVar.n();
                case 2:
    ...
    /* renamed from: com.tencent.mapsdk.rastercore.tile.a.a$1 */
    ...
    public final c a(com.tencent.mapsdk.rastercore.tile.a aVar) {
        ...
        if (!(this.e == null || aVar.m() == MapSource.CUSTOMER || aVar.m() == MapSource.TRAFFIC || (aVar.m() == MapSource.TENCENT && aVar.n() == 7))) {
...
*/
    ...
    L_0x0036:
        ...
        r3 = r6.l();
        r2.append(r3);
        r2 = r6.g();	 Catch:{ Throwable -> 0x00d0, all -> 0x00ec }
        if (r2 == 0) goto L_0x0069;	 Catch:{ Throwable -> 0x00d0, all -> 0x00ec }
    L_0x005f:
        r2 = r6.l();	 Catch:{ Throwable -> 0x00d0, all -> 0x00ec }
        if (r2 != r0) goto L_0x0069;	 Catch:{ Throwable -> 0x00d0, all -> 0x00ec }
    L_0x0065:
        r2 = r4.e;	 Catch:{ Throwable -> 0x00d0, all -> 0x00ec }
    ...
    L_0x007e:
        ...
        goto L_0x0036;
    L_0x0083:
        r2 = new java.lang.StringBuilder;	 Catch:{ Throwable -> 0x00d0, all -> 0x00ec }
        r3 = "Put: tileData.getVersion()=";	 Catch:{ Throwable -> 0x00d0, all -> 0x00ec }
        r2.<init>(r3);	 Catch:{ Throwable -> 0x00d0, all -> 0x00ec }
        r3 = r6.l();	 Catch:{ Throwable -> 0x00d0, all -> 0x00ec }
        r2 = r2.append(r3);	 Catch:{ Throwable -> 0x00d0, all -> 0x00ec }
        r3 = ",currentVersion=";	 Catch:{ Throwable -> 0x00d0, all -> 0x00ec }
        r2 = r2.append(r3);	 Catch:{ Throwable -> 0x00d0, all -> 0x00ec }
        r2.append(r0);	 Catch:{ Throwable -> 0x00d0, all -> 0x00ec }
        r0 = r4.e;	 Catch:{ Throwable -> 0x00d0, all -> 0x00ec }
        r0 = r0.c(r6);	 Catch:{ Throwable -> 0x00d0, all -> 0x00ec }
        if (r0 != 0) goto L_0x00ba;	 Catch:{ Throwable -> 0x00d0, all -> 0x00ec }
    L_0x00a5:
        r0 = r4.e;	 Catch:{ Throwable -> 0x00d0, all -> 0x00ec }
        r2 = r5.c();	 Catch:{ Throwable -> 0x00d0, all -> 0x00ec }
        r0 = r0.a(r6, r2);	 Catch:{ Throwable -> 0x00d0, all -> 0x00ec }
        r1 = r4.f;
        r1 = r1.writeLock();
        r1.unlock();
        goto L_0x0025;
    L_0x00ba:
        r0 = r4.e;	 Catch:{ Throwable -> 0x00d0, all -> 0x00ec }
        r2 = r5.c();	 Catch:{ Throwable -> 0x00d0, all -> 0x00ec }
        r3 = 0;	 Catch:{ Throwable -> 0x00d0, all -> 0x00ec }
        r0 = r0.a(r6, r2, r3);	 Catch:{ Throwable -> 0x00d0, all -> 0x00ec }
        r1 = r4.f;
        r1 = r1.writeLock();
        r1.unlock();
        goto L_0x0025;
    L_0x00d0:
        r0 = move-exception;
        r2 = new java.lang.StringBuilder;	 Catch:{ Throwable -> 0x00d0, all -> 0x00ec }
        r3 = "put error:";	 Catch:{ Throwable -> 0x00d0, all -> 0x00ec }
        r2.<init>(r3);	 Catch:{ Throwable -> 0x00d0, all -> 0x00ec }
        r0 = r0.toString();	 Catch:{ Throwable -> 0x00d0, all -> 0x00ec }
        r2.append(r0);	 Catch:{ Throwable -> 0x00d0, all -> 0x00ec }
        r0 = r4.f;
        r0 = r0.writeLock();
        r0.unlock();
