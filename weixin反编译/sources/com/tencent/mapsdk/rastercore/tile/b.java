                    ...
                    for (int i = 0; i < arrayList.size(); i++) {
                        for (a aVar : ((MapTile) arrayList.get(i)).b()) {
                            ...
                            try {
                                ...
                                if (g.Anp != null) {
                                    g.Anp.collectErrorInfo("TileEngineManager getTiles Runnable call CacheManager Get occured Exception,tileInfo:x=" + aVar.b() + ",y=" + aVar.c() + ",z=" + aVar.d() + "Exception Info:" + th.toString());
                                }
                                a = null;
                            }
                            if (a.b() != null && a.d() == aVar.l()) {
                                aVar.a(a.b());
                                if (aVar.m() == MapSource.TENCENT && !b.this.c.z()) {
                                    e.a++;
                                }
