...
public class c extends com.tencent.liteav.basic.module.a implements b, e, com.tencent.liteav.basic.c.a, com.tencent.liteav.beauty.e, k, d {
    ...
    public int e() {
        ...
        t();
        com.tencent.liteav.audio.c.a().a((e) this);
        ...
        if (this.e != null) {
            this.e.a(new Runnable() {
                public void run() {
                    ...
                    c.this.b(c.this.h.width, c.this.h.height);
                }
            });
        }
    }
        ...
        if ((this.k.I & 2) == 2) {
            ...
            if (a != null) {
                this.i.a(new Runnable() {
                    public void run() {
                        if (!c.this.a.b() || c.this.h.width != i || c.this.h.height != i2) {
                            c.this.a.a(a, c.this.j, c.this.k.t, i, i2);
                        }
                    }
                });
            }
                ...
                public void run() {
                    try {
                        if (c.this.a != null && c.this.e != null && c.this.j != null) {
                            c.this.a.a(c.this.e.e(), c.this.j, c.this.k.t, c.this.h.width, c.this.h.height);
                        }
                    } catch (Exception e) {
                    }
                }
