...
public class TXCStreamUploader extends com.tencent.liteav.basic.module.a implements b {
        ...
        this.mThread = new Thread("RTMPUpload") {
            public void run() {
                ...
                synchronized (TXCStreamUploader.this.mThreadLock) {
                    ...
                    String access$500 = TXCStreamUploader.this.mRtmpUrl;
                    String str = str;
                    boolean z = z;
                    int i = TXCStreamUploader.this.mParam.e;
                    int i2 = TXCStreamUploader.this.mParam.d;
                    int i3 = TXCStreamUploader.this.mParam.a;
                    int i4 = TXCStreamUploader.this.mParam.c;
                    int i5 = TXCStreamUploader.this.mParam.h;
                    int i6 = TXCStreamUploader.this.mParam.m ? z ? 3 : 2 : 1;
                    tXCStreamUploader.mUploaderInstance = tXCStreamUploader2.nativeInitUploader(access$500, str, z, i, i2, i3, i4, i5, 16, i6);
    ...
    private a getRtmpRealConnectInfo() {
        ...
        return new a(split[0] + "://" + stringBuilder.toString(), aVar.c);
    }
