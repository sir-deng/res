                    ...
                    if (dequeueOutputBuffer == -3) {
                        ...
                        if (byteBuffer == null) {
                            ...
                            if (bufferInfo.size > 5 && obj[0] == (byte) 0 && obj[1] == (byte) 0 && obj[2] == (byte) 0 && obj[3] == (byte) 0 && obj[4] == (byte) 0 && obj[5] == (byte) 0) {
                                int i = 3;
                                while (i < length - 4) {
                                    if (obj[i] == (byte) 0 && obj[i + 1] == (byte) 0 && obj[i + 2] == (byte) 0 && obj[i + 3] == (byte) 1) {
                                        length -= i;
                                        break;
                                    }
                                    i++;
                                ...
                                System.arraycopy(obj, i, obj2, 0, length);
                                bArr2 = obj2;
                            } else {
                                bArr2 = obj;
                            }
                            if (bufferInfo.size == 0) {
                                ...
                                if ((bufferInfo.flags & 2) != 2) {
                                    ...
                                    if ((bufferInfo.flags & 1) == 1) {
                                        ...
                                        this.F = -1;
                                        if (this.h) {
                                            bArr3 = new byte[(this.B.length + bArr2.length)];
                                            System.arraycopy(this.B, 0, bArr3, 0, this.B.length);
                                            System.arraycopy(bArr2, 0, bArr3, this.B.length, bArr2.length);
                                        } else {
                                            bArr2 = a(bArr2);
                                            bArr3 = new byte[(this.B.length + bArr2.length)];
                                            System.arraycopy(this.B, 0, bArr3, 0, this.B.length);
                                    ...
                                    byteBuffer.position(bufferInfo.offset);
                                    if (this.i) {
                                        callDelegate(bArr3, i2, this.k, this.l, this.m, i2 == 0 ? 0 : this.l - 1, j2, j2, 0, byteBuffer, bufferInfo);
                                    } else {
                                        callDelegate(obj, i2, this.k, this.l, this.m, i2 == 0 ? 0 : this.l - 1, j2, j2, 0, byteBuffer, bufferInfo);
                                    }
                                    this.m++;
