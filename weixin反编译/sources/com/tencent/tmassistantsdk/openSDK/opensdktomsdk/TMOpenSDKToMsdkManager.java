...
public class TMOpenSDKToMsdkManager {
                    ...
                    TMOpenSDKToMsdkManager.this.mSubMessageHandler.post(new Runnable() {
                        public void run() {
                            try {
                                ...
                                x.printErrStackTrace(TMOpenSDKToMsdkManager.TAG, e, "", new Object[0]);
                            }
                        }
                    });
                } else if (5 == i) {
    ...
    protected OnClickListener negativeBtnListenner = new OnClickListener() {
        public void onClick(View view) {
            ...
            JceStruct createTipsInfoLog = TipsInfoReportManager.getInstance().createTipsInfoLog(TMOpenSDKToMsdkManager.this.mAuthorizedInfo);
        ...
        public void onClick(View view) {
            if (TMOpenSDKToMsdkManager.this.mContext != null) {
                ...
                try {
                    ...
                    x.printErrStackTrace(TMOpenSDKToMsdkManager.TAG, e2, "", new Object[0]);
                }
                x.printErrStackTrace(TMOpenSDKToMsdkManager.TAG, e2, "", new Object[0]);
            }
        }
    ...
    public void initOpenSDK(ITMOpenSDKToMsdkListener iTMOpenSDKToMsdkListener) {
        ...
        this.mMainMessageHandler = new ag(Looper.getMainLooper(), new a() {
