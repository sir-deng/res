...
public class ProxyWebViewSuperWrapper extends ProxyWebViewClientExtension implements a {
    ...
    public ProxyWebViewSuperWrapper(b bVar) {
        ...
        this.mXWebProxyImp.ABw = this;
    }

    public void onPreReadFinished() {
        b bVar = this.mXWebProxyImp;
        if (bVar.ABw != null) {
            bVar.ABw.super_onPreReadFinished();
        }
    }
    ...
    public void onPromptScaleSaved() {
        b bVar = this.mXWebProxyImp;
        if (bVar.ABw != null) {
            bVar.ABw.super_onPromptScaleSaved();
        }
    }
    ...
    public void onUrlChange(String str, String str2) {
        b bVar = this.mXWebProxyImp;
        if (bVar.ABw != null) {
            bVar.ABw.super_onUrlChange(str, str2);
        }
    }
    ...
    public void onShowListBox(String[] strArr, int[] iArr, int[] iArr2, int i) {
        b bVar = this.mXWebProxyImp;
        if (bVar.ABw != null) {
            bVar.ABw.super_onShowListBox(strArr, iArr, iArr2, i);
        }
    }
    ...
    public void onShowMutilListBox(String[] strArr, int[] iArr, int[] iArr2, int[] iArr3) {
        b bVar = this.mXWebProxyImp;
        if (bVar.ABw != null) {
            bVar.ABw.super_onShowMutilListBox(strArr, iArr, iArr2, iArr3);
        }
    }
    ...
    public void onTransitionToCommitted() {
        b bVar = this.mXWebProxyImp;
        if (bVar.ABw != null) {
            bVar.ABw.super_onTransitionToCommitted();
        }
    }
    ...
    public void showTranslateBubble(int i, String str, String str2, int i2) {
        b bVar = this.mXWebProxyImp;
        if (bVar.ABw != null) {
            bVar.ABw.super_showTranslateBubble(i, str, str2, i2);
        } else {
    ...
    public void onUploadProgressStart(int i) {
        b bVar = this.mXWebProxyImp;
        if (bVar.ABw != null) {
            bVar.ABw.super_onUploadProgressStart(i);
        }
    }
    ...
    public void onUploadProgressChange(int i, int i2, String str) {
        b bVar = this.mXWebProxyImp;
        if (bVar.ABw != null) {
            bVar.ABw.super_onUploadProgressChange(i, i2, str);
        }
    }
    ...
    public void onFlingScrollBegin(int i, int i2, int i3) {
        b bVar = this.mXWebProxyImp;
        if (bVar.ABw != null) {
            bVar.ABw.super_onFlingScrollBegin(i, i2, i3);
        }
    }
    ...
    public void onFlingScrollEnd() {
        b bVar = this.mXWebProxyImp;
        if (bVar.ABw != null) {
            bVar.ABw.super_onFlingScrollEnd();
        }
    }
    ...
    public void onScrollChanged(int i, int i2, int i3, int i4) {
        b bVar = this.mXWebProxyImp;
        if (bVar.ABw != null) {
            bVar.ABw.super_onScrollChanged(i, i2, i3, i4);
        }
    }
    ...
    public void onSoftKeyBoardShow() {
        b bVar = this.mXWebProxyImp;
        if (bVar.ABw != null) {
            bVar.ABw.super_onSoftKeyBoardShow();
        }
    }
    ...
    public void onSoftKeyBoardHide(int i) {
        b bVar = this.mXWebProxyImp;
        if (bVar.ABw != null) {
            bVar.ABw.super_onSoftKeyBoardHide(i);
        }
    }
    ...
    public void onSetButtonStatus(boolean z, boolean z2) {
        b bVar = this.mXWebProxyImp;
        if (bVar.ABw != null) {
            bVar.ABw.super_onSetButtonStatus(z, z2);
        }
    }
    ...
    public void onHistoryItemChanged() {
        b bVar = this.mXWebProxyImp;
        if (bVar.ABw != null) {
            bVar.ABw.super_onHistoryItemChanged();
        }
    }
    ...
    public void handlePluginTag(String str, String str2, boolean z, String str3) {
        b bVar = this.mXWebProxyImp;
        if (bVar.ABw != null) {
            bVar.ABw.super_handlePluginTag(str, str2, z, str3);
        }
    }
    ...
    public void onDoubleTapStart() {
        b bVar = this.mXWebProxyImp;
        if (bVar.ABw != null) {
            bVar.ABw.super_onDoubleTapStart();
        }
    }
    ...
    public void onPinchToZoomStart() {
        b bVar = this.mXWebProxyImp;
        if (bVar.ABw != null) {
            bVar.ABw.super_onPinchToZoomStart();
        }
    }
    ...
    public void onSlidingTitleOffScreen(int i, int i2) {
        b bVar = this.mXWebProxyImp;
        if (bVar.ABw != null) {
            bVar.ABw.super_onSlidingTitleOffScreen(i, i2);
        }
    }
    ...
    public void onMissingPluginClicked(String str, String str2, String str3, int i) {
        b bVar = this.mXWebProxyImp;
        if (bVar.ABw != null) {
            bVar.ABw.super_onMissingPluginClicked(str, str2, str3, i);
        }
    }
    ...
    public void onReportAdFilterInfo(int i, int i2, String str, boolean z) {
        b bVar = this.mXWebProxyImp;
        if (bVar.ABw != null) {
            bVar.ABw.super_onReportAdFilterInfo(i, i2, str, z);
        }
    }
    ...
    public void onReportHtmlInfo(int i, String str) {
        b bVar = this.mXWebProxyImp;
        if (bVar.ABw != null) {
            bVar.ABw.super_onReportHtmlInfo(i, str);
        }
    }
    ...
    public void onNativeCrashReport(int i, String str) {
        b bVar = this.mXWebProxyImp;
        if (bVar.ABw != null) {
            bVar.ABw.super_onNativeCrashReport(i, str);
        }
    }
    ...
    public Object onMiscCallBack(String str, Bundle bundle, Object obj, Object obj2, Object obj3, Object obj4) {
        b bVar = this.mXWebProxyImp;
        return bVar.ABw != null ? bVar.ABw.super_onMiscCallBack(str, bundle, obj, obj2, obj3, obj4) : null;
    }
    ...
    public void onMetricsSavedCountReceived(String str, boolean z, long j, String str2, int i) {
        b bVar = this.mXWebProxyImp;
        if (bVar.ABw != null) {
            bVar.ABw.super_onMetricsSavedCountReceived(str, z, j, str2, i);
        } else {
            Log.e("ProxyWebViewClientExtension", "mSuperProvider Is null");
        }
    }
    ...
    public boolean notifyAutoAudioPlay(String str, JsResult jsResult) {
        b bVar = this.mXWebProxyImp;
        f fVar = new g.f(jsResult);
        if (bVar.ABw != null) {
            return bVar.ABw.super_notifyAutoAudioPlay(str, fVar);
        }
        Log.e("ProxyWebViewClientExtension", "mSuperProvider Is null");
        return false;
    }
    ...
    public boolean allowJavaScriptOpenWindowAutomatically(String str, String str2) {
        b bVar = this.mXWebProxyImp;
        if (bVar.ABw != null) {
            return bVar.ABw.super_allowJavaScriptOpenWindowAutomatically(str, str2);
        }
        Log.e("ProxyWebViewClientExtension", "mSuperProvider Is null");
        return false;
    }
    ...
    public boolean notifyJavaScriptOpenWindowsBlocked(String str, String[] strArr, ValueCallback<Boolean> valueCallback, boolean z) {
        b bVar = this.mXWebProxyImp;
        if (bVar.ABw != null) {
            return bVar.ABw.super_notifyJavaScriptOpenWindowsBlocked(str, strArr, valueCallback, z);
        }
        Log.e("ProxyWebViewClientExtension", "mSuperProvider Is null");
        return false;
    }
    ...
    public void onResponseReceived(WebResourceRequest webResourceRequest, WebResourceResponse webResourceResponse, int i) {
        ...
        if (bVar.ABw != null) {
            bVar.ABw.super_onResponseReceived(bVar2, a, i);
        } else {
            Log.e("ProxyWebViewClientExtension", "mSuperProvider Is null");
        }
    }
    ...
    public void didFirstVisuallyNonEmptyPaint() {
        b bVar = this.mXWebProxyImp;
        if (bVar.ABw != null) {
            bVar.ABw.super_didFirstVisuallyNonEmptyPaint();
        }
    }
    ...
    public void documentAvailableInMainFrame() {
        b bVar = this.mXWebProxyImp;
        if (bVar.ABw != null) {
            bVar.ABw.super_documentAvailableInMainFrame();
        }
    }
    ...
    public void onReceivedViewSource(String str) {
        b bVar = this.mXWebProxyImp;
        if (bVar.ABw != null) {
            bVar.ABw.super_onReceivedViewSource(str);
        }
    }
    ...
    public void onPrefetchResourceHit(boolean z) {
        b bVar = this.mXWebProxyImp;
        if (bVar.ABw != null) {
            bVar.ABw.super_onPrefetchResourceHit(z);
        }
    }
    ...
    public void onReceivedSslErrorCancel() {
        b bVar = this.mXWebProxyImp;
        if (bVar.ABw != null) {
            bVar.ABw.super_onReceivedSslErrorCancel();
        }
    }
