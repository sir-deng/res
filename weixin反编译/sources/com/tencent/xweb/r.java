...
public final class r {
    static boolean AzR = false;
    static boolean AzS = false;
    ...
    public static synchronized void a(Context context, b bVar, q qVar, WebViewExtensionListener webViewExtensionListener) {
        synchronized (r.class) {
            ...
            if ((context != null && XWalkEnvironment.getApplicationContext() == null) || !AzR) {
                AzR = true;
                XWalkEnvironment.init(context);
                a a = h.a(c.WV_KIND_CW);
                if (a != null) {
            ...
            if (webViewExtensionListener != null) {
                h.a(c.WV_KIND_CW).initCallback(webViewExtensionListener);
            }
        }
    }
