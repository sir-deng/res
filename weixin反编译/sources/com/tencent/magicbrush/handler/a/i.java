...
public final class i implements c {
    ...
    public final FloatBuffer drawText(String str) {
        ...
        if (bB == null) {
            f.i("MicroMsg.MBFontManagerImpl", "drawText() load result is null. atlas may be full. first time, clear and retry; text = [%s]; mCurrentState = [%s]", str, this.bog);
            clear();
            bB = this.bnX.bB(str);
        }
        if (bB != null) {
        ...
        f.i("MicroMsg.MBFontManagerImpl", "drawText() load result is null. atlas may be full. second time, just returned; text = [%s]; mCurrentState = [%s]", str, this.bog);
        return null;
    }
    ...
    public final float measureText(String str) {
        ...
        if (bD == -1.0f) {
            f.i("MicroMsg.MBFontManagerImpl", "measure() load result is null. atlas may be full. first time, clear and retry; text = [%s]; mCurrentState = [%s]", str, this.bog);
            clear();
            bD = this.bnX.bD(str);
        }
        if (bD != -1.0f) {
        ...
        f.i("MicroMsg.MBFontManagerImpl", "measure() load result is null. atlas may be full. second time, just returned; text = [%s]; mCurrentState = [%s]", str, this.bog);
        return 0.0f;
    }
