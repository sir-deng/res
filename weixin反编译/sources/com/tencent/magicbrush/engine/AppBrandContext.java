...
public class AppBrandContext extends b {
    ...
    public class a extends TimerTask {
        ...
        public final void run() {
            if (!AppBrandContext.this.bnt) {
                AppBrandContext.this.mHandler.post(new Runnable() {
                    public final void run() {
                        AppBrandContext.notifyRunTimer(AppBrandContext.this.bnB, AppBrandContext.this.bns, a.this.bnv);
                    }
                });
            } else if (!this.bnw) {
                AppBrandContext.this.bnu.add(Integer.valueOf(this.bnv));
            }
        }
    }
