...
public final class b {
    public static boolean b(ApplicationLike applicationLike) {
        if (applicationLike != null && applicationLike.getApplication() != null) {
            return ShareTinkerInternals.Jl(applicationLike.getTinkerFlags());
        }
    ...
    public static String d(ApplicationLike applicationLike) {
        ...
        boolean iH = ShareTinkerInternals.iH(applicationLike.getApplication());
        if (j == null || j2 == null) {
            return null;
        }
        if (iH) {
    ...
    public static void e(ApplicationLike applicationLike) {
        ...
        SharePatchFileUtil.g(SharePatchFileUtil.iA(applicationLike.getApplication()));
    }
}
