...
public class a {
    ...
    private static final class b {
        static /* synthetic */ void c(ClassLoader classLoader, File file) {
            ...
            ShareReflectUtil.a(obj, "nativeLibraryPathElements").set(obj, (Object[]) a.invoke(obj, new Object[]{arrayList3, null, arrayList4}));
        }
    }
    ...
    public static boolean a(ApplicationLike applicationLike, String str) {
        ...
        File iA = SharePatchFileUtil.iA(applicationLike.getApplication());
        if (iA == null) {
            com.tencent.tinker.lib.f.a.e("Tinker.LoadLibrary", "failed to get current patch directory.", new Object[0]);
            return false;
        }
        File file = new File(new File(iA.getAbsolutePath() + "/" + SharePatchFileUtil.act(d)).getAbsolutePath() + "/lib/lib/" + str);
        if (file.exists()) {
    ...
    private static void a(ClassLoader classLoader, File file) {
        if (file == null || !file.exists()) {
            ...
            try {
                ...
                arrayList3.addAll(arrayList2);
                arrayList3.addAll(collection);
                ShareReflectUtil.a(obj, "nativeLibraryPathElements").set(obj, (Object[]) ShareReflectUtil.a(obj, "makePathElements", List.class).invoke(obj, new Object[]{arrayList3}));
            } catch (Throwable th) {
