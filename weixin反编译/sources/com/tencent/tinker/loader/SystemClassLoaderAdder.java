...
public class SystemClassLoaderAdder {
    ...
    public static void a(Application application, PathClassLoader pathClassLoader, File file, List<File> list) {
        ...
        if (!list.isEmpty()) {
            ...
            List dM = dM(list);
            if (VERSION.SDK_INT >= 24 && !dL(dM)) {
                pathClassLoader2 = AndroidNClassLoader.a(pathClassLoader2, application);
            }
            if (VERSION.SDK_INT >= 23) {
                V23.c(pathClassLoader2, dM, file);
            } else if (VERSION.SDK_INT >= 19) {
                V19.b(pathClassLoader2, dM, file);
            } else if (VERSION.SDK_INT >= 14) {
                V14.a(pathClassLoader2, dM, file);
            } else {
                V4.d(pathClassLoader2, dM, file);
            }
            Asx = dM.size();
            new StringBuilder("after loaded classloader: ").append(pathClassLoader2).append(", dex size:").append(Asx);
    ...
    public static void a(ClassLoader classLoader) {
        if (Asx > 0) {
            if (VERSION.SDK_INT >= 14) {
                ShareReflectUtil.a(ShareReflectUtil.a((Object) classLoader, "pathList").get(classLoader), "dexElements", Asx);
                return;
            }
            ShareReflectUtil.a((Object) classLoader, "mPaths", Asx);
            ShareReflectUtil.a((Object) classLoader, "mFiles", Asx);
            ShareReflectUtil.a((Object) classLoader, "mZips", Asx);
            try {
                ShareReflectUtil.a((Object) classLoader, "mDexs", Asx);
            } catch (Exception e) {
            }
        }
    }
    ...
    private static List<File> dM(List<File> list) {
        List<File> arrayList = new ArrayList(list);
        final Map hashMap = new HashMap();
        for (File name : arrayList) {
            CharSequence name2 = name.getName();
            hashMap.put(name2, Boolean.valueOf(ShareConstants.AtI.matcher(name2).matches()));
        }
