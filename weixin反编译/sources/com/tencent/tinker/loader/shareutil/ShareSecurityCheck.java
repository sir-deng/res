...
public class ShareSecurityCheck {
    ...
    public final HashMap<String, String> Avd = new HashMap();
    private final HashMap<String, String> Ave = new HashMap();
    ...
    public ShareSecurityCheck(Context context) {
        ...
        if (Avc == null) {
            ...
            try {
                String bS = SharePatchFileUtil.bS(context2.getPackageManager().getPackageInfo(context2.getPackageName(), 64).signatures[0].toByteArray());
                Avc = bS;
                if (bS == null) {
                    throw new TinkerRuntimeException("get public key md5 is null");
                }
                SharePatchFileUtil.cA(null);
            } catch (Throwable e) {
    ...
    public final HashMap<String, String> cHY() {
        if (!this.Ave.isEmpty()) {
            return this.Ave;
        }
        String str = (String) this.Avd.get("assets/package_meta.txt");
        if (str == null) {
            return null;
        }
        for (String str2 : str.split("\n")) {
            if (!(str2 == null || str2.length() <= 0 || str2.startsWith("#"))) {
                ...
                if (split != null && split.length >= 2) {
                    this.Ave.put(split[0].trim(), split[1].trim());
                }
            }
        }
        return this.Ave;
    ...
    public final boolean ak(File file) {
        Throwable e;
        JarFile jarFile;
                ...
                while (entries.hasMoreElements()) {
                    ...
                    if (jarEntry != null) {
                        ...
                        if (!name.startsWith("META-INF/") && name.endsWith("meta.txt")) {
                            this.Avd.put(name, SharePatchFileUtil.a(jarFile2, jarEntry));
    ...
    private static boolean a(File file, Certificate[] certificateArr) {
        if (certificateArr.length > 0) {
            ...
            while (length >= 0) {
                try {
                    if (Avc.equals(SharePatchFileUtil.bS(certificateArr[length].getEncoded()))) {
                        return true;
                    }
                    length--;
                } catch (Exception e) {
