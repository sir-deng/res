...
public class TinkerResourceLoader {
    ...
    public static boolean a(TinkerApplication tinkerApplication, String str, Intent intent) {
        ...
        if (tinkerApplication.isTinkerLoadVerifyFlag()) {
            if (SharePatchFileUtil.h(file, AsJ.AuT)) {
                ...
                new StringBuilder("Failed to load resource file, path: ").append(file.getPath()).append(", expect md5: ").append(AsJ.AuT);
    ...
    public static boolean a(Context context, String str, ShareSecurityCheck shareSecurityCheck, Intent intent) {
        String str2 = (String) shareSecurityCheck.Avd.get("assets/res_meta.txt");
        if (str2 == null) {
            return true;
        }
        ShareResPatchInfo.b(str2, AsJ);
        if (AsJ.AuT == null) {
            return true;
        }
        if (ShareResPatchInfo.a(AsJ)) {
            str2 = str + "/res/";
            File file = new File(str2);
            if (!file.exists() || !file.isDirectory()) {
                ...
                try {
                    TinkerResourcePatcher.ix(context);
                    return true;
