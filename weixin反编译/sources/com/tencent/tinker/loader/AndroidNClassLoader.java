...
class AndroidNClassLoader extends PathClassLoader {
    private final PathClassLoader Asv;
    private String Asw;
    ...
    public Class<?> findClass(String str) {
        if ((str == null || !str.startsWith("com.tencent.tinker.loader.") || str.equals("com.tencent.tinker.loader.TinkerTestDexLoad")) && (this.Asw == null || !this.Asw.equals(str))) {
            return super.findClass(str);
        }
        return this.Asv.loadClass(str);
    }
