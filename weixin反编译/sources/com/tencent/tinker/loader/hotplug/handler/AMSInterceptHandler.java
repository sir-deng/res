...
public class AMSInterceptHandler implements BinderInvocationHandler {
    private static final int[] Atq = new int[]{16842840};
    ...
    private Object b(Object obj, Method method, Object[] objArr) {
        ...
        i = -1;
        if (i != -1 && ((Integer) objArr[0]).intValue() == Atr) {
    ...
    private void aq(Intent intent) {
        ...
        if (IncrementComponentManager.acp(str)) {
            ActivityInfo acq = IncrementComponentManager.acq(str);
            String s = ActivityStubManager.s(str, acq.launchMode, a(acq));
    ...
    private boolean a(ActivityInfo activityInfo) {
        ...
        try {
            typedArray = newTheme.obtainStyledAttributes(Atq);
