...
final class ActivityStubs {
    static final String Atf = ActivityStubs.class.getPackage().getName();
    static final String Atg = (Atf + "." + ActivityStubs.class.getSimpleName() + "$STDStub_%02X");
    static final String Ath = (Atf + "." + ActivityStubs.class.getSimpleName() + "$SGTStub_%02X");
    static final String Ati = (Atf + "." + ActivityStubs.class.getSimpleName() + "$SGTKStub_%02X");
    static final String Atj = (Atf + "." + ActivityStubs.class.getSimpleName() + "$SIStub_%02X");
