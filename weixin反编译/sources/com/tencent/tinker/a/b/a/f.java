...
public final class f extends e {
    private final h Apo;
    private final c App;
    private final boolean Apq = true;
    ...
    public final void a(int i, int i2, int i3, int i4, int i5, long j) {
        ...
        switch (i2) {
            ...
            case 113:
            case 114:
                this.Apo.a(b.fO(i2, b.fP(0, 0)), (short) i3, b.z(0, 0, 0, 0));
                return;
            case 40:
                byte b;
                if (this.Apq) {
                    b = i5 - this.Apo.Apj;
                    if (b == ((byte) b)) {
                        this.Apo.c(b.fO(i2, b & 255));
                        return;
                    } else if (b != ((short) b)) {
                        this.Apo.a((short) 42, (short) b, (short) (b >> 16));
                        return;
                    } else {
                        this.Apo.b((short) 41, (short) b);
                        return;
                    }
                }
                b = i5 - this.Apo.Apj;
                if (b != ((byte) b)) {
                    throw new j("Target out of range: " + a.IQ(b) + ", perhaps you need to enable force jumbo mode.");
                }
                this.Apo.c(b.fO(i2, b & 255));
                return;
            case 41:
                short s;
                if (this.Apq) {
                    short s2 = i5 - this.Apo.Apj;
                    if (s2 != ((short) s2)) {
                        this.Apo.a((short) 42, (short) s2, (short) (s2 >> 16));
                        return;
                    }
                    s = (short) i2;
                    this.Apo.b(s, (short) s2);
                    return;
                }
                s = (short) i2;
                this.Apo.b(s, b.fQ(i5, this.Apo.Apj));
                return;
            case R.styleable.AppCompatTheme_dialogTheme /*42*/:
                int i6 = i5 - this.Apo.Apj;
                this.Apo.a((short) i2, (short) i6, (short) (i6 >> 16));
                return;
            default:
                throw new IllegalStateException("unexpected opcode: " + a.IP(i2));
        }
    }
    ...
    public final void a(int i, int i2, int i3, int i4, int i5, long j, int i6) {
        ...
        switch (i2) {
            ...
            case 30:
            case 39:
                this.Apo.c(b.fO(i2, i6));
                return;
            case 18:
                short s = (short) i2;
                h hVar = this.Apo;
                if (j < -8 || j > 7) {
                    throw new j("Literal out of range: " + a.gA(j));
                }
                hVar.c(b.fO(s, b.fP(i6, ((int) j) & 15)));
                return;
            case 19:
            case 22:
                this.Apo.b(b.fO(i2, i6), b.gz(j));
                return;
            case 20:
            case 23:
                if (j != ((long) ((int) j))) {
                ...
                i7 = (int) j;
                this.Apo.a(b.fO(i2, i6), (short) i7, (short) (i7 >> 16));
                return;
            case 21:
            case 25:
                this.Apo.b(b.fO(i2, i6), (short) ((int) (j >> (i2 == 21 ? 16 : 48))));
                return;
            case 24:
                h hVar2 = this.Apo;
            ...
            case 26:
                if (this.Apq) {
                    if (i3 > 65535) {
                        this.Apo.a(b.fO(27, i6), (short) i3, (short) (i3 >> 16));
                        return;
                    } else {
                        this.Apo.b(b.fO(i2, i6), (short) i3);
                        return;
                    }
                } else if (i3 > 65535) {
                    throw new j("string index out of bound: " + a.IN(i3) + ", perhaps you need to enable force jumbo mode.");
                } else {
                    this.Apo.b(b.fO(i2, i6), (short) i3);
                    return;
                }
            case 27:
                this.Apo.a(b.fO(i2, i6), (short) i3, (short) (i3 >> 16));
                return;
            case 28:
            case 31:
            case 34:
            ...
            case 113:
            case 114:
                this.Apo.a(b.fO(i2, b.fP(0, 1)), (short) i3, b.z(i6, 0, 0, 0));
                return;
            case 38:
            ...
            case 60:
            case 61:
                this.Apo.b(b.fO(i2, i6), b.fQ(i5, this.Apo.Apj));
                return;
            default:
                throw new IllegalStateException("unexpected opcode: " + a.IP(i2));
        }
    ...
    public final void a(int i, int i2, int i3, int i4, int i5, long j, int i6, int i7) {
        ...
        switch (i2) {
            ...
            case 207:
                this.Apo.c(b.fO((short) i2, b.fP(i6, i7)));
                return;
            case 2:
            case 5:
            case 8:
                this.Apo.b(b.fO(i2, i6), b.IJ(i7));
                return;
            case 3:
            case 6:
            case 9:
                this.Apo.a((short) i2, b.II(i6), b.IJ(i7));
                return;
            case 32:
            case 35:
            case 82:
            ...
            case 94:
            case 95:
                this.Apo.b(b.fO(i2, b.fP(i6, i7)), (short) i3);
                return;
            case 36:
            case 110:
            case 111:
            ...
            case 113:
            case 114:
                this.Apo.a(b.fO(i2, b.fP(0, 2)), (short) i3, b.z(i6, i7, 0, 0));
                return;
            case 50:
            case 51:
            case 52:
            ...
            case 54:
            case 55:
                this.Apo.b(b.fO(i2, b.fP(i6, i7)), b.fQ(i5, this.Apo.Apj));
                return;
            ...
            case bp.CTRL_INDEX /*215*/:
                this.Apo.b(b.fO(i2, b.fP(i6, i7)), b.gz(j));
                return;
    ...
    public final void a(int i, int i2, int i3, int i4, int i5, long j, int i6, int i7, int i8) {
        switch (i2) {
            ...
            case 113:
            case 114:
                this.Apo.a(b.fO(i2, b.fP(0, 3)), (short) i3, b.z(i6, i7, i8, 0));
                return;
            ...
            case ac.CTRL_BYTE /*175*/:
                this.Apo.b(b.fO(i2, i6), b.fO(i7, i8));
                return;
            default:
                throw new IllegalStateException("unexpected opcode: " + a.IP(i2));
        }
    ...
    public final void a(int i, int i2, int i3, int i4, int i5, long j, int i6, int i7, int i8, int i9) {
        switch (i2) {
            ...
            case 113:
            case 114:
                this.Apo.a(b.fO(i2, b.fP(0, 4)), (short) i3, b.z(i6, i7, i8, i9));
                return;
            default:
                throw new IllegalStateException("unexpected opcode: " + a.IP(i2));
        }
    ...
    public final void a(int i, int i2, int i3, int i4, int i5, long j, int i6, int i7, int i8, int i9, int i10) {
        switch (i2) {
            ...
            case 113:
            case 114:
                this.Apo.a(b.fO(i2, b.fP(i10, 5)), (short) i3, b.z(i6, i7, i8, i9));
                return;
            default:
                throw new IllegalStateException("unexpected opcode: " + a.IP(i2));
        }
    ...
    public final void b(int i, int i2, int i3, int i4, int i5, long j, int i6, int i7) {
        switch (i2) {
            ...
            case 119:
            case 120:
                this.Apo.a(b.fO(i2, i7), (short) i3, b.II(i6));
                return;
            default:
                throw new IllegalStateException("unexpected opcode: " + a.IP(i2));
        }
    ...
    public final void a(int i, int i2, int[] iArr, int[] iArr2) {
        int length;
        int i3 = 0;
        int cHL = this.Apo.cHL();
        this.Apo.c((short) i2);
        this.Apo.c(b.IG(iArr2.length));
        for (int writeInt : iArr) {
            this.Apo.writeInt(writeInt);
        }
        if (this.Apq) {
            length = iArr2.length;
            while (i3 < length) {
                this.Apo.writeInt(this.App.IM(iArr2[i3]) - cHL);
                i3++;
            }
            return;
        }
        length = iArr2.length;
        while (i3 < length) {
            this.Apo.writeInt(iArr2[i3] - cHL);
            i3++;
        }
    }
    ...
    public final void b(int i, int i2, int i3, int[] iArr) {
        ...
        int cHL = this.Apo.cHL();
        this.Apo.c((short) i2);
        this.Apo.c(b.IG(iArr.length));
        this.Apo.writeInt(i3);
        int length;
        if (this.Apq) {
            length = iArr.length;
            while (i4 < length) {
                this.Apo.writeInt(this.App.IM(iArr[i4]) - cHL);
                i4++;
            }
            return;
        }
    ...
    public final void a(int i, int i2, Object obj, int i3, int i4) {
        ...
        switch (i4) {
            ...
            case 8:
                ...
                return;
            default:
                throw new j("bogus element_width: " + a.IO(i4));
        }
    }
}
