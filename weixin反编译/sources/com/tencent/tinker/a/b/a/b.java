...
public final class b {
    public static short fO(int i, int i2) {
        if ((i & -256) != 0) {
    ...
    public static short z(int i, int i2, int i3, int i4) {
        if ((i & -16) != 0) {
    ...
    public static short fQ(int i, int i2) {
        short s = i - i2;
        if (s == ((short) s)) {
            return (short) s;
        }
        throw new j("Target out of range: " + a.IQ(s) + ", perhaps you need to enable force jumbo mode.");
    }

    public static short gz(long j) {
    ...
    public static short II(int i) {
        if ((-65536 & i) == 0) {
            return (short) i;
        }
        throw new j("Register A out of range: " + a.gA((long) i));
    }

    public static short IJ(int i) {
        if ((-65536 & i) == 0) {
            return (short) i;
        }
        throw new j("Register B out of range: " + a.gA((long) i));
    }
