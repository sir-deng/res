...
public final class d {
    ...
    public final void a(e eVar) {
        ...
        while (true) {
            aVar = this.Apm;
            if ((aVar.Apj < aVar.Apr.length ? 1 : null) != null) {
                int i = this.Apm.Apj;
                int read = this.Apm.read();
                int i2 = read & 255;
                if (i2 == 0 || i2 == 255) {
                    i2 = read;
                }
                ...
                switch (i2) {
                    ...
                    case 0:
                    case 14:
                        eVar.a(i, read & 255, 0, 1, 0, (long) b.IH(read));
                        break;
                    case 1:
                    case 4:
                    case 7:
                    ...
                    case 5:
                    case 8:
                        eVar.a(i, read & 255, 0, 1, 0, 0, b.IH(read), this.Apm.read());
                        break;
                    case 3:
                    case 6:
                    case 9:
                        eVar.a(i, read & 255, 0, 1, 0, (long) b.IH(read), this.Apm.read(), this.Apm.read());
                        break;
                    case 10:
                    case 11:
                    case 12:
                    ...
                    case 30:
                    case 39:
                        eVar.a(i, read & 255, 0, 1, 0, 0, b.IH(read));
                        break;
                    case 18:
                    ...
                    case 19:
                    case 22:
                        eVar.a(i, read & 255, 0, 1, 0, (long) ((short) this.Apm.read()), b.IH(read));
                        break;
                    case 20:
                    case 23:
                        eVar.a(i, read & 255, 0, 1, 0, (long) this.Apm.readInt(), b.IH(read));
                        break;
                    case 21:
                    case 25:
                        i3 = read & 255;
                        eVar.a(i, i3, 0, 1, 0, ((long) ((short) this.Apm.read())) << (i3 == 21 ? 16 : 48), b.IH(read));
                        break;
                    case 24:
                        eVar.a(i, read & 255, 0, 1, 0, this.Apm.readLong(), b.IH(read));
                        break;
                    case 26:
                    case 28:
                    case 31:
                    ...
                    case 109:
                        i3 = read & 255;
                        eVar.a(i, i3, this.Apm.read(), b.IK(i3), 0, 0, b.IH(read));
                        break;
                    case 27:
                        i3 = read & 255;
                        eVar.a(i, i3, this.Apm.readInt(), b.IK(i3), 0, 0, b.IH(read));
                        break;
                    case 32:
                    case 35:
                    case 82:
                    ...
                    case 95:
                        i4 = read & 255;
                        eVar.a(i, i4, this.Apm.read(), b.IK(i4), 0, 0, (read >> 8) & 15, (read >> 12) & 15);
                        break;
                    case 36:
                    case 110:
                    case 111:
                    ...
                    case 114:
                        ...
                        switch (i2) {
                            case 0:
                                eVar.a(i, i7, read2, IK, 0, 0);
                                break;
                            case 1:
                                eVar.a(i, i7, read2, IK, 0, 0, i5);
                                break;
                            case 2:
                                eVar.a(i, i7, read2, IK, 0, 0, i5, i3);
                                break;
                            case 3:
                                eVar.a(i, i7, read2, IK, 0, 0, i5, i3, i4);
                                break;
                            case 4:
                                eVar.a(i, i7, read2, IK, 0, 0, i5, i3, i4, i6);
                                break;
                            case 5:
                                eVar.a(i, i7, read2, IK, 0, 0, i5, i3, i4, i6, i8);
                                break;
                            default:
                    ...
                    case 120:
                        i4 = read & 255;
                        eVar.b(i, i4, this.Apm.read(), b.IK(i4), 0, 0, this.Apm.read(), b.IH(read));
                        break;
                    case 38:
                    ...
                    case R.styleable.AppCompatTheme_listDividerAlertDialog /*44*/:
                        i3 = read & 255;
                        i5 = b.IH(read);
                        readInt = i + this.Apm.readInt();
                        switch (i3) {
                            case R.styleable.AppCompatTheme_dialogPreferredPadding /*43*/:
                            case R.styleable.AppCompatTheme_listDividerAlertDialog /*44*/:
                                this.Apm.fN(readInt + 1, i);
                                break;
                        }
                        eVar.a(i, i3, 0, 1, readInt, 0, i5);
                        break;
                    case 40:
                        eVar.a(i, read & 255, 0, 1, i + ((byte) b.IH(read)), 0);
                        break;
                    case 41:
                        eVar.a(i, read & 255, 0, 1, i + ((short) this.Apm.read()), (long) b.IH(read));
                        break;
                    case R.styleable.AppCompatTheme_dialogTheme /*42*/:
                        eVar.a(i, read & 255, 0, 1, i + this.Apm.readInt(), (long) b.IH(read));
                        break;
                    ...
                    case ac.CTRL_BYTE /*175*/:
                        ...
                        i5 = b.IH(read);
                        i2 = this.Apm.read();
                        eVar.a(i, i6, 0, 1, 0, 0, i5, i2 & 255, b.IH(i2));
                        break;
                    case 50:
                    case 51:
                    case 52:
                    ...
                    case 54:
                    case 55:
                        eVar.a(i, read & 255, 0, 1, i + ((short) this.Apm.read()), 0, (read >> 8) & 15, (read >> 12) & 15);
                        break;
                    case 56:
                    case 57:
                    case 58:
                    ...
                    case 60:
                    case 61:
                        eVar.a(i, read & 255, 0, 1, i + ((short) this.Apm.read()), 0, b.IH(read));
                        break;
                    ...
                    case bp.CTRL_INDEX /*215*/:
                        eVar.a(i, read & 255, 0, 1, 0, (long) ((short) this.Apm.read()), (read >> 8) & 15, (read >> 12) & 15);
                        break;
                    ...
                    case com.tencent.mm.plugin.appbrand.jsapi.contact.a.CTRL_INDEX /*226*/:
                        ...
                        i5 = b.IH(read);
                        i2 = this.Apm.read();
                        eVar.a(i, i4, 0, 1, 0, (long) ((byte) b.IH(i2)), i5, i2 & 255);
                        break;
                    case 256:
                        read2 = this.Apm.cHL();
                        IK = this.Apm.read();
                        readInt = this.Apm.readInt();
                        iArr = new int[IK];
                        for (i2 = 0; i2 < IK; i2++) {
                            iArr[i2] = this.Apm.readInt() + read2;
                        }
                    ...
                    case 768:
                        ...
                        switch (i2) {
                            ...
                            case 8:
                                ...
                                for (i2 = 0; i2 < readInt2; i2++) {
                                    obj[i2] = this.Apm.readLong();
                                }
                                eVar.a(i, read, obj, obj.length, 8);
                                break;
                            default:
                                throw new com.tencent.tinker.a.a.j("bogus element_width: " + com.tencent.tinker.a.b.b.a.IO(i2));
                        }
                    default:
                        throw new IllegalStateException("Unknown opcode: " + com.tencent.tinker.a.b.b.a.IN(i2));
                }
            }
            return;
        }
