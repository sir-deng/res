...
class l {
    ...
    void b(AttributeSet attributeSet, int i) {
        ...
        if (obtainStyledAttributes.hasValue(1)) {
            this.Qi = a(context, ez, obtainStyledAttributes.getResourceId(1, 0));
        }
        if (obtainStyledAttributes.hasValue(2)) {
            this.Qj = a(context, ez, obtainStyledAttributes.getResourceId(2, 0));
        }
        if (obtainStyledAttributes.hasValue(3)) {
            this.Qk = a(context, ez, obtainStyledAttributes.getResourceId(3, 0));
        }
        if (obtainStyledAttributes.hasValue(4)) {
            this.Ql = a(context, ez, obtainStyledAttributes.getResourceId(4, 0));
        }
