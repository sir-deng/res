...
public class Toolbar extends ViewGroup {
    ...
    private class a implements l {
        ...
        public final boolean b(h hVar) {
            ...
            if (Toolbar.this.ZB.getParent() != Toolbar.this) {
                Toolbar.this.addView(Toolbar.this.ZB);
            }
            Toolbar.this.ZC = hVar.getActionView();
            this.aab = hVar;
            if (Toolbar.this.ZC.getParent() != Toolbar.this) {
                android.view.ViewGroup.LayoutParams gY = Toolbar.gY();
                gY.gravity = 8388611 | (Toolbar.this.ZF & MMGIFException.D_GIF_ERR_IMAGE_DEFECT);
                gY.aac = 2;
                Toolbar.this.ZC.setLayoutParams(gY);
                Toolbar.this.addView(Toolbar.this.ZC);
            }
            ...
            hVar.J(true);
            if (Toolbar.this.ZC instanceof c) {
                ((c) Toolbar.this.ZC).onActionViewExpanded();
            }
            return true;
        }
        ...
        public final boolean c(h hVar) {
            if (Toolbar.this.ZC instanceof c) {
                ((c) Toolbar.this.ZC).onActionViewCollapsed();
            }
            Toolbar.this.removeView(Toolbar.this.ZC);
            Toolbar.this.removeView(Toolbar.this.ZB);
            Toolbar.this.ZC = null;
            Toolbar toolbar = Toolbar.this;
    ...
    static /* synthetic */ void b(Toolbar toolbar) {
        if (toolbar.ZB == null) {
            ...
            toolbar.ZB.setOnClickListener(new OnClickListener() {
    ...
    public Toolbar(Context context, AttributeSet attributeSet, int i) {
        ...
        this.ZU = new d() {
            public final boolean onMenuItemClick(MenuItem menuItem) {
                if (Toolbar.this.ZT != null) {
                    return Toolbar.this.ZT.onMenuItemClick(menuItem);
                }
                return false;
            }
        };
        this.ZZ = new Runnable() {
