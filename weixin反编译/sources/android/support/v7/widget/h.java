...
public final class h {
    ...
    final Drawable a(Context context, int i, boolean z, Drawable drawable) {
        ...
        if (f != null) {
            ...
            a(layerDrawable.findDrawableByLayerId(16908288), al.i(context, android.support.v7.a.a.a.colorControlNormal), Pp);
            a(layerDrawable.findDrawableByLayerId(16908303), al.i(context, android.support.v7.a.a.a.colorControlNormal), Pp);
            a(layerDrawable.findDrawableByLayerId(16908301), al.i(context, android.support.v7.a.a.a.colorControlActivated), Pp);
            return drawable;
        } else if (i == e.abc_ratingbar_indicator_material || i == e.abc_ratingbar_small_material) {
            layerDrawable = (LayerDrawable) drawable;
            a(layerDrawable.findDrawableByLayerId(16908288), al.k(context, android.support.v7.a.a.a.colorControlNormal), Pp);
            a(layerDrawable.findDrawableByLayerId(16908303), al.i(context, android.support.v7.a.a.a.colorControlActivated), Pp);
            a(layerDrawable.findDrawableByLayerId(16908301), al.i(context, android.support.v7.a.a.a.colorControlActivated), Pp);
            return drawable;
    ...
    L_0x002b:
        ...
        throw r0;
    L_0x002e:
        r1 = r0.wi;	 Catch:{ all -> 0x002b }
        r4 = r0.hX;	 Catch:{ all -> 0x002b }
        r1 = android.support.v4.e.b.a(r1, r4, r8);	 Catch:{ all -> 0x002b }
        if (r1 < 0) goto L_0x0049;
    L_0x0038:
        r4 = r0.wj;	 Catch:{ all -> 0x002b }
        r4 = r4[r1];	 Catch:{ all -> 0x002b }
        r5 = android.support.v4.e.e.wg;	 Catch:{ all -> 0x002b }
