...
public abstract class z extends p {
    ...
    protected final void a(View view, a aVar) {
        ...
        if (hVar == null || !hVar.eR()) {
            ...
            fe = e(h.bh(view) - layoutParams.leftMargin, layoutParams.rightMargin + h.bj(view), hVar.getPaddingLeft(), hVar.mWidth - hVar.getPaddingRight(), fe);
        }
        ...
        int ceil = (int) Math.ceil(((double) bg((int) Math.sqrt((double) ((fe * fe) + (i * i))))) / 0.3356d);
        if (ceil > 0) {
            aVar.a(-fe, -i, ceil, this.Eu);
        }
    }
    ...
    protected final void a(int i, int i2, a aVar) {
        ...
        if (this.SG == 0 && this.SH == 0) {
            ...
            aVar.a((int) (((float) this.SG) * 1.2f), (int) (((float) this.SH) * 1.2f), (int) (((float) bg(10000)) * 1.2f), this.SD);
        }
    }
