...
public class AppCompatSpinner extends Spinner implements x {
    ...
    private class b extends ListPopupWindow {
        ...
        public b(Context context, AttributeSet attributeSet, int i) {
            ...
            this.SW = AppCompatSpinner.this;
            setModal(true);
            this.SV = 0;
            this.SY = new OnItemClickListener(AppCompatSpinner.this) {
                public final void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
                    AppCompatSpinner.this.setSelection(i);
                    if (AppCompatSpinner.this.getOnItemClickListener() != null) {
                        AppCompatSpinner.this.performItemClick(view, i, b.this.FP.getItemId(i));
                    }
                    b.this.dismiss();
                }
            };
        ...
        final void eA() {
            ...
            if (background != null) {
                background.getPadding(AppCompatSpinner.this.ey);
                i = at.bv(AppCompatSpinner.this) ? AppCompatSpinner.this.ey.right : -AppCompatSpinner.this.ey.left;
            } else {
                Rect b = AppCompatSpinner.this.ey;
                AppCompatSpinner.this.ey.right = 0;
                b.left = 0;
                i = 0;
            }
            ...
            if (AppCompatSpinner.this.PV == -2) {
                int a = AppCompatSpinner.this.a((SpinnerAdapter) this.FP, this.SK.getBackground());
                i2 = (AppCompatSpinner.this.getContext().getResources().getDisplayMetrics().widthPixels - AppCompatSpinner.this.ey.left) - AppCompatSpinner.this.ey.right;
                if (a <= i2) {
                    i2 = a;
                }
                setContentWidth(Math.max(i2, (width - paddingLeft) - paddingRight));
            } else if (AppCompatSpinner.this.PV == -1) {
                setContentWidth((width - paddingLeft) - paddingRight);
            } else {
                setContentWidth(AppCompatSpinner.this.PV);
            }
            ...
            if (VERSION.SDK_INT >= 11) {
                ...
                try {
                    ...
                    try {
                        ...
                        if (i2 == 1) {
                            bVar = new b(this.Mn, attributeSet, i);
                            ...
                            a.Zu.recycle();
                            this.PU = bVar;
                            this.Kz = new android.support.v7.widget.ListPopupWindow.b(this) {
                                public final ListPopupWindow dq() {
                                    return bVar;
                                }

                                public final boolean dr() {
                                    if (!AppCompatSpinner.this.PU.SK.isShowing()) {
                                        AppCompatSpinner.this.PU.show();
                                    }
                                    return true;
                                }
                            };
