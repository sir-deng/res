...
public class ActionBarOverlayLayout extends ViewGroup implements r, t {
    ...
    private q Ni;
    private ai Nj;
    private final am Nk = new an() {
        public final void q(View view) {
            ActionBarOverlayLayout.this.Nj = null;
            ActionBarOverlayLayout.this.MX = false;
        }
    ...
    private final Runnable Nl = new Runnable() {
        public final void run() {
            ActionBarOverlayLayout.this.dU();
            ActionBarOverlayLayout.this.Nj = z.U(ActionBarOverlayLayout.this.MS).s(0.0f).a(ActionBarOverlayLayout.this.Nk);
        }
    };
    private final Runnable Nm = new Runnable() {
        public final void run() {
            ActionBarOverlayLayout.this.dU();
            ActionBarOverlayLayout.this.Nj = z.U(ActionBarOverlayLayout.this.MS).s((float) (-ActionBarOverlayLayout.this.MS.getHeight())).a(ActionBarOverlayLayout.this.Nk);
        }
    };
