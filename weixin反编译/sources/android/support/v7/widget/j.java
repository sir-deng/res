...
class j {
    ...
    private Drawable b(Drawable drawable, boolean z) {
        ...
        if (drawable instanceof c) {
            ...
            bo = new LayerDrawable(drawableArr);
            while (i < numberOfLayers) {
                bo.setId(i, layerDrawable.getId(i));
                i++;
            }
            return bo;
            ...
            bo = new ShapeDrawable(new RoundRectShape(new float[]{5.0f, 5.0f, 5.0f, 5.0f, 5.0f, 5.0f, 5.0f, 5.0f}, null, null));
            bo.getPaint().setShader(new BitmapShader(bitmap, TileMode.REPEAT, TileMode.CLAMP));
            bo.getPaint().setColorFilter(bitmapDrawable.getPaint().getColorFilter());
            return z ? new ClipDrawable(bo, 3, 1) : bo;
        }
    }
}
