...
public class ActionMenuView extends LinearLayoutCompat implements android.support.v7.view.menu.f.b, m {
    ...
    private class c implements android.support.v7.view.menu.f.a {
        ...
        public final boolean a(f fVar, MenuItem menuItem) {
            return ActionMenuView.this.NW != null && ActionMenuView.this.NW.onMenuItemClick(menuItem);
        }

        public final void b(f fVar) {
            if (ActionMenuView.this.NS != null) {
                ActionMenuView.this.NS.b(fVar);
            }
        }
    }
    ...
    protected final /* synthetic */ android.support.v7.widget.LinearLayoutCompat.LayoutParams ef() {
        return ed();
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        while (i11 < childCount2) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                layoutParams.Oc = z;
                int d = d(childAt, i7, layoutParams.NY ? 1 : i5, childMeasureSpec, paddingTop);
                i9 = Math.max(i9, d);
                if (layoutParams.Ob) {
                    i3 = i10 + 1;
                } else {
        ...
        while (i10 > 0 && paddingTop > 0) {
            ...
            while (true) {
                ...
                if (layoutParams.Ob) {
                    if (layoutParams.NZ < i6) {
                        i5 = layoutParams.NZ;
                        j = (long) (1 << i15);
                        size = 1;
                    } else if (layoutParams.NZ == i6) {
                        j |= (long) (1 << i15);
                        size = i5 + 1;
                        i5 = i6;
                    }
            ...
            while (i6 < childCount2) {
                ...
                if ((((long) (1 << i6)) & j) != 0) {
                    if (obj3 != null && layoutParams.Oc && i5 == 1) {
                        childAt2.setPadding(this.NV + i7, 0, this.NV, 0);
                    }
                    layoutParams.NZ++;
        ...
        if (obj3 != null) {
            ...
            while (true) {
                ...
                layoutParams = (LayoutParams) childAt.getLayoutParams();
                if (layoutParams.Od) {
                    childAt.measure(MeasureSpec.makeMeasureSpec(layoutParams.Oa + (layoutParams.NZ * i7), 1073741824), childMeasureSpec);
                }
                size = i3 + 1;
            }
        }
    ...
    private static LayoutParams ed() {
    ...
    private boolean aI(int i) {
        ...
        return (i <= 0 || !(childAt2 instanceof a)) ? z : ((a) childAt2).do() | z;
    }
