...
public class SwitchCompat extends CompoundButton {
    ...
    private class a extends Animation {
        ...
        /* synthetic */ a(SwitchCompat switchCompat, float f, float f2, byte b) {
            this(f, f2);
        }
        ...
        protected final void applyTransformation(float f, Transformation transformation) {
            SwitchCompat.this.H(this.Zi + (this.Zk * f));
        }
    }
        ...
        switch (o.d(motionEvent)) {
            ...
            case 3:
                ...
                if (z) {
                    ...
                    z = Math.abs(x) > ((float) this.Ux) ? at.bv(this) ? x < 0.0f : x > 0.0f : gT();
                } else {
                    z = isChecked;
                }
                if (z != isChecked) {
    ...
    public void setChecked(boolean z) {
        ...
        if (getWindowToken() != null && z.ai(this) && isShown()) {
            ...
            this.Zf.setAnimationListener(new AnimationListener() {
                public final void onAnimationStart(Animation animation) {
                }

                public final void onAnimationEnd(Animation animation) {
                    if (SwitchCompat.this.Zf == animation) {
                        SwitchCompat.this.H(isChecked ? 1.0f : 0.0f);
                        SwitchCompat.this.Zf = null;
                    }
                }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Layout layout = gT() ? this.Zc : this.Zd;
        if (layout != null) {
            int i3;
