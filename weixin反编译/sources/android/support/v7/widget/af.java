...
final class af extends Drawable {
    ...
    af(Resources resources, int i, float f, float f2, float f3) {
        this.jm = resources.getColor(android.support.v7.b.a.a.IX);
        this.jo = resources.getColor(android.support.v7.b.a.a.IW);
        ...
        if (f2 < 0.0f) {
            ...
            if (this.jk != l || this.ji != l2) {
                this.jk = l;
                this.ji = l2;
                this.jj = (float) ((int) (((l * 1.5f) + ((float) this.Wr)) + 0.5f));
    ...
    static float a(float f, float f2, boolean z) {
        if (z) {
            return (float) (((double) (1.5f * f)) + ((1.0d - jb) * ((double) f2)));
        }
        return 1.5f * f;
    }
