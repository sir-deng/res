...
public final class aq implements u {
    ...
    private aq(Toolbar toolbar, boolean z, int i, int i2) {
        ...
        this.gH.setNavigationOnClickListener(new OnClickListener() {
            final android.support.v7.view.menu.a aap = new android.support.v7.view.menu.a(aq.this.gH.getContext(), aq.this.uU);

            public final void onClick(View view) {
                if (aq.this.HV != null && aq.this.aal) {
                    aq.this.HV.onMenuItemSelected(0, this.aap);
                }
            }
        });
    }
    ...
    public final ai c(final int i, long j) {
        return z.U(this.gH).q(i == 0 ? 1.0f : 0.0f).d(j).a(new an() {
            private boolean Mu = false;

            public final void p(View view) {
                aq.this.gH.setVisibility(0);
            }

            public final void q(View view) {
                if (!this.Mu) {
                    aq.this.gH.setVisibility(i);
                }
            }
