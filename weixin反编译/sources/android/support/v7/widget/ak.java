...
final class ak extends p implements OnClickListener {
    ...
    private static final class a {
        ...
        public a(View view) {
            this.YC = (TextView) view.findViewById(16908308);
            this.YD = (TextView) view.findViewById(16908309);
            this.YE = (ImageView) view.findViewById(16908295);
            this.YF = (ImageView) view.findViewById(16908296);
            this.YG = (ImageView) view.findViewById(f.edit_query);
        }
    }
    ...
    private static void a(android.database.Cursor r2) {
...
*/
    ...
    L_0x0012:
        ...
        goto L_0x0006;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v7.widget.ak.a(android.database.Cursor):void");
    }
        ...
        if (aVar.YD != null) {
            ...
            if (a != null) {
                if (this.Yv == null) {
                    ...
                    this.mContext.getTheme().resolveAttribute(android.support.v7.a.a.a.textColorSearchUrl, typedValue, true);
