...
public final class ai extends HorizontalScrollView implements OnItemSelectedListener {
    ...
    private class a extends BaseAdapter {
        ...
        public final int getCount() {
            return ai.this.WB.getChildCount();
        }

        public final Object getItem(int i) {
            return ((b) ai.this.WB.getChildAt(i)).WL;
        }
    ...
    private class b extends LinearLayoutCompat implements OnLongClickListener {
        ...
        public b(Context context, android.support.v7.app.ActionBar.a aVar, boolean z) {
        ...
        public final void onMeasure(int i, int i2) {
            ...
            if (ai.this.WE > 0 && getMeasuredWidth() > ai.this.WE) {
                super.onMeasure(MeasureSpec.makeMeasureSpec(ai.this.WE, 1073741824), i2);
            }
        }
    ...
    static /* synthetic */ b a(ai aiVar, android.support.v7.app.ActionBar.a aVar) {
        b bVar = new b(aiVar.getContext(), aVar, true);
