...
public final class ac extends a {
    ...
    final a Wj = new a() {
        public final void a(View view, b bVar) {
            super.a(view, bVar);
            if (!ac.this.gd() && ac.this.Va.TV != null) {
                ac.this.Va.TV.b(view, bVar);
            }
        }
    ...
    final boolean gd() {
        ...
        return !recyclerView.Uc || recyclerView.Ul || recyclerView.TP.eu();
    }
    ...
    public final void a(View view, b bVar) {
        ...
        if (!gd() && this.Va.TV != null) {
            ...
            b.zW.f(bVar.zX, new k(b.zW.a(hVar.a(mVar, qVar), hVar.b(mVar, qVar), false, 0)).zX);
        }
    }
