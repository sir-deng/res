...
public class i extends c<android.support.v4.c.a.b> implements MenuItem {
    ...
    class a extends android.support.v4.view.d {
        ...
        public final void onPrepareSubMenu(SubMenu subMenu) {
            this.LR.onPrepareSubMenu(i.this.a(subMenu));
        }
    }
    ...
    private class c extends d<OnActionExpandListener> implements e {
        ...
        public final boolean onMenuItemActionExpand(MenuItem menuItem) {
            return ((OnActionExpandListener) this.KO).onMenuItemActionExpand(i.this.f(menuItem));
        }

        public final boolean onMenuItemActionCollapse(MenuItem menuItem) {
            return ((OnActionExpandListener) this.KO).onMenuItemActionCollapse(i.this.f(menuItem));
        }
    }
    ...
    private class d extends d<OnMenuItemClickListener> implements OnMenuItemClickListener {
        ...
        public final boolean onMenuItemClick(MenuItem menuItem) {
            return ((OnMenuItemClickListener) this.KO).onMenuItemClick(i.this.f(menuItem));
        }
    }
    ...
    public MenuItem setOnMenuItemClickListener(OnMenuItemClickListener onMenuItemClickListener) {
        ((android.support.v4.c.a.b) this.KO).setOnMenuItemClickListener(onMenuItemClickListener != null ? new d(onMenuItemClickListener) : null);
        return this;
    }
    ...
    public ActionProvider getActionProvider() {
        android.support.v4.view.d bu = ((android.support.v4.c.a.b) this.KO).bu();
        if (bu instanceof a) {
            return ((a) bu).LR;
        }
        return null;
    ...
    public MenuItem setOnActionExpandListener(OnActionExpandListener onActionExpandListener) {
        ((android.support.v4.c.a.b) this.KO).a(onActionExpandListener != null ? new c(onActionExpandListener) : null);
        return this;
    }
