...
public class ListMenuItemView extends LinearLayout implements a {
    ...
    public final void a(h hVar) {
        ...
        if (!(!isCheckable && this.KQ == null && this.KR == null)) {
            ...
            if (this.eb.dI()) {
                if (this.KQ == null) {
                    this.KQ = (RadioButton) ds().inflate(h.abc_list_menu_item_radio, this, false);
                    addView(this.KQ);
                }
                ...
                if (this.KR == null) {
                    this.KR = (CheckBox) ds().inflate(h.abc_list_menu_item_checkbox, this, false);
                    addView(this.KR);
                }
        ...
        if ((z || this.KV) && !(this.kP == null && icon == null && !this.KV)) {
            if (this.kP == null) {
                this.kP = (ImageView) ds().inflate(h.abc_list_menu_item_icon, this, false);
                addView(this.kP, 0);
            }
