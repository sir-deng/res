...
public final class e implements l, OnItemClickListener {
    ...
    private class a extends BaseAdapter {
        ...
        public final int getCount() {
            int size = e.this.eg.dD().size() - e.this.KZ;
            return this.Lc < 0 ? size : size - 1;
        }

        public final h aE(int i) {
            ArrayList dD = e.this.eg.dD();
            int a = e.this.KZ + i;
        ...
        public final View getView(int i, View view, ViewGroup viewGroup) {
            View inflate;
            if (view == null) {
                inflate = e.this.DF.inflate(e.this.KK, viewGroup, false);
            } else {
                inflate = view;
            }
    ...
    public final boolean a(p pVar) {
        ...
        if (!(aVar2.Gm == null && aVar2.BA == null && aVar2.FP == null)) {
            ...
            if (!aVar2.Gp) {
                ...
                if (aVar2.BA != null) {
                    cVar22 = new SimpleCursorAdapter(aVar2.mContext, i2, aVar2.BA, new String[]{aVar2.Gs}, new int[]{16908308});
                } else {
                    cVar22 = aVar2.FP != null ? aVar2.FP : new c(aVar2.mContext, i2, aVar2.Gm);
                }
            } else if (aVar2.BA == null) {
                cVar22 = new AnonymousClass1(aVar2.mContext, a.FU, aVar2.Gm, listView);
            } else {
                cVar22 = new AnonymousClass2(aVar2.mContext, aVar2.BA, listView, a);
            }
            a.FP = cVar22;
            a.FQ = aVar2.FQ;
            if (aVar2.Gn != null) {
