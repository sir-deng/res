...
public final class h implements b {
    ...
    public final boolean dF() {
        if ((this.Kx != null && this.Kx.onMenuItemClick(this)) || this.eg.b(this.eg.dE(), this)) {
            return true;
        }
        if (this.LE != null) {
            this.LE.run();
    ...
    final char dG() {
        return this.eg.dv() ? this.Ku : this.Kt;
    }

    final boolean dH() {
        return this.eg.dw() && dG() != 0;
    }
    ...
    public final Drawable getIcon() {
        ...
        Drawable a = android.support.v7.widget.h.ez().a(this.eg.mContext, this.Kw, false);
        this.Kw = 0;
        this.Kv = a;
        return a;
    }
    ...
    public final MenuItem setChecked(boolean z) {
        if ((this.ur & 4) != 0) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (hVar.getGroupId() == groupId && hVar.dI() && hVar.isCheckable()) {
                    hVar.G(hVar == this);
                }
            }
        } else {
