            ...
            if (inflate != null) {
                ...
                if (VERSION.SDK_INT >= 23) {
                    ...
                    if (!(findViewById5 == null && findViewById == null)) {
                        if (bVar.Fu != null) {
                            bVar.FL.Dx = new AnonymousClass2(findViewById5, findViewById);
                            bVar.FL.post(new AnonymousClass3(findViewById5, findViewById));
                        } else if (bVar.Fv != null) {
                            bVar.Fv.setOnScrollListener(new AnonymousClass4(findViewById5, findViewById));
                            bVar.Fv.post(new AnonymousClass5(findViewById5, findViewById));
                        } else {
                            if (findViewById5 != null) {
                                b2.removeView(findViewById5);
                            }
