    ...
    public ScrimInsetsFrameLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        z.b((View) this, new t() {
            public final ap a(View view, ap apVar) {
                if (ScrimInsetsFrameLayout.this.ex == null) {
                    ScrimInsetsFrameLayout.this.ex = new Rect();
                }
                ScrimInsetsFrameLayout.this.ex.set(apVar.getSystemWindowInsetLeft(), apVar.getSystemWindowInsetTop(), apVar.getSystemWindowInsetRight(), apVar.getSystemWindowInsetBottom());
                ScrimInsetsFrameLayout.this.a(ScrimInsetsFrameLayout.this.ex);
                ScrimInsetsFrameLayout scrimInsetsFrameLayout = ScrimInsetsFrameLayout.this;
                boolean z = ScrimInsetsFrameLayout.this.ex.isEmpty() || ScrimInsetsFrameLayout.this.ew == null;
                scrimInsetsFrameLayout.setWillNotDraw(z);
                z.E(ScrimInsetsFrameLayout.this);
                return apVar.cc();
            }
        });
    }
