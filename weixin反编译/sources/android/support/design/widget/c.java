...
public final class c extends j {
    ...
    private View a(int i, View view, LayoutParams layoutParams) {
        ...
        View view2 = (FrameLayout) coordinatorLayout.findViewById(e.bk);
        BottomSheetBehavior.i(view2).fs = this.fA;
        ...
        if (z) {
            coordinatorLayout.findViewById(e.bp).setOnClickListener(new OnClickListener() {
