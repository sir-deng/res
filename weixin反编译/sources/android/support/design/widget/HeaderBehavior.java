...
abstract class HeaderBehavior<V extends View> extends ViewOffsetBehavior<V> {
    ...
    private class a implements Runnable {
        ...
        public final void run() {
            if (this.iP != null && HeaderBehavior.this.iK != null) {
                if (HeaderBehavior.this.iK.computeScrollOffset()) {
                    HeaderBehavior.this.c(this.iO, this.iP, HeaderBehavior.this.iK.getCurrY());
                    z.a(this.iP, (Runnable) this);
                    return;
                }
                HeaderBehavior.this.a(this.iO, this.iP);
            }
        }
    }
    ...
    final boolean a(CoordinatorLayout coordinatorLayout, V v, int i, float f) {
        ...
        this.iK.b(L(), 0, Math.round(f), 0, 0, i, 0);
        if (this.iK.computeScrollOffset()) {
            this.iJ = new a(coordinatorLayout, v);
            z.a((View) v, this.iJ);
            return true;
        }
