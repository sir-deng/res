    ...
    private class a extends android.support.v4.view.a {
        ...
        public final void a(View view, b bVar) {
            ...
            if (TextInputLayout.this.kT != null) {
                b.zW.f(bVar.zX, TextInputLayout.this.kT);
            }
            charSequence = TextInputLayout.this.la != null ? TextInputLayout.this.la.getText() : null;
            if (!TextUtils.isEmpty(charSequence)) {
                b.zW.j(bVar.zX, true);
        ...
        if (this.le != z2) {
            if (z2) {
                ...
                try {
                    ...
                    this.lf.setTextColor(android.support.v4.content.a.c(getContext(), c.ba));
                }
                a(this.lf, -1);
                if (this.kT == null) {
                    L(0);
        ...
        if (this.kZ != z) {
            ...
            if (z) {
                ...
                try {
                    ...
                    this.la.setTextColor(android.support.v4.content.a.c(getContext(), c.ba));
                }
            ...
            if (!TextUtils.equals(this.ld, charSequence)) {
                ...
                if (this.lc) {
                    ...
                    if (ai) {
                        ...
                        z.U(this.la).q(1.0f).d(200).b(a.eD).a(new an() {
                    ...
                    if (ai) {
                        z.U(this.la).q(0.0f).d(200).b(a.eC).a(new an() {
