...
public class BottomSheetBehavior<V extends View> extends Behavior<V> {
    ...
    private final android.support.v4.widget.u.a fx = new android.support.v4.widget.u.a() {
        public final boolean b(View view, int i) {
            ...
            if (BottomSheetBehavior.this.fw) {
                return false;
            }
            if (BottomSheetBehavior.this.mState == 3 && BottomSheetBehavior.this.fu == i) {
                View view2 = (View) BottomSheetBehavior.this.fr.get();
        ...
        public final void a(View view, float f, float f2) {
            ...
            int i = 3;
            if (f2 < 0.0f) {
                f3 = BottomSheetBehavior.this.fh;
            } else if (BottomSheetBehavior.this.fj && BottomSheetBehavior.this.a(view, f2)) {
                f3 = BottomSheetBehavior.this.fp;
                i = 5;
            } else if (f2 == 0.0f) {
                int top = view.getTop();
                if (Math.abs(top - BottomSheetBehavior.this.fh) < Math.abs(top - BottomSheetBehavior.this.fi)) {
                    ...
                    f3 = BottomSheetBehavior.this.fi;
                    i = 4;
                }
            } else {
                f3 = BottomSheetBehavior.this.fi;
            ...
            if (BottomSheetBehavior.this.fk.t(view.getLeft(), f3)) {
                BottomSheetBehavior.this.r(2);
                z.a(view, new b(view, i));
                return;
            }
            BottomSheetBehavior.this.r(i);
        }
        ...
        public final int N() {
            if (BottomSheetBehavior.this.fj) {
                return BottomSheetBehavior.this.fp - BottomSheetBehavior.this.fh;
            }
            return BottomSheetBehavior.this.fi - BottomSheetBehavior.this.fh;
        }
    };
    public int mState = 4;
    ...
    private class b implements Runnable {
        ...
        public final void run() {
            if (BottomSheetBehavior.this.fk == null || !BottomSheetBehavior.this.fk.cM()) {
    ...
    public BottomSheetBehavior(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, i.bW);
        q(obtainStyledAttributes.getDimensionPixelSize(i.bX, 0));
        this.fj = obtainStyledAttributes.getBoolean(i.bY, false);
    ...
    public final boolean a(CoordinatorLayout coordinatorLayout, V v, View view, float f, float f2) {
        return view == this.fr.get() && (this.mState != 3 || super.a(coordinatorLayout, (View) v, view, f, f2));
    }
