...
public class CoordinatorLayout extends ViewGroup implements r {
    ...
    private class c implements OnHierarchyChangeListener {
        ...
        public final void onChildViewAdded(View view, View view2) {
            if (CoordinatorLayout.this.hz != null) {
                CoordinatorLayout.this.hz.onChildViewAdded(view, view2);
            }
        }
        ...
        public final void onChildViewRemoved(View view, View view2) {
            ...
            if (CoordinatorLayout.this.hz != null) {
                CoordinatorLayout.this.hz.onChildViewRemoved(view, view2);
            }
        }
    }
    ...
    public CoordinatorLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        this.hf = new Comparator<View>() {
            public final /* synthetic */ int compare(Object obj, Object obj2) {
                View view = (View) obj;
                View view2 = (View) obj2;
                if (view != view2) {
                    if (((d) view.getLayoutParams()).c(CoordinatorLayout.this, view, view2)) {
                        return 1;
                    }
                    if (((d) view2.getLayoutParams()).c(CoordinatorLayout.this, view2, view)) {
                        return -1;
                    }
                }
                return 0;
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        z = false;
        Behavior behavior = ((d) this.hs.getLayoutParams()).hC;
        z2 = behavior != null ? behavior.b(this, this.hs, motionEvent) : false;
        if (this.hs == null) {
            z2 |= super.onTouchEvent(motionEvent);
            motionEvent2 = null;
        } else if (z) {
    ...
    final void k(boolean z) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            for (i2 = 0; i2 < i; i2++) {
                if (dVar2.hI == ((View) this.hi.get(i2))) {
                    dVar = (d) view.getLayoutParams();
                    if (dVar.hH != null) {
                        Rect rect = this.hl;
                        Rect rect2 = this.hm;
                        Rect rect3 = this.hn;
                        x.a(this, dVar.hH, rect);
                        a(view, false, rect2);
                        a(view, I, rect, rect3);
