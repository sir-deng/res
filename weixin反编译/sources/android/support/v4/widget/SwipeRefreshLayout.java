...
public class SwipeRefreshLayout extends ViewGroup implements p, r {
    ...
    private int EI;
    private boolean EJ;
    private AnimationListener EK = new AnimationListener() {
    ...
    private final Animation EL = new Animation() {
        public final void applyTransformation(float f, Transformation transformation) {
            int j;
            if (SwipeRefreshLayout.this.EJ) {
                j = (int) SwipeRefreshLayout.this.EF;
            } else {
                j = (int) (SwipeRefreshLayout.this.EF - ((float) Math.abs(SwipeRefreshLayout.this.Ez)));
            }
            SwipeRefreshLayout.this.e((((int) (((float) (j - SwipeRefreshLayout.this.Ex)) * f)) + SwipeRefreshLayout.this.Ex) - SwipeRefreshLayout.this.Ev.getTop(), false);
            SwipeRefreshLayout.this.EA.y(1.0f - f);
        }
    };
    private final Animation EM = new Animation() {
        public final void applyTransformation(float f, Transformation transformation) {
            SwipeRefreshLayout.this.e((SwipeRefreshLayout.this.Ex + ((int) (((float) (SwipeRefreshLayout.this.Ez - SwipeRefreshLayout.this.Ex)) * f))) - SwipeRefreshLayout.this.Ev.getTop(), false);
        }
    };
    private a Eg;
    ...
    private Animation s(final int i, final int i2) {
        ...
        Animation anonymousClass3 = new Animation() {
            public final void applyTransformation(float f, Transformation transformation) {
                SwipeRefreshLayout.this.EA.setAlpha((int) (((float) i) + (((float) (i2 - i)) * f)));
            }
        };
        anonymousClass3.setDuration(300);
        this.Ev.Bk = null;
        this.Ev.clearAnimation();
        this.Ev.startAnimation(anonymousClass3);
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (!isEnabled() || this.Et || cL() || this.Eh || this.En) {
            return false;
        }
        float g;
        switch (d) {
    ...
    private void G(float f) {
        if (f <= this.Ei) {
            ...
            if (this.Es) {
                ...
                this.EE = new Animation() {
                    public final void applyTransformation(float f, Transformation transformation) {
                        SwipeRefreshLayout.this.E(SwipeRefreshLayout.this.Ey + ((-SwipeRefreshLayout.this.Ey) * f));
                        SwipeRefreshLayout.this.e((SwipeRefreshLayout.this.Ex + ((int) (((float) (SwipeRefreshLayout.this.Ez - SwipeRefreshLayout.this.Ex)) * f))) - SwipeRefreshLayout.this.Ev.getTop(), false);
                    }
                };
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (!isEnabled() || this.Et || cL() || this.En) {
            return false;
        }
        float e;
        switch (d) {
