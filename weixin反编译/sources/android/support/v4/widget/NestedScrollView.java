...
public class NestedScrollView extends FrameLayout implements p, r, w {
        ...
        public final boolean performAccessibilityAction(View view, int i, Bundle bundle) {
            ...
            switch (i) {
                case Downloads.RECV_BUFFER_SIZE /*4096*/:
                    min = Math.min(((nestedScrollView.getHeight() - nestedScrollView.getPaddingBottom()) - nestedScrollView.getPaddingTop()) + nestedScrollView.getScrollY(), nestedScrollView.cD());
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        switch (action & 255) {
            ...
            case 3:
                ...
                this.fu = -1;
                cC();
                if (this.iK.i(getScrollX(), getScrollY(), cD())) {
                    z.E(this);
                }
                stopNestedScroll();
                break;
            ...
            case 1:
                if (this.iL) {
                    ...
                    if (Math.abs(d) > this.zc) {
                        at(-d);
                    } else if (this.iK.i(getScrollX(), getScrollY(), cD())) {
                        z.E(this);
                    }
                }
                this.fu = -1;
            ...
            case 2:
                ...
                if (b != -1) {
                    ...
                    if (this.iL) {
                        ...
                        if (d(0, i, 0, getScrollY(), cD) && !hasNestedScrollingParent()) {
                            this.ft.clear();
                        }
                        int scrollY2 = getScrollY() - scrollY;
                ...
                break;
            case 3:
                if (this.iL && getChildCount() > 0 && this.iK.i(getScrollX(), getScrollY(), cD())) {
                    z.E(this);
                }
                this.fu = -1;
                cE();
    ...
    public void computeScroll() {
        if (this.iK.computeScrollOffset()) {
            ...
            if (scrollX != currX || scrollY != currY) {
                int cD = cD();
                int B = z.B(this);
                Object obj = (B == 0 || (B == 1 && cD > 0)) ? 1 : null;
                d(currX - scrollX, currY - scrollY, scrollX, scrollY, cD);
                if (obj != null) {
                    cF();
                    if (currY <= 0 && scrollY > 0) {
                        this.Dh.ap((int) this.iK.getCurrVelocity());
                    } else if (currY >= cD && scrollY < cD) {
    ...
    private void at(int i) {
        int scrollY = getScrollY();
        boolean z = (scrollY > 0 || i > 0) && (scrollY < cD() || i < 0);
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.Dh != null) {
            ...
            if (!this.Di.isFinished()) {
                ...
                width = (getWidth() - getPaddingLeft()) - getPaddingRight();
                int height = getHeight();
                canvas.translate((float) ((-width) + getPaddingLeft()), (float) (Math.max(cD(), scrollY) + height));
