...
public class PagerTitleStrip extends ViewGroup implements a {
    ...
    private class a extends DataSetObserver implements d, e {
        ...
        public final void ae(int i) {
            float f = 0.0f;
            if (this.yi == 0) {
                PagerTitleStrip.this.a(PagerTitleStrip.this.xS.yF, PagerTitleStrip.this.xS.yE);
                if (PagerTitleStrip.this.xX >= 0.0f) {
                    f = PagerTitleStrip.this.xX;
                }
                PagerTitleStrip.this.a(PagerTitleStrip.this.xS.yF, f, true);
            }
        }
