...
public final class u extends t {
    ...
    final class a implements android.support.v4.content.c.a<Object>, b<Object> {
        ...
        public a(int i, Bundle bundle, android.support.v4.app.t.a<Object> aVar) {
            this.mId = i;
            this.rG = bundle;
            this.rH = aVar;
        }
        ...
        final void destroy() {
            while (true) {
                ...
                boolean z = this.rK;
                this.rK = false;
                if (this.rH != null && this.rI != null && this.rJ && z) {
                    String str;
                    if (u.DEBUG) {
                        new StringBuilder("  Reseting: ").append(this);
                    }
                    if (u.this.mHost != null) {
                        str = u.this.mHost.mFragmentManager.qH;
                        u.this.mHost.mFragmentManager.qH = "onLoaderReset";
                    } else {
                        str = null;
                    }
                    if (u.this.mHost != null) {
                        u.this.mHost.mFragmentManager.qH = str;
                    }
                }
                this.rH = null;
                this.mData = null;
        ...
        public final void b(c<Object> cVar, Object obj) {
            ...
            if (!this.qG && u.this.rD.get(this.mId) == this) {
                a aVar = this.rO;
                if (aVar != null) {
                    if (u.DEBUG) {
                ...
                aVar = (a) u.this.rE.get(this.mId);
                if (!(aVar == null || aVar == this)) {
                    aVar.rK = false;
                    aVar.destroy();
                    u.this.rE.remove(this.mId);
                }
                if (u.this.mHost != null && !u.this.ba()) {
                    u.this.mHost.mFragmentManager.aV();
                }
            }
        }
        ...
        final void c(c<Object> cVar, Object obj) {
            ...
            if (this.rH != null) {
                if (u.this.mHost != null) {
                    String str2 = u.this.mHost.mFragmentManager.qH;
                    u.this.mHost.mFragmentManager.qH = "onLoadFinished";
                    str = str2;
                } else {
                    str = null;
                }
    ...
    public final void destroyLoader(int i) {
        ...
        if (indexOfKey >= 0) {
            aVar = (a) this.rD.valueAt(indexOfKey);
