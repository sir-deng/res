...
final class e extends q implements Runnable {
    ...
    static /* synthetic */ android.support.v4.e.a a(e eVar, b bVar, boolean z, Fragment fragment) {
        ...
        Map a2 = new android.support.v4.e.a();
        View view = fragment.getView();
        if (!(view == null || eVar.pw == null)) {
            r.a(a2, view);
            if (z) {
                a2 = a(eVar.pw, eVar.px, (android.support.v4.e.a) a2);
            } else {
                g.a(a2, eVar.px);
            }
        }
    ...
    public final void run() {
        ...
        if (!this.pp || this.mIndex >= 0) {
            ...
            int i = a2 != null ? 0 : this.po;
            int i2 = a2 != null ? 0 : this.pn;
            a aVar = this.pg;
            while (aVar != null) {
                int i3 = a2 != null ? 0 : aVar.pM;
                int i4 = a2 != null ? 0 : aVar.pN;
                Fragment fragment;
                switch (aVar.pK) {
                    case 1:
                        fragment = aVar.pL;
                ...
                switch (aVar.pK) {
                    ...
                    case 2:
                        ...
                        if (this.pf.qt != null) {
                            ...
                            while (true) {
                                int i2 = i;
                                if (i2 < this.pf.qt.size()) {
                                    Fragment fragment3 = (Fragment) this.pf.qt.get(i2);
    ...
    public final b a(boolean z, b bVar, SparseArray<Fragment> sparseArray, SparseArray<Fragment> sparseArray2) {
        ...
        M(-1);
        int i2 = bVar != null ? 0 : this.po;
        int i3 = bVar != null ? 0 : this.pn;
        a aVar = this.ph;
        while (aVar != null) {
            int i4 = bVar != null ? 0 : aVar.pO;
            i = bVar != null ? 0 : aVar.pP;
            Fragment fragment;
            Fragment fragment2;
            switch (aVar.pK) {
                case 1:
                ...
                case 4:
                    fragment2 = aVar.pL;
                    fragment2.mNextAnim = i4;
                    this.pf.c(fragment2, n.Q(i3), i2);
                    break;
                case 5:
                    fragment = aVar.pL;
                    fragment.mNextAnim = i;
                    this.pf.b(fragment, n.Q(i3), i2);
                    break;
                case 6:
                    fragment2 = aVar.pL;
                    fragment2.mNextAnim = i4;
                    this.pf.e(fragment2, n.Q(i3), i2);
                    break;
                case 7:
                    fragment2 = aVar.pL;
                    fragment2.mNextAnim = i4;
                    this.pf.d(fragment2, n.Q(i3), i2);
                    break;
                default:
                    throw new IllegalArgumentException("Unknown cmd: " + aVar.pK);
            }
        ...
        if (z) {
            this.pf.a(this.pf.qA, n.Q(i3), i2, true);
            bVar = null;
        }
        if (this.mIndex >= 0) {
            n nVar = this.pf;
        ...
        if (arrayList != null) {
            ...
            while (true) {
                ...
                if (i2 < arrayList.size()) {
                    a(bVar.pR, (String) arrayList.get(i2), (String) arrayList2.get(i2));
                    i = i2 + 1;
                } else {
                    return;
                }
