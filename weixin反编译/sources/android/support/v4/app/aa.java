...
final class aa {
    ...
    public static void a(Builder builder, android.support.v4.app.ac.a aVar) {
        Action.Builder builder2 = new Action.Builder(aVar.getIcon(), aVar.getTitle(), aVar.bj());
        if (aVar.bk() != null) {
            for (RemoteInput addRemoteInput : ai.a(aVar.bk())) {
